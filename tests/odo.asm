*---------------------------------------------------------------
* Generated by cobc370 from odo.cbl
...
* MOVE REC -> OUT-AREA
         ...
         STH   2,MVLLEN
         PACK  PWK2(16),D0000(2)   zoned -> packed
         ZAP   DWK(8),PWK2(16)
         CVB   2,DWK               DEPENDING ON count
         MH    2,H0001             times the element
         LA    2,4(2)              plus the fixed part
         STH   2,MVLLEN+2
         LA    1,D0004
         ST    1,MVLPARM
         LA    1,D0001
         ...
         LA    1,MVLPARM
         L     15,VMVL
         BALR  14,15               COBMVL: any length, space filled
         DROP  8
T0007    DS    0H
* DISPLAY
...
VMVL     DC    V(COBMVL)
MVLPARM  DC    A(0),A(0),X'80',AL3(MVLLEN)  COBMVL: receiver, sender, l
MVLLEN   DS    2H                  receiver length, sender length
PWK1     DS    PL16
PWK2     DS    PL16
...
* WORKING-STORAGE
D0000    DC    CL2'00'             N PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0001    DS    0CL19               REC (01 group)
D0002    DC    CL4'HDR-'           HDR PIC X(4)
D0003    DC    5CL3' '             E PIC X(3) table
         DS    XL5                 reserve the rest of a table
D0004    DC    CL19'...................'  OUT-AREA PIC X(19) VALUE ALL
         DS    XL5                 reserve the rest of a table
D0005    DS    0CL19               BACK (01 group)
D0006    DC    CL4' '              BHDR PIC X(4)
D0007    DC    5CL3' '             BE PIC X(3) table
         DS    XL5                 reserve the rest of a table
D0008    DC    CL19'hdr:aaabbbcccdddeee'  LONG-SRC PIC X(19)
         DS    XL5                 reserve the rest of a table
D0009    DC    CL2'00'             M PIC 9(2)v0 DISP
*---------------------------------------------------------------
