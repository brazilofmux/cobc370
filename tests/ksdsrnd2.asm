*---------------------------------------------------------------
* Generated by cobc370 from ksdsrnd2.cbl
...
* MOVE 0000000003 -> K-KEY
         MVC   D0002(10),S0009     literal move, space padded
T0013    DS    0H
* MOVE TROIS -> K-TEXT
         MVC   D0003(5),S0010      literal move, space padded
T0014    DS    0H
* REWRITE K-REC
         MVC   FD000S(80),D0001    keep the record area
         GET   RPL=FD000R          hold the record the key names
...
* MOVE 0000000002 -> K-KEY
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0002(10),S0012     literal move, space padded
T0017    DS    0H
* READ K-FILE
...
T0019    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0014
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+5(10),D0002+0
         MVC   DSPBUF+15(1),S0015
...
WK5      DS    PL16
* file control blocks
FD000    ACB   DDNAME=KSDSF01,MACRF=(KEY,DIR,OUT)  VSAM access method c
...
S0002    DC    CL10'0000000004'
S0003    DC    CL5'QUATR'
S0004    DC    CL18'REWRITE 4 INVALID '
S0005    DC    CL10'REWRITE 4 '
S0006    DC    CL10'0000000001'
S0007    DC    CL17'DELETE 1 INVALID '
S0008    DC    CL9'DELETE 1 '
S0009    DC    CL10'0000000003'
S0010    DC    CL5'TROIS'
S0011    DC    CL18'REWRITE 3 INVALID '
S0012    DC    CL10'0000000002'
S0013    DC    CL15'READ 2 INVALID '
S0014    DC    CL5'READ '
S0015    DC    CL1' '
S0016    DC    CL15'READ 4 INVALID '
S0017    DC    CL15'READ 1 INVALID '
...
SPIELTB  DS    0F
         ...
         DC    A(T0021-COBBEG),AL2(48,0)
         DC    A(T0022-COBBEG),AL2(48,0)
         DC    A(T0023-COBBEG),AL2(49,0)
         DC    A(T0024-COBBEG),AL2(50,0)
         DC    A(T0025-COBBEG),AL2(52,0)
         DC    A(T0026-COBBEG),AL2(52,0)
         DC    A(T0027-COBBEG),AL2(53,0)
         DC    A(T0028-COBBEG),AL2(54,0)
