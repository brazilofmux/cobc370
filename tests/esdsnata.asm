*---------------------------------------------------------------
* Generated by cobc370 from esdsnata.cbl
...
P0005    DS    0H
T0019    DS    0H
* MOVE RECORD-IMAGE -> ESDS-RECORD
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(80),D0001     alphanumeric move
T0020    DS    0H
* MOVE N -> WRITE-FAILED-SWITCH
         MVC   D0007(1),S0008      literal move, space padded
T0021    DS    0H
* WRITE ESDS-RECORD
...
* IF
         ...
         CLC   D0007(1),S0006      alphanumeric compare
         BNE   L0008
         CLC   D0004(2),S0009      alphanumeric compare
         BNE   L0008
T0026    DS    0H
* DISPLAY
         MVC   DSPBUF+0(37),S0010
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0027    DS    0H
...
S0001    DC    CL42'ESDSADDT: WRITE (EXTEND) ESDS SEQUENTIALLY'  nonnum
S0002    DC    CL42'------------------------------------------'
S0003    DC    CL1' '
S0004    DC    CL2'00'
S0005    DC    CL31'VSAM ERROR DURING OPEN, STATUS '
S0006    DC    CL1'Y'
S0007    DC    CL32' RECORDS WERE ADDED SUCCESSFULLY'
S0008    DC    CL1'N'
S0009    DC    CL2'24'
S0010    DC    CL37'INSUFFICIENT SPACE DEFINED IN CLUSTER'
S0011    DC    CL28'VSAM ERROR ON WRITE, STATUS '
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0014-COBBEG),AL2(49)
         DC    AL2(T0015-COBBEG),AL2(49)
         DC    AL2(T0016-COBBEG),AL2(51)
         DC    AL2(T0017-COBBEG),AL2(51)
         DC    AL2(T0018-COBBEG),AL2(53)
         DC    AL2(T0019-COBBEG),AL2(55)
         DC    AL2(T0020-COBBEG),AL2(56)
         DC    AL2(T0021-COBBEG),AL2(58)
         DC    AL2(T0022-COBBEG),AL2(58)
         DC    AL2(T0023-COBBEG),AL2(60)
         DC    AL2(T0024-COBBEG),AL2(60)
         DC    AL2(T0025-COBBEG),AL2(62)
         DC    AL2(T0026-COBBEG),AL2(62)
         DC    AL2(T0027-COBBEG),AL2(63)
         DC    AL2(T0028-COBBEG),AL2(65)
         DC    AL2(T0029-COBBEG),AL2(65)
         DC    AL2(T0030-COBBEG),AL2(66)
         DC    AL2(T0031-COBBEG),AL2(68)
COBWS    CSECT
...
D0003    DC    CL80' '             ESDS-RECORD PIC X(80)
...
D0007    DC    CL1'N'              WRITE-FAILED-SWITCH PIC X(1)
         DS    XL7                 reserve the rest of a table
