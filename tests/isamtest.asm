*---------------------------------------------------------------
* Generated by cobc370 from tests/isamtest.cbl
...
* READ GLACCT
         MVI   ISFLG,X'00'
         READ  DB013,K,FD000,D0000,'S',D0008  random by NOMINAL KEY
         CHECK DB013
         CLI   ISFLG,X'00'         record found?
         BE    L0002
...
* BISAM error exit: CHECK routes a missing record here
...
D0008    DC    PL6'0'              WS-NOM-KEY PIC 9(10)v0 COMP-3
D0009    DC    ZL10'0'             OUT-KEY PIC 9(10)v0 DISP
D0010    DC    H'0'                WS-IDX PIC S9(4)v0 COMP
