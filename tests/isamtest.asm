...
* DISPLAY
         ...
         MVC   DSPBUF+6(10),D0009
         MVC   DSPBUF+16(1),S0002
         MVC   DSPBUF+17(40),D0007
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0015    DS    0H
