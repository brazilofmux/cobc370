*---------------------------------------------------------------
* Generated by cobc370 from isamtest.cbl
...
* MOVE 9999999999 -> WS-NOM-KEY
         ZAP   PWK1(16),K0004+10(6)  literal
         L     8,BL0000            base locator
         USING WSC0000,8
         ZAP   D0009(6),PWK1(16)
         OI    D0009+5,X'0F'       unsigned: force an F sign
...
* DISPLAY
         ...
         MVC   DSPBUF+6(10),D0010+0
         MVC   DSPBUF+16(1),S0002
         MVC   DSPBUF+17(40),D0008+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0015    DS    0H
...
PA0002   DC    A(P0002)            SHOW-MISS
PA0003   DC    A(P0003)            SHOW-EXIT
