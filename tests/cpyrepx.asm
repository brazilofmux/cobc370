*---------------------------------------------------------------
* Generated by cobc370 from cpyrepx.cbl
...
* MOVE HELLO -> NEWX
         ...
         USING WSC0000,8
         MVC   D0001(5),S0001      literal move, space padded
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(6),S0002
         MVC   DSPBUF+6(5),D0001+0
         MVC   DSPBUF+11(3),S0003
         MVC   DSPBUF+14(5),D0002+0
         MVC   DSPBUF+19(1),S0004
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL5'HELLO'          nonnumeric constants
S0002    DC    CL6'COPY ['
S0003    DC    CL3'] ['
S0004    DC    CL1']'
...
* WORKING-STORAGE
D0000    DS    0CL10               CPYREC (01 group)
D0001    DC    CL5' '              NEWX PIC X(5)
D0002    DC    CL5'X'              NEWX-LIT PIC X(5)
*---------------------------------------------------------------
