*---------------------------------------------------------------
* Generated by cobc370 from accept.cbl
...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+7(20),D0000+0
         MVC   DSPBUF+27(1),S0002
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+8(20),D0002+0
         MVC   DSPBUF+28(1),S0002
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0006    DS    0H
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL7'ONE   ['        nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL7'TWO   ['
S0004    DC    CL8'PASTEOF['
...
* WORKING-STORAGE
D0000    DC    CL20' '             L1 PIC X(20)
         DS    XL4                 reserve the rest of a table
D0001    DC    CL20' '             L2 PIC X(20)
         DS    XL4                 reserve the rest of a table
D0002    DC    CL20' '             L3 PIC X(20)
*---------------------------------------------------------------
