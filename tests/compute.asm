*---------------------------------------------------------------
* Generated by cobc370 from compute.cbl
...
* COMPUTE R1 = ...
         ...
         USING WSC0000,8
         ZAP   WK0+6(10),D0000(4)
         ZAP   WK1+6(10),D0001(4)
         L     2,D0002
         CVD   2,DWK               binary -> packed
         ZAP   WK2+10(6),DWK(8)
         MP    WK1+6(10),WK2+10(6)  scale becomes the sum of the scales
         AP    WK0+6(10),WK1+6(10)
         UNPK  D0003(9),WK0+6(10)  packed -> zoned
...
* COMPUTE R2 = ...
         ...
         CVD   2,DWK               binary -> packed
         ZAP   WK1+10(6),DWK(8)
         MP    WK0+5(11),WK1+10(6)  scale becomes the sum of the scales
         UNPK  D0004(9),WK0+5(11)  packed -> zoned
...
* COMPUTE R3 = ...
         ...
         UNPK  D0005(9),WK0+9(7)   packed -> zoned
...
* COMPUTE R4 ROUNDED = ...
         ...
         ZAP   QTMP(7),WK0+5(7)    the quotient on its own
         ZAP   WK0+9(7),QTMP(7)    drop the remainder
         SRP   WK0+9(7),60,5       align scale (right, ROUNDED)
         UNPK  D0006(9),WK0+9(7)   packed -> zoned
         OI    D0006+8,X'F0'       unsigned: force an F zone
T0004    DS    0H
* COMPUTE R5 = ...
         ZAP   WK1+12(4),D0001(4)
         ZAP   WK0+11(5),K0001+15(1)  unary minus
         SP    WK0+11(5),WK1+12(4)
         AP    WK0+11(5),D0000(4)
         UNPK  D0007(9),WK0+11(5)  packed -> zoned
...
* COMPUTE R6 = ...
         ...
         CVD   2,DWK               binary -> packed
         ZAP   WK1+10(6),DWK(8)
         SRP   WK0+4(12),4,0       align scale (left)
         DP    WK0+4(12),WK1+10(6)  quotient, then the remainder
         ZAP   QTMP(6),WK0+4(6)    the quotient on its own
         ZAP   WK0+10(6),QTMP(6)   drop the remainder
         SRP   WK0+10(6),60,0      align scale (right)
         UNPK  D0008(9),WK0+10(6)  packed -> zoned
         OI    D0008+8,X'F0'       unsigned: force an F zone
T0006    DS    0H
* COMPUTE R7 ROUNDED = ...
         ZAP   WK0+3(13),D0000(4)
         AP    WK0+3(13),D0001(4)
         L     2,D0002
         CVD   2,DWK               binary -> packed
         ZAP   WK1+10(6),DWK(8)
         SRP   WK0+3(13),4,0       align scale (left)
         DP    WK0+3(13),WK1+10(6)  quotient, then the remainder
         ZAP   QTMP(7),WK0+3(7)    the quotient on its own
         ZAP   WK0+9(7),QTMP(7)    drop the remainder
         SRP   WK0+9(7),60,5       align scale (right, ROUNDED)
         UNPK  D0009(9),WK0+9(7)   packed -> zoned
         OI    D0009+8,X'F0'       unsigned: force an F zone
T0007    DS    0H
* DISPLAY
         MVC   DSPBUF+0(9),D0003+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0008    DS    0H
* DISPLAY
         MVC   DSPBUF+0(9),D0004+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0009    DS    0H
* DISPLAY
         MVC   DSPBUF+0(9),D0005+0
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0010    DS    0H
* DISPLAY
         MVC   DSPBUF+0(9),D0006+0
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0011    DS    0H
* DISPLAY
         MVC   DSPBUF+0(9),D0007+0
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
T0012    DS    0H
* DISPLAY
         MVC   DSPBUF+0(9),D0008+0
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0013    DS    0H
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0002-COBBEG),AL2(18)
         DC    AL2(T0003-COBBEG),AL2(19)
         DC    AL2(T0004-COBBEG),AL2(20)
         DC    AL2(T0005-COBBEG),AL2(21)
         DC    AL2(T0006-COBBEG),AL2(22)
         DC    AL2(T0007-COBBEG),AL2(23)
         DC    AL2(T0008-COBBEG),AL2(24)
         DC    AL2(T0009-COBBEG),AL2(25)
         DC    AL2(T0010-COBBEG),AL2(26)
         DC    AL2(T0011-COBBEG),AL2(27)
...
D0001    DC    PL4'600'            B PIC S9(7)v2 COMP-3
         DS    XL4                 reserve the rest of a table
D0002    DC    FL4'7'              C PIC S9(5)v0 COMP
         DS    XL4                 reserve the rest of a table
D0003    DC    CL9'000000000'      R1 PIC 9(9)v2 DISP
         DS    XL7                 reserve the rest of a table
D0004    DC    CL9'000000000'      R2 PIC 9(9)v2 DISP
         DS    XL7                 reserve the rest of a table
D0005    DC    CL9'000000000'      R3 PIC 9(9)v2 DISP
         DS    XL7                 reserve the rest of a table
D0006    DC    CL9'000000000'      R4 PIC 9(9)v2 DISP
         DS    XL7                 reserve the rest of a table
D0007    DC    CL9'000000000'      R5 PIC 9(9)v2 DISP
         DS    XL7                 reserve the rest of a table
D0008    DC    CL9'000000000'      R6 PIC 9(9)v2 DISP
         DS    XL7                 reserve the rest of a table
D0009    DC    CL9'000000000'      R7 PIC 9(9)v2 DISP
*---------------------------------------------------------------
