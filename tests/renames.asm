*---------------------------------------------------------------
* Generated by cobc370 from renames.cbl
...
* DISPLAY
         MVC   DSPBUF+0(1),S0001
         MVC   DSPBUF+1(4),D0010+0
         MVC   DSPBUF+5(2),S0002
         MVC   DSPBUF+7(7),D0011+0
...
* DISPLAY
         MVC   DSPBUF+0(1),S0001
         MVC   DSPBUF+1(3),D0002+0
         MVC   DSPBUF+4(2),S0002
         MVC   DSPBUF+6(3),D0012+0
...
T0005    DS    0H
* MOVE XYZWV -> BC
         MVC   D0008(5),S0004      literal move, space padded
T0006    DS    0H
* DISPLAY
         MVC   DSPBUF+0(1),S0001
         MVC   DSPBUF+1(13),D0000+0
         MVC   DSPBUF+14(1),S0003
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0007    DS    0H
* MOVE QQ -> DD
         MVC   D0010(4),S0005      literal move, space padded
T0008    DS    0H
* IF
         CLC   D0011(7),S0006      alphanumeric compare
         BNE   L0001
T0009    DS    0H
* DISPLAY
...
L0002    DS    0H
T0012    DS    0H
* ALTER SWITCH TO PROCEED TO SECOND-P
         LA    15,P0002            the new target
         ST    15,AL0003           into that paragraph's branch cell
T0013    DS    0H
* GO TO SWITCH
         B     P0003
* FIRST-P.
...
* DISPLAY
         ...
         BALR  14,15
T0017    DS    0H
* ALTER SWITCH TO PROCEED TO FIRST-P
         LA    15,P0001            the new target
         ST    15,AL0003           into that paragraph's branch cell
T0018    DS    0H
* GO TO SWITCH
         B     P0003
...
T0019    DS    0H
* GO TO 
         L     15,AL0003           the current target
         BR    15
* DONE.
P0004    DS    0H
T0020    DS    0H
...
AL0003   DC    A(0)                bare GO TO: undefined until ALTERed
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
S0007    DC    CL6'CDE OK'
S0008    DC    CL5'CDE ['
S0009    DC    CL7'FIRST-P'
S0010    DC    CL8'SECOND-P'
...
SPIENUM  DC    H'21'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0002-COBBEG),AL2(27)
         DC    AL2(T0003-COBBEG),AL2(28)
         DC    AL2(T0004-COBBEG),AL2(29)
         ...
         DC    AL2(T0016-COBBEG),AL2(41)
         DC    AL2(T0017-COBBEG),AL2(42)
         DC    AL2(T0018-COBBEG),AL2(43)
         DC    AL2(T0019-COBBEG),AL2(45)
         DC    AL2(T0020-COBBEG),AL2(47)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DS    0CL13               REC (01 group)
D0001    DC    CL3'AAA'            A PIC X(3)
D0002    DC    CL3'123'            B PIC 9(3)v0 DISP
D0003    DC    CL2'CC'             C PIC X(2)
D0004    DS    0CL4                D (05 group)
D0005    DC    CL2'D1'             D1 PIC X(2)
D0006    DC    CL2'D2'             D2 PIC X(2)
D0007    DC    CL1'E'              E PIC X(1)
D0008    EQU   COBWS+3             BC REDEFINES
D0009    EQU   COBWS+3             BB REDEFINES
D0010    EQU   COBWS+8             DD REDEFINES
D0011    EQU   COBWS+6             CDE REDEFINES
         DS    XL3                 reserve the rest of a table
D0012    DC    CL3'000'            N PIC 9(3)v0 DISP
*---------------------------------------------------------------
