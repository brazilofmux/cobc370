*---------------------------------------------------------------
* Generated by cobc370 from corresp.cbl
...
* DISPLAY
         ...
         MVC   DSPBUF+1(8),D0014
         MVC   DSPBUF+9(2),S0002
         MVC   DSPBUF+11(3),D0016
...
* DISPLAY
         MVC   DSPBUF+0(1),S0001
         MVC   DSPBUF+1(5),D0019
         MVC   DSPBUF+6(2),S0002
         MVC   DSPBUF+8(5),D0018
         MVC   DSPBUF+13(2),S0002
         MVC   DSPBUF+15(3),D0020
...
* DISPLAY
         MVC   DSPBUF+0(1),S0001
         MVC   DSPBUF+1(6),D0027
         MVC   DSPBUF+7(2),S0002
         MVC   DSPBUF+9(3),D0022
...
* DISPLAY
         MVC   DSPBUF+0(1),S0001
         MVC   DSPBUF+1(1),D0029
         MVC   DSPBUF+2(2),S0002
         MVC   DSPBUF+4(1),D0025
...
* DISPLAY
         ...
         MVC   DSPBUF+5(6),D0027
         MVC   DSPBUF+11(2),S0002
         MVC   DSPBUF+13(3),D0028
         MVC   DSPBUF+16(2),S0002
         MVC   DSPBUF+18(5),D0018
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0001-COBBEG),AL2(42)
         DC    AL2(T0002-COBBEG),AL2(42)
         ...
         DC    AL2(T0008-COBBEG),AL2(46)
         DC    AL2(T0009-COBBEG),AL2(47)
         DC    AL2(T0010-COBBEG),AL2(48)
         DC    AL2(T0011-COBBEG),AL2(49)
         DC    AL2(T0012-COBBEG),AL2(50)
         DC    AL2(T0013-COBBEG),AL2(50)
         DC    AL2(T0014-COBBEG),AL2(50)
         DC    AL2(T0015-COBBEG),AL2(51)
         DC    AL2(T0016-COBBEG),AL2(52)
         DC    AL2(T0017-COBBEG),AL2(53)
         DC    AL2(T0018-COBBEG),AL2(54)
         DC    AL2(T0019-COBBEG),AL2(54)
         ...
         DC    AL2(T0025-COBBEG),AL2(60)
         DC    AL2(T0026-COBBEG),AL2(60)
         DC    AL2(T0027-COBBEG),AL2(60)
         DC    AL2(T0028-COBBEG),AL2(60)
         DC    AL2(T0029-COBBEG),AL2(61)
         DC    AL2(T0030-COBBEG),AL2(62)
         DC    AL2(T0031-COBBEG),AL2(63)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DS    0CL34               SRC-REC (01 group)
D0001    DC    CL6'ALICE'          NAME PIC X(6)
D0002    DC    CL2'ZZ'             FILL0002 PIC X(2)
D0003    DC    CL2'30'             AGE PIC 9(2)v0 DISP
D0004    DS    0CL13               ADDR (05 group)
D0005    DC    CL5'PARIS'          CITY PIC X(5)
D0006    DC    CL5'75001'          ZIP PIC 9(5)v0 DISP
D0007    DC    CL3'XYZ'            EXTRA PIC X(3)
...
D0014    DC    CL8'BOB'            NAME PIC X(8)
D0015    DC    CL2'QQ'             FILL0015 PIC X(2)
D0016    DC    CL3'999'            AGE PIC 9(3)v0 DISP
D0017    DS    0CL13               ADDR (05 group)
D0018    DC    CL5'00000'          ZIP PIC 9(5)v0 DISP
D0019    DC    CL5'ROME'           CITY PIC X(5)
D0020    DC    CL3'OTH'            OTHR PIC X(3)
...
D0028    DC    CL3' '              E-AGE edited, 3 chars
         DS    XL5                 reserve the rest of a table
D0029    DC    CL1'0'              T1 PIC 9(1)v0 DISP
*---------------------------------------------------------------
