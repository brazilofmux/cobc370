*---------------------------------------------------------------
* Generated by cobc370 from godep10.cbl
...
L0001    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  WK0+15(1),D0005(1)  zoned -> packed
...
R0002    DS    0H
         DROP  8
         LA    15,F0013            restore fall-through
         ST    15,X0013
T0003    DS    0H
* STOP RUN
...
* GO TO ... DEPENDING ON SEL
         ...
         BNL   L0008               out of range: fall through
         SLL   2,2                 four bytes per entry
         B     L0007(2)            into the table
L0007    DS    0H
         B     P0003               P1
         B     P0004               P2
         B     P0005               P3
...
X0001    DC    A(F0001)            TRY-ONE
X0013    DC    A(F0013)            DISPATCH-EXIT
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
S0004    DC    CL12'LANDED IN P3'
S0005    DC    CL12'LANDED IN P4'
S0006    DC    CL12'LANDED IN P5'
S0007    DC    CL12'LANDED IN P6'
S0008    DC    CL12'LANDED IN P7'
S0009    DC    CL12'LANDED IN P8'
S0010    DC    CL12'LANDED IN P9'
S0011    DC    CL13'LANDED IN P10'
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0019-COBBEG),AL2(44)
         DC    AL2(T0020-COBBEG),AL2(45)
         DC    AL2(T0021-COBBEG),AL2(47)
         DC    AL2(T0022-COBBEG),AL2(48)
         DC    AL2(T0023-COBBEG),AL2(50)
         DC    AL2(T0024-COBBEG),AL2(51)
         DC    AL2(T0025-COBBEG),AL2(53)
         DC    AL2(T0026-COBBEG),AL2(54)
         DC    AL2(T0027-COBBEG),AL2(56)
         DC    AL2(T0028-COBBEG),AL2(57)
         DC    AL2(T0029-COBBEG),AL2(59)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    HL2'0'              SEL PIC S9(4)v0 COMP
         DS    XL6                 reserve the rest of a table
D0001    DS    0CL10               VALS (01 group)
D0002    DC    CL10'0103091011'    FILL0002 PIC X(10)
D0003    EQU   COBWS+8             VTAB REDEFINES
D0004    EQU   COBWS+8             V REDEFINES
         DS    XL6                 reserve the rest of a table
D0005    DC    CL1'0'              I PIC 9(1)v0 DISP
*---------------------------------------------------------------
