*---------------------------------------------------------------
* Generated by cobc370 from justif.cbl
...
* MOVE SRC-4 -> PLAIN-8
         ...
         USING WSC0000,8
         MVC   D0000(4),D0003      alphanumeric move
         MVI   D0000+4,C' '        space fill the remainder
         MVC   D0000+5(3),D0000+4
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(12),S0001
         MVC   DSPBUF+12(8),D0000+0
         MVC   DSPBUF+20(1),S0002
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
* MOVE SRC-4 -> RIGHT-8
         MVI   D0001,C' '          space fill on the left
         MVC   D0001+1(3),D0001
         MVC   D0001+4(4),D0003+0  JUSTIFIED: aligned right
T0003    DS    0H
* DISPLAY
         MVC   DSPBUF+0(12),S0003
         MVC   DSPBUF+12(8),D0001+0
         MVC   DSPBUF+20(1),S0002
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0004    DS    0H
* MOVE SRC-9 -> PLAIN-8
         MVC   D0000(8),D0004      alphanumeric move
T0005    DS    0H
* DISPLAY
...
T0006    DS    0H
* MOVE SRC-9 -> RIGHT-8
         MVC   D0001+0(8),D0004+1  JUSTIFIED: aligned right
T0007    DS    0H
* DISPLAY
...
T0008    DS    0H
* MOVE SRC-4 -> RIGHT-3
         MVC   D0002+0(3),D0003+1  JUSTIFIED: aligned right
T0009    DS    0H
* DISPLAY
         MVC   DSPBUF+0(12),S0006
         MVC   DSPBUF+12(3),D0002+0
...
T0010    DS    0H
* MOVE AB -> RIGHT-8
         MVC   D0001(8),S0007      literal move, space padded
T0011    DS    0H
* DISPLAY
...
* MOVE NUM-3 -> RIGHT-8
         MVI   D0001,C' '          space fill on the left
         MVC   D0001+1(4),D0001
         MVC   D0001+5(3),D0005+0  JUSTIFIED: aligned right
T0013    DS    0H
* DISPLAY
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL12'PLAIN 4->8 ['  nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL12'JUST  4->8 ['
S0004    DC    CL12'PLAIN 9->8 ['
S0005    DC    CL12'JUST  9->8 ['
S0006    DC    CL12'JUST  4->3 ['
S0007    DC    CL8'      AB'
S0008    DC    CL12'JUST lit   ['
S0009    DC    CL12'JUST num   ['
...
* WORKING-STORAGE
D0000    DC    CL8' '              PLAIN-8 PIC X(8)
D0001    DC    CL8' '              RIGHT-8 PIC X(8)
D0002    DC    CL3' '              RIGHT-3 PIC X(3)
         DS    XL5                 reserve the rest of a table
D0003    DC    CL4'ABCD'           SRC-4 PIC X(4)
         DS    XL4                 reserve the rest of a table
D0004    DC    CL9'123456789'      SRC-9 PIC X(9)
         DS    XL7                 reserve the rest of a table
D0005    DC    CL3'042'            NUM-3 PIC 9(3)v0 DISP
*---------------------------------------------------------------
