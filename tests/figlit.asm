*---------------------------------------------------------------
* Generated by cobc370 from figlit.cbl
...
* MOVE ALL literal -> X
         ...
         MVC   0(2,1),S0001        the unit
         MVC   2(5,1),0(1)         propagate across the item
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(1),S0002
         MVC   DSPBUF+1(7),D0000+0
         MVC   DSPBUF+8(1),S0003
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
* IF
         CLC   D0000(7),S0004      alphanumeric compare
         BNE   L0001
T0003    DS    0H
* DISPLAY
         MVC   DSPBUF+0(11),S0005
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
         DROP  8
...
* MOVE ALL literal -> Y
         L     8,BL0000            base locator
         USING WSC0000,8
         LA    1,D0001             ALL literal
         MVC   0(1,1),S0006        the unit
         MVC   1(2,1),0(1)         propagate across the item
T0005    DS    0H
* DISPLAY
         MVC   DSPBUF+0(1),S0002
         MVC   DSPBUF+1(3),D0001+0
...
T0006    DS    0H
* MOVE HIGH-VALUES -> X
         LA    1,D0000             HIGH-VALUES
         MVI   0(1),X'FF'
         MVC   1(6,1),0(1)         propagate across the item
T0007    DS    0H
* IF
         CLC   D0000(7),HVALS      alphanumeric compare
         BNE   L0002
T0008    DS    0H
* DISPLAY
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0000(7),LVALS      alphanumeric compare
         BE    L0003
T0010    DS    0H
* DISPLAY
...
* MOVE LOW-VALUES -> Y
         L     8,BL0000            base locator
         USING WSC0000,8
         LA    1,D0001             LOW-VALUES
         MVI   0(1),X'00'
         MVC   1(2,1),0(1)         propagate across the item
T0012    DS    0H
* IF
         CLC   D0001(3),LVALS      alphanumeric compare
         BNE   L0004
T0013    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0009
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
         DROP  8
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0001(3),HVALS      alphanumeric compare
         BNL   L0005
T0015    DS    0H
* DISPLAY
...
T0017    DS    0H
* IF
         CLC   D0002(4),QVALS      alphanumeric compare
         BNE   L0006
T0018    DS    0H
* DISPLAY
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0002(4),S0012      alphanumeric compare
         BE    L0007
T0020    DS    0H
* DISPLAY
...
* MOVE ALL literal -> E
         ...
         LA    1,0(,6)             ALL literal
         MVC   0(3,1),S0014        the unit
         MVC   3(1,1),0(1)         propagate across the item
T0022    DS    0H
* MOVE E -> Y4
         LA    7,1                 subscript-1
         MH    7,H0001             times element size
         LA    7,D0008(7)          element address
         MVC   D0005(4),0(7)       alphanumeric move
T0023    DS    0H
* DISPLAY
         MVC   DSPBUF+0(1),S0002
         MVC   DSPBUF+1(4),D0005+0
         MVC   DSPBUF+5(1),S0003
         LA    1,PARM0010
         L     15,VDISP
         BALR  14,15
T0024    DS    0H
* MOVE LONG-DATA-NAME-ONE -> N
...
* ADD 123455 -> N
         ...
         ZAP   PWK2(16),K0001+12(4)  literal
...
* MOVE N -> E-N
         ...
         MVC   EDWK(11),M0001      load the ED pattern
         ED    EDWK(11),EDSRC
         MVC   D0004(8),EDWK+3     the edited result
T0027    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),D0004+0
         LA    1,PARM0011
         L     15,VDISP
         BALR  14,15
T0028    DS    0H
...
HVALS    DC    256X'FF'            HIGH-VALUES, for comparison
LVALS    DC    256X'00'            LOW-VALUES, for comparison
...
WK4      DS    PL16
WK5      DS    PL16
K0001    EQU   *-12                numeric constants, as long as used
         DC    PL4'123455'
...
S0002    DC    CL1'['
S0003    DC    CL1']'
S0004    DC    CL7'ABABABA'
S0005    DC    CL11'X IS ALL AB'
S0006    DC    CL1'-'
S0007    DC    CL9'X IS HIGH'
S0008    DC    CL12'X IS NOT LOW'
S0009    DC    CL8'Y IS LOW'
S0010    DC    CL14'LOW BELOW HIGH'
S0011    DC    CL11'Q IS QUOTES'
S0012    DC    CL4'    '
...
SPIELTB  DS    0F
         ...
         DC    A(T0030-COBBEG),AL2(43,0)
         DC    A(T0031-COBBEG),AL2(44,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL7'ABCDEFG'        X PIC X(7)
         DS    XL1                 reserve the rest of a table
D0001    DC    CL3'XYZ'            Y PIC X(3)
         DS    XL5                 reserve the rest of a table
D0002    DC    CL4' '              Q PIC X(4)
         DS    XL4                 reserve the rest of a table
D0003    DC    CL7'0000000'        N PIC 9(7)v2 DISP
         DS    XL1                 reserve the rest of a table
D0004    DC    CL8' '              E-N edited, 8 chars
D0005    DC    CL4' '              Y4 PIC X(4)
         DS    XL4                 reserve the rest of a table
D0006    DC    CL5'12345'          LONG-DATA-NAME-ONE PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0007    DS    0CL12               T (01 group)
D0008    DC    3CL4' '             E PIC X(4) table
*---------------------------------------------------------------
