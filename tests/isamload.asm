*---------------------------------------------------------------
* Generated by cobc370 from isamload.cbl
...
* OPEN INPUT DESCIN
         ...
         BO    L0005
         WTO   'COBC370: OPEN FAILED, DD DESCIN',ROUTCDE=11
         ABEND 35
         B     L0006
L0005    DS    0H
L0006    DS    0H
...
ISYNAD   MVI   ISFLG,X'01'
         BR    14
ISFLG    DC    X'00'
X0002    DC    A(F0002)            A002-READ-END
X0003    DC    A(F0003)            A003-PROCESS
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
PA0001   DC    A(P0001)            A002-READ
PA0003   DC    A(P0003)            A003-PROCESS
...
SPIELTB  DS    0F
         ...
         DC    A(T0014-COBBEG),AL2(51,0)
         DC    A(T0015-COBBEG),AL2(52,0)
         DC    A(T0016-COBBEG),AL2(53,0)
