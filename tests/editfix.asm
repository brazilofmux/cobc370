*---------------------------------------------------------------
* Generated by cobc370 from editfix.cbl
...
* MOVE N -> E1
         ...
         MVC   EDWK(8),M0001       load the ED pattern
         ED    EDWK(8),EDSRC
         MVI   EDWK+1,X'5B'        the fixed currency symbol
         MVC   D0005(7),EDWK+1     the edited result
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0001
         MVC   DSPBUF+5(7),D0005+0
...
* MOVE N -> E1S
         ...
         ED    EDWK(10),EDSRC
         MVI   EDWK+2,X'5B'        the fixed currency symbol
         MVC   D0006(8),EDWK+2     the edited result
T0003    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0003
         MVC   DSPBUF+5(8),D0006+0
         MVC   DSPBUF+13(1),S0002
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0004    DS    0H
* MOVE NM -> E2
         PACK  PWK1(16),D0001(7)   zoned -> packed
         ZAP   EDSRC(4),PWK1(16)   source, sized to the selector count
         MVC   EDWK(12),M0003      load the ED pattern
         LA    1,EDWK+7            where printing starts if EDMK stays
         EDMK  EDWK(12),EDSRC
         BCTR  1,0                 one left of the first significant di
         MVI   0(1),X'5B'          the floating currency symbol
         BNM   G0001               not negative?
         MVI   EDWK+11,C'-'
         B     G0002
G0001    MVI   EDWK+11,C' '
G0002    DS    0H
         MVC   D0007(11),EDWK+1    the edited result
T0005    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0004
         MVC   DSPBUF+5(11),D0007+0
...
T0008    DS    0H
* MOVE NS -> E3
         PACK  PWK1(16),D0002(7)   zoned -> packed
         ZAP   EDSRC(3),PWK1(16)   source, sized to the selector count
         NI    EDSRC,X'0F'         truncate to the picture: the spare d
         MVC   EDWK(7),M0004       load the ED pattern
         CP    EDSRC(3),K0001+15(1)  zero: nothing to show
         BE    G0005
         ED    EDWK(7),EDSRC
         B     G0006
G0005    DS    0H                  zero: all fill
         MVC   EDWK+2(5),SPCS
G0006    DS    0H
         MVC   D0008(5),EDWK+2     the edited result
T0009    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0006
         MVC   DSPBUF+5(5),D0008+0
...
* MOVE NZ -> E3
         ...
         ED    EDWK(7),EDSRC
         B     G0008
G0007    DS    0H                  zero: all fill
         MVC   EDWK+2(5),SPCS
G0008    DS    0H
         MVC   D0008(5),EDWK+2     the edited result
T0011    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0007
         MVC   DSPBUF+5(5),D0008+0
         MVC   DSPBUF+10(1),S0002
         LA    1,PARM0006
         L     15,VDISP
...
T0012    DS    0H
* MOVE NB -> E4
         PACK  PWK1(16),D0004(5)   zoned -> packed
         ZAP   EDSRC(3),PWK1(16)   source, sized to the selector count
         NI    EDSRC,X'0F'         truncate to the picture: the spare d
         MVC   EDWK(6),M0005       load the ED pattern
         ED    EDWK(6),EDSRC
         MVC   D0009(4),EDWK+2     the edited result
T0013    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0008
         MVC   DSPBUF+5(4),D0009+0
...
* MOVE N -> E6
         PACK  PWK1(16),D0000(7)   zoned -> packed
         ZAP   EDSRC(3),PWK1(16)   source, sized to the selector count
         MVC   EDWK(8),M0006       load the ED pattern
         ED    EDWK(8),EDSRC
...
G0009    MVI   EDWK+7,C' '
G0010    DS    0H
         MVC   D0010(7),EDWK+1     the edited result
T0015    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0009
         MVC   DSPBUF+5(7),D0010+0
         MVC   DSPBUF+12(1),S0002
         LA    1,PARM0008
         L     15,VDISP
         BALR  14,15
...
* MOVE NZ -> E8
         ...
         MVC   EDWK(5),M0007       load the ED pattern
         CP    EDSRC(2),K0001+15(1)  zero: nothing to show
         BE    G0011
         LA    1,EDWK+2            where printing starts if EDMK stays
         EDMK  EDWK(5),EDSRC
         BCTR  1,0                 one left of the first significant di
...
G0014    DS    0H
         B     G0012
G0011    DS    0H                  zero: all fill
         MVC   EDWK+1(4),SPCS
G0012    DS    0H
         MVC   D0012(4),EDWK+1     the edited result
T0017    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0010
         MVC   DSPBUF+5(4),D0012+0
         MVC   DSPBUF+9(1),S0002
         LA    1,PARM0009
         L     15,VDISP
         BALR  14,15
...
* MOVE NZ -> E9
         ...
         MVI   0(1),X'5B'          the floating currency symbol
         B     G0016
G0015    DS    0H                  zero: all fill
         MVC   EDWK+1(4),SPCS
G0016    DS    0H
         MVC   D0013(4),EDWK+1     the edited result
T0019    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0011
         MVC   DSPBUF+5(4),D0013+0
         MVC   DSPBUF+9(1),S0002
         LA    1,PARM0010
         L     15,VDISP
         BALR  14,15
...
* MOVE NM -> E7
         ...
         SRP   PWK1(16),62,0       align scale (right)
         ZAP   EDSRC(2),PWK1(16)   source, sized to the selector count
         MVC   EDWK(5),M0008       load the ED pattern
         ED    EDWK(5),EDSRC
...
G0017    MVI   EDWK+4,C' '
G0018    DS    0H
         MVC   D0011(4),EDWK+1     the edited result
T0021    DS    0H
* MOVE E7 -> A2
         MVC   D0016(4),D0011      alphanumeric move
         MVI   D0016+4,C' '        space fill the remainder
         MVC   D0016+5(1),D0016+4
T0022    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0012
         MVC   DSPBUF+5(6),D0016+0
...
T0023    DS    0H
* MOVE S2 -> A1
         MVC   D0014(8),M0009      the insertion characters
         MVC   D0014+0(2),D0015+0  a run of data positions
T0024    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0013
         MVC   DSPBUF+5(8),D0014+0
         MVC   DSPBUF+13(1),S0002
         LA    1,PARM0012
         L     15,VDISP
         BALR  14,15
T0025    DS    0H
* MOVE ABCDEF -> A1
         MVC   D0014(8),S0014      literal move, space padded
T0026    DS    0H
* DISPLAY
...
K0001    EQU   *-15                numeric constants, as long as used
         DC    PL1'0'
M0001    DC    XL8'40402021204B2020'  ED patterns
M0002    DC    XL10'5C205C202021204B2020'
M0003    DC    XL12'404020206B2021204B202040'
M0004    DC    XL7'402020214B2020'
M0005    DC    XL6'402020202120'
M0006    DC    XL8'5C2021204B20205C'
M0007    DC    XL5'4040202020'
M0008    DC    XL5'4020212040'
M0009    DC    XL8'4040404040404040'
S0001    DC    CL5'F1  ['          nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL5'F1S ['
S0004    DC    CL5'F2- ['
S0005    DC    CL5'F2+ ['
...
SPIELTB  DS    0F
         ...
         DC    A(T0003-COBBEG),AL2(34,0)
         DC    A(T0004-COBBEG),AL2(35,0)
         DC    A(T0005-COBBEG),AL2(35,0)
         ...
         DC    A(T0026-COBBEG),AL2(45,0)
         DC    A(T0027-COBBEG),AL2(46,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    ZL7'500'            N PIC S9(7)v2 DISP
         DS    XL1                 reserve the rest of a table
D0001    DC    ZL7'-500'           NM PIC S9(7)v2 DISP
         DS    XL1                 reserve the rest of a table
D0002    DC    ZL7'-005'           NS PIC S9(7)v2 DISP
         DS    XL1                 reserve the rest of a table
D0003    DC    ZL7'000'            NZ PIC S9(7)v2 DISP
         DS    XL1                 reserve the rest of a table
D0004    DC    ZL5'10005'          NB PIC S9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0005    DC    CL7' '              E1 edited, 7 chars
         DS    XL1                 reserve the rest of a table
D0006    DC    CL8' '              E1S edited, 8 chars
D0007    DC    CL11' '             E2 edited, 11 chars
         DS    XL5                 reserve the rest of a table
D0008    DC    CL5' '              E3 edited, 5 chars
         DS    XL3                 reserve the rest of a table
D0009    DC    CL4' '              E4 edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0010    DC    CL7' '              E6 edited, 7 chars
         DS    XL1                 reserve the rest of a table
D0011    DC    CL4' '              E7 edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0012    DC    CL4' '              E8 edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0013    DC    CL4' '              E9 edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0014    DC    CL8' '              A1 PIC X(8)
D0015    DC    CL2'AB'             S2 PIC X(2)
         DS    XL6                 reserve the rest of a table
D0016    DC    CL6' '              A2 PIC X(6)
         DS    XL2                 reserve the rest of a table
D0017    DC    CL4' '              A4 PIC X(4)
*---------------------------------------------------------------
