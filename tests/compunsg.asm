*---------------------------------------------------------------
* Generated by cobc370 from compunsg.cbl
...
G0001    MVI   EDWK+2,C' '
G0002    DS    0H
         MVC   D0004(5),EDWK+2     the edited result
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),S0001
         MVC   DSPBUF+10(5),D0004+0
...
* MOVE X9 -> XD
         ...
         MVI   0(1),C'-'
G0005    DS    0H
         MVC   D0001(10),EDWK+1    the edited result
T0012    DS    0H
* DISPLAY
         MVC   DSPBUF+0(11),S0006
         MVC   DSPBUF+11(10),D0001+0
         MVC   DSPBUF+21(1),S0002
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
T0013    DS    0H
...
M0002    DC    XL11'4040202020202020202120'
H0001    DC    H'10'               element sizes
S0001    DC    CL10'UNSIGNED ['    nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL12'UNSIGNED POS'
S0004    DC    CL16'UNSIGNED NOT POS'
S0005    DC    CL18'UNSIGNED COMPUTE ['
S0006    DC    CL11'TRUNCATED ['
...
* WORKING-STORAGE
D0000    DC    FL4'0'              X9 PIC S9(9)v0 COMP
         DS    XL4                 reserve the rest of a table
D0001    DC    CL10' '             XD edited, 10 chars
         DS    XL6                 reserve the rest of a table
D0002    DC    CL10'9999999999'    W PIC 9(10)v0 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    HL2'5'              U PIC 9(4)v0 COMP
         DS    XL6                 reserve the rest of a table
D0004    DC    CL5' '              UD edited, 5 chars
*---------------------------------------------------------------
