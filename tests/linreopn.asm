*---------------------------------------------------------------
* Generated by cobc370 from linreopn.cbl
...
* OPEN OUTPUT P-FILE
         ...
         BO    L0011
         WTO   'COBC370: OPEN FAILED, DD PRTOUT',ROUTCDE=11
         ABEND 35
         B     L0012
L0011    DS    0H
         ...
         USING WSC0000,8
         MVC   D0003(2),=H'1'      LINAGE-COUNTER = 1 at OPEN
L0012    DS    0H
         DROP  8
T0001    DS    0H
* MOVE FIRST OPEN, LINE 1 -> P-LINE
         L     8,BL0000            base locator
         USING WSC0000,8
...
* DISPLAY
         ...
         BALR  14,15
T0013    DS    0H
* MOVE SECOND OPEN, LINE 1 -> P-LINE
...
L0008    DS    0H
T0015    DS    0H
* MOVE SECOND OPEN, LINE 2 -> P-LINE
         L     8,BL0000            base locator
         USING WSC0000,8
...
WK5      DS    PL16
* file control blocks
FD000    DCB   DDNAME=PRTOUT,DSORG=PS,MACRF=(PM),RECFM=FM,             X
               LRECL=20,BLKSIZE=20
FP000P   DC    A(FD000)            COBADV parameter list
         ...
         DC    X'80',AL3(D0003)    LINAGE-COUNTER
FP000L   DC    H'20'               the record length
FP000O   DC    H'0'                lines a BEFORE left owing
FP000Q   DS    H                   this line's request
FP000G   DC    H'5',H'0',H'0',H'0'  LINAGE, FOOTING, TOP, BOTTOM
S0001    DC    CL20'FIRST OPEN, LINE 1  '  nonnumeric constants
S0002    DC    CL20'FIRST OPEN, LINE 2  '
S0003    DC    CL20'FIRST OPEN, LINE 3  '
S0004    DC    CL13'BEFORE CLOSE '
S0005    DC    CL13'AFTER REOPEN '
S0006    DC    CL20'SECOND OPEN, LINE 1 '
S0007    DC    CL20'SECOND OPEN, LINE 2 '
S0008    DC    CL16'AFTER TWO LINES '
...
D0001    DC    CL20' '             P-LINE PIC X(20)
         DS    XL4                 reserve the rest of a table
D0002    DC    CL2'00'             LC-SHOW PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    HL2'1'              LINAGE-COUNTER PIC 9(4)v0 COMP
*---------------------------------------------------------------
