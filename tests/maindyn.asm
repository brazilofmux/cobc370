*---------------------------------------------------------------
* Generated by cobc370 from maindyn.cbl
...
* CANCEL
         ...
         USING WSC0000,8
         MVC   DYNNAME(8),D0000    the program name
         LA    1,DYNPARM
         L     15,VCANC
         BALR  14,15               release it, if it was loaded
         DROP  8
T0002    DS    0H
* PERFORM CALL-IT
...
* CANCEL
         MVC   DYNNAME,=CL8' '
         MVC   DYNNAME(6),S0001    the program name
         LA    1,DYNPARM
         L     15,VCANC
         BALR  14,15               release it, if it was loaded
T0004    DS    0H
...
* CANCEL
         MVC   DYNNAME,=CL8' '
         MVC   DYNNAME(8),S0002    the program name
         LA    1,DYNPARM
         L     15,VCANC
         BALR  14,15               release it, if it was loaded
T0006    DS    0H
...
* CALL ''
         ...
         LA    0,D0001             MB-OUT
         ST    0,PL010+0
         OI    PL010+0,X'80'       high bit marks the last argument
         MVC   DYNNAME,=CL8' '
         MVC   DYNNAME(8),D0000    the program name
         LA    1,PL010
         ST    1,DYNPARM+4         the callee's parameter list
         LA    1,DYNPARM
         L     15,VDCAL
...
PT003    DC    H'0'                PERFORM n TIMES counter
X0001    DC    A(F0001)            CALL-IT
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
VDCAL    DC    V(COBDCAL)
VCANC    DC    V(COBCANC)
DYNPARM  DC    A(DYNNAME),A(0)     CALL identifier: name, parameter lis
DYNNAME  DS    CL8
PWK1     DS    PL16
PWK2     DS    PL16
...
K0002    DC    PL16'2'
S0001    DC    CL6'SUBDYN'         nonnumeric constants
S0002    DC    CL8'NOTLOADD'
S0003    DC    CL10'RESULT END'
S0004    DC    CL7'RESULT '
