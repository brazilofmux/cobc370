*---------------------------------------------------------------
* Generated by cobc370 from isamrno.cbl
...
* DISPLAY
         ...
         MVC   DSPBUF+6(1),S0004
         MVC   DSPBUF+7(70),D0004+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0005    DS    0H
* MOVE 300 -> WS-NOMKEY
         MVC   D0005(10),S0005     numeric literal as zoned digits
T0006    DS    0H
* READ DESCIDX
         MVI   ISFLG,X'00'
         XC    DB000(4),DB000      clear the ECB before each READ
...
S0001    DC    CL10'0000000250'    nonnumeric constants
S0002    DC    CL7'OV1 IK '
S0003    DC    CL4'OV1 '
S0004    DC    CL1' '
