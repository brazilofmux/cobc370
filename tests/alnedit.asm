*---------------------------------------------------------------
* Generated by cobc370 from alnedit.cbl
...
* MOVE SRC6 -> DATE-ED
         ...
         USING WSC0000,8
         MVC   D0000(8),M0001      the insertion characters
         MVC   D0000+0(2),D0005+0  a run of data positions
         MVC   D0000+3(2),D0005+2  a run of data positions
         MVC   D0000+6(2),D0005+4  a run of data positions
T0001    DS    0H
* DISPLAY
...
T0002    DS    0H
* MOVE SRC3 -> SPACED
         MVC   D0001(5),M0002      the insertion characters
         MVC   D0001+0(1),D0006+0  a run of data positions
         MVC   D0001+2(1),D0006+1  a run of data positions
         MVC   D0001+4(1),D0006+2  a run of data positions
T0003    DS    0H
* DISPLAY
         MVC   DSPBUF+0(7),S0003
         MVC   DSPBUF+7(5),D0001+0
...
T0004    DS    0H
* MOVE SRC4 -> ZEROED
         MVC   D0002(6),M0003      the insertion characters
         MVC   D0002+0(2),D0007+0  a run of data positions
         MVC   D0002+4(2),D0007+2  a run of data positions
T0005    DS    0H
* DISPLAY
         MVC   DSPBUF+0(7),S0004
         MVC   DSPBUF+7(6),D0002+0
...
T0006    DS    0H
* MOVE SRC3 -> ALPHA-ED
         MVC   D0003(3),M0004      the insertion characters
         MVC   D0003+0(1),D0006+0  a run of data positions
         MVC   D0003+2(1),D0006+1  a run of data positions
T0007    DS    0H
* DISPLAY
         MVC   DSPBUF+0(7),S0005
         MVC   DSPBUF+7(3),D0003+0
...
T0008    DS    0H
* MOVE SRC6 -> MIXED-ED
         MVC   D0004(8),M0005      the insertion characters
         MVC   D0004+0(2),D0005+0  a run of data positions
         MVC   D0004+3(2),D0005+2  a run of data positions
         MVC   D0004+6(2),D0005+4  a run of data positions
T0009    DS    0H
* DISPLAY
         MVC   DSPBUF+0(7),S0006
         MVC   DSPBUF+7(8),D0004+0
         MVC   DSPBUF+15(1),S0002
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
...
* MOVE SRC3 -> DATE-ED
         MVC   D0000(8),M0001      the insertion characters
         MVC   D0000+0(2),D0006+0  a run of data positions
         MVC   D0000+3(1),D0006+2  a run of data positions
T0011    DS    0H
* DISPLAY
...
* WORKING-STORAGE
D0000    DC    CL8' '              DATE-ED PIC X(8)
D0001    DC    CL5' '              SPACED PIC X(5)
         DS    XL3                 reserve the rest of a table
D0002    DC    CL6' '              ZEROED PIC X(6)
         DS    XL2                 reserve the rest of a table
D0003    DC    CL3' '              ALPHA-ED PIC X(3)
         DS    XL5                 reserve the rest of a table
D0004    DC    CL8' '              MIXED-ED PIC X(8)
D0005    DC    CL6'311226'         SRC6 PIC X(6)
         DS    XL2                 reserve the rest of a table
D0006    DC    CL3'ABC'            SRC3 PIC X(3)
         DS    XL5                 reserve the rest of a table
D0007    DC    CL4'WXYZ'           SRC4 PIC X(4)
*---------------------------------------------------------------
