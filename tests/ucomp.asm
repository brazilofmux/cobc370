*---------------------------------------------------------------
* Generated by cobc370 from ucomp.cbl
...
* ADD 1 -> B
         ...
         USING WSC0000,8
         MVC   DWK(2),D0002        COMP, not on its boundary
         LH    2,DWK
         AH    2,H0001             binary, same scale: in the register
         STH   2,DWK
         MVC   D0002(2),DWK        COMP, not on its boundary
T0001    DS    0H
* MOVE B -> SHOW
         MVC   DWK(2),D0002        COMP, not on its boundary
         LH    2,DWK
...
* WORKING-STORAGE
D0000    DS    0CL3                G (01 group)
D0001    DC    CL1'X'              A PIC X(1)
D0002    DC    HL2'1'              B PIC S9(4)v0 COMP
