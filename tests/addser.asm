*---------------------------------------------------------------
* Generated by cobc370 from addser.cbl
...
* MOVE D -> S
         ...
         MVI   EDWK+2,C'-'
G0001    DS    0H
         MVC   D0006(7),EDWK+2     the edited result
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(11),S0001
         MVC   DSPBUF+11(7),D0006+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
...
* MOVE F -> T
         ...
         MVI   EDWK+2,C'-'
G0011    DS    0H
         MVC   D0007(8),EDWK+2     the edited result
T0017    DS    0H
* DISPLAY
         MVC   DSPBUF+0(11),S0006
         MVC   DSPBUF+11(8),D0007+0
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0018    DS    0H
* SUBTRACT 1 -> A
         PACK  PWK1(16),D0000(4)   zoned -> packed
         ZAP   PWK2(16),K0001(16)  literal
         SP    PWK1(16),PWK2(16)
         UNPK  D0000(4),PWK1(16)   packed -> zoned
...
K0003    DC    PL16'3'
K0004    DC    PL16'4'
M0001    DC    XL9'402140202020202020'  ED patterns
M0002    DC    XL10'402140202020204B2020'
S0001    DC    CL11'ADD 3 TO   '   nonnumeric constants
S0002    DC    CL11'ADD GIVING '
S0003    DC    CL11'ADD LITS   '
S0004    DC    CL11'SUB 2 FROM '
S0005    DC    CL11'SUB GIVING '
S0006    DC    CL11'ADD ROUNDED'
S0007    DC    CL11'SUB ONE    '
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0014-COBBEG),AL2(33)
         DC    AL2(T0015-COBBEG),AL2(34)
         DC    AL2(T0016-COBBEG),AL2(35)
         DC    AL2(T0017-COBBEG),AL2(36)
         DC    AL2(T0018-COBBEG),AL2(37)
         DC    AL2(T0019-COBBEG),AL2(38)
         DC    AL2(T0020-COBBEG),AL2(39)
         DC    AL2(T0021-COBBEG),AL2(40)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL4'0010'           A PIC 9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0001    DC    CL4'0020'           B PIC 9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0002    DC    CL4'0030'           C PIC 9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0003    DC    ZL6'100'            D PIC S9(6)v0 DISP
         DS    XL2                 reserve the rest of a table
D0004    DC    ZL6'0'              E PIC S9(6)v0 DISP
         DS    XL2                 reserve the rest of a table
D0005    DC    ZL6'000'            F PIC S9(6)v2 DISP
         DS    XL2                 reserve the rest of a table
D0006    DC    CL7' '              S edited, 7 chars
         DS    XL1                 reserve the rest of a table
D0007    DC    CL8' '              T edited, 8 chars
*---------------------------------------------------------------
