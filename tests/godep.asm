...
* GO TO ... DEPENDING ON SEL
         ...
         L     15,GD0018(2)        the target's address
         BR    15
L0016    DS    0H
         DROP  8
T0017    DS    0H
...
* GO TO ... DEPENDING ON SELC
         ...
         SLL   2,2                 four bytes per entry
         L     15,GD0032(2)        the target's address
         BR    15
L0018    DS    0H
         DROP  8
T0026    DS    0H
* DISPLAY
         MVC   DSPBUF+0(17),S0010
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
T0027    DS    0H
...
* GO TO ... DEPENDING ON TV
         ...
         SLL   2,2                 four bytes per entry
         L     15,GD0043(2)        the target's address
         BR    15
L0020    DS    0H
         DROP  8
T0033    DS    0H
* DISPLAY
         MVC   DSPBUF+0(18),S0013
         LA    1,PARM0008
         L     15,VDISP
         BALR  14,15
T0034    DS    0H
...
DWK      DS    D                   CVD/CVB doubleword
         DS    0F
GD0018   DC    A(P0002)            ONE
         DC    A(P0003)            TWO
         DC    A(P0004)            THREE
         DS    0F
GD0032   DC    A(P0007)            C-ONE
         DC    A(P0008)            C-TWO
         DS    0F
GD0043   DC    A(P0011)            T-ONE
         DC    A(P0012)            T-TWO
         DC    A(P0013)            T-THREE
PWK1     DS    PL16
PWK2     DS    PL16
...
S0004    DC    CL1'3'
S0005    DC    CL1'4'
S0006    DC    CL17'FELL THROUGH FOR '
S0007    DC    CL8'ONE FOR '
S0008    DC    CL8'TWO FOR '
S0009    DC    CL10'THREE FOR '
S0010    DC    CL17'COMP FELL THROUGH'
S0011    DC    CL8'COMP ONE'
S0012    DC    CL8'COMP TWO'
S0013    DC    CL18'TABLE FELL THROUGH'
S0014    DC    CL9'TABLE ONE'
S0015    DC    CL9'TABLE TWO'
S0016    DC    CL11'TABLE THREE'
...
SPIELTB  DS    0F
         ...
         DC    A(T0002-COBBEG),AL2(16,0)
         DC    A(T0003-COBBEG),AL2(17,0)
         DC    A(T0004-COBBEG),AL2(18,0)
         DC    A(T0005-COBBEG),AL2(19,0)
         DC    A(T0006-COBBEG),AL2(20,0)
         DC    A(T0007-COBBEG),AL2(21,0)
         ...
         DC    A(T0034-COBBEG),AL2(58,0)
         DC    A(T0035-COBBEG),AL2(60,0)
         DC    A(T0036-COBBEG),AL2(61,0)
         DC    A(T0037-COBBEG),AL2(63,0)
