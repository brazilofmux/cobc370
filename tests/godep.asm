*---------------------------------------------------------------
* Generated by cobc370 from godep.cbl
...
R0006    DS    0H
         DROP  8
         LA    15,F0009            restore fall-through
         ST    15,X0009
T0012    DS    0H
* MOVE 1 -> TV
         ZAP   PWK1(16),K0002(16)  literal
...
P0001    DS    0H
T0016    DS    0H
* GO TO ... DEPENDING ON SEL
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  PWK1(16),D0000(1)   zoned -> packed
         ZAP   DWK(8),PWK1(16)
         CVB   2,DWK               the selector
         BCTR  2,0                 1 selects the first entry
         LH    0,H0002             the entry count
         CLR   2,0                 past the last, or negative -- unsign
         BNL   L0016               out of range: fall through
         SLL   2,2                 four bytes per entry
         B     L0015(2)            into the table
L0015    DS    0H
         B     P0002               ONE
         B     P0003               TWO
         B     P0004               THREE
...
T0019    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0002
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+8(1),D0000+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0020    DS    0H
...
* GO TO ... DEPENDING ON SELC
         ...
         CVB   2,DWK               the selector
         BCTR  2,0                 1 selects the first entry
         LH    0,H0001             the entry count
         CLR   2,0                 past the last, or negative -- unsign
         BNL   L0018               out of range: fall through
         SLL   2,2                 four bytes per entry
         B     L0017(2)            into the table
L0017    DS    0H
         B     P0007               C-ONE
         B     P0008               C-TWO
L0018    DS    0H
...
* GO TO ... DEPENDING ON TV
         ...
         LH    0,H0002             the entry count
         CLR   2,0                 past the last, or negative -- unsign
         BNL   L0020               out of range: fall through
         SLL   2,2                 four bytes per entry
         B     L0019(2)            into the table
L0019    DS    0H
         B     P0011               T-ONE
         B     P0012               T-TWO
         B     P0013               T-THREE
...
X0005    DC    A(F0005)            TRY-X
X0009    DC    A(F0009)            TRYC-X
X0014    DC    A(F0014)            TRYT-X
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
H0002    DC    H'3'
S0001    DC    CL17'FELL THROUGH FOR '  nonnumeric constants
S0002    DC    CL8'ONE FOR '
S0003    DC    CL8'TWO FOR '
S0004    DC    CL10'THREE FOR '
S0005    DC    CL17'COMP FELL THROUGH'
S0006    DC    CL8'COMP ONE'
S0007    DC    CL8'COMP TWO'
S0008    DC    CL18'TABLE FELL THROUGH'
S0009    DC    CL9'TABLE ONE'
S0010    DC    CL9'TABLE TWO'
S0011    DC    CL11'TABLE THREE'
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0019-COBBEG),AL2(35)
         DC    AL2(T0020-COBBEG),AL2(36)
         DC    AL2(T0021-COBBEG),AL2(38)
         DC    AL2(T0022-COBBEG),AL2(39)
         DC    AL2(T0023-COBBEG),AL2(41)
         DC    AL2(T0024-COBBEG),AL2(43)
         DC    AL2(T0025-COBBEG),AL2(45)
         DC    AL2(T0026-COBBEG),AL2(46)
         DC    AL2(T0027-COBBEG),AL2(47)
         DC    AL2(T0028-COBBEG),AL2(49)
         DC    AL2(T0029-COBBEG),AL2(50)
         DC    AL2(T0030-COBBEG),AL2(52)
         DC    AL2(T0031-COBBEG),AL2(54)
         DC    AL2(T0032-COBBEG),AL2(56)
         DC    AL2(T0033-COBBEG),AL2(57)
         DC    AL2(T0034-COBBEG),AL2(58)
         DC    AL2(T0035-COBBEG),AL2(60)
         DC    AL2(T0036-COBBEG),AL2(61)
         DC    AL2(T0037-COBBEG),AL2(63)
         DC    AL2(T0038-COBBEG),AL2(64)
         DC    AL2(T0039-COBBEG),AL2(66)
...
D0001    DC    HL2'0'              SELC PIC S9(4)v0 COMP
         DS    XL6                 reserve the rest of a table
D0002    DS    0CL6                TAB (01 group)
D0003    DC    3CL2'00'            TV PIC 9(2)v0 DISP table
*---------------------------------------------------------------
