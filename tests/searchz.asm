*---------------------------------------------------------------
* Generated by cobc370 from searchz.cbl
...
L0004    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         LH    1,D0002             the index
         LTR   1,1                 below the first occurrence?
         BNP   L0001               AT END
         CH    1,H0002             past the last occurrence?
         BH    L0001               AT END
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         LH    6,D0002             subscript
...
SL002    DC    H'0'                SEARCH ALL low bound
SH002    DC    H'0'                high bound
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0003-COBBEG),AL2(14)
         DC    AL2(T0004-COBBEG),AL2(15)
         DC    AL2(T0005-COBBEG),AL2(15)
         DC    AL2(T0006-COBBEG),AL2(16)
...
D0002    DC    HL2'0'              IX PIC S9(4)v0 COMP
*---------------------------------------------------------------
