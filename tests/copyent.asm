*---------------------------------------------------------------
* Generated by cobc370 from copyent.cbl
...
* DISPLAY
         ...
         USING WSC0000,8
         MVC   DSPBUF+11(14),D0000+0
         MVC   DSPBUF+25(1),S0002
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0001    DS    0H
* MOVE DONE -> DC-OUT
         MVC   D0002(8),S0003      literal move, space padded
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(4),S0004
         MVC   DSPBUF+4(6),D0001+0
         MVC   DSPBUF+10(7),S0005
         MVC   DSPBUF+17(8),D0002+0
         MVC   DSPBUF+25(1),S0002
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
* MOVE 111111 -> OT-IN
         MVC   D0004(6),S0006      literal move, space padded
T0004    DS    0H
* DISPLAY
         MVC   DSPBUF+0(9),S0007
         MVC   DSPBUF+9(14),D0003+0
         MVC   DSPBUF+23(9),S0008
         MVC   DSPBUF+32(14),D0000+0
         MVC   DSPBUF+46(1),S0002
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0005    DS    0H
...
T0006    DS    0H
* DISPLAY
         MVC   DSPBUF+0(13),S0010
         MVC   DSPBUF+13(6),D0007+0
         MVC   DSPBUF+19(2),S0011
         MVC   DSPBUF+21(3),D0008+0
         MVC   DSPBUF+24(1),S0012
         MVC   DSPBUF+25(3),D0009+0
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
T0007    DS    0H
* DISPLAY
         ...
         MVC   DSPBUF+16(2),S0011
         MVC   DSPBUF+18(3),D0011+0
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0008    DS    0H
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL11'SAME NAME ['   nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL8'DONE    '
S0004    DC    CL4'IN ['
S0005    DC    CL7'] OUT ['
S0006    DC    CL6'111111'
S0007    DC    CL9'RENAMED ['
S0008    DC    CL9'] FIRST ['
S0009    DC    CL12'ELEMENTARY ['
S0010    DC    CL13'FIRST ENTRY ['
S0011    DC    CL2'] '
S0012    DC    CL1' '
S0013    DC    CL13'LATER ENTRY ['
...
* WORKING-STORAGE
D0000    DS    0CL14               DATECNV-PARM (01 group)
D0001    DC    CL6'092426'         DC-IN PIC X(6)
D0002    DC    CL8'NOT YET'        DC-OUT PIC X(8)
         DS    XL2                 reserve the rest of a table
D0003    DS    0CL14               OTHER-PARM (01 group)
D0004    DC    CL6'092426'         OT-IN PIC X(6)
D0005    DC    CL8'NOT YET'        OT-OUT PIC X(8)
         DS    XL2                 reserve the rest of a table
D0006    DC    CL10'ELEMENTARY'    MY-ELEM PIC X(10)
         DS    XL6                 reserve the rest of a table
D0007    DS    0CL6                MY-ONE (01 group)
D0008    DC    CL3'AAA'            ONE-A PIC X(3)
D0009    DC    CL3'123'            ONE-N PIC 9(3)v0 DISP
         DS    XL2                 reserve the rest of a table
D0010    DS    0CL3                LIB-TWO (01 group)
D0011    DC    CL3'BBB'            TWO-A PIC X(3)
*---------------------------------------------------------------
