*---------------------------------------------------------------
* Generated by cobc370 from subdyn.cbl
...
* MOVE WS-CALLS -> OUT-CALLS
         ...
         STH   2,D0002
T0002    DS    0H
* EXIT PROGRAM: back to the caller
...
* WORKING-STORAGE
D0000    DC    HL2'0'              WS-CALLS PIC S9(4)v0 COMP
LS0000   DSECT                     LS-OUT (caller's storage)
D0001    DS    0CL2                LS-OUT (01 group)
D0002    DS    CL2                 OUT-CALLS
         END
