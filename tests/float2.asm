*---------------------------------------------------------------
* Generated by cobc370 from float2.cbl
...
* MOVE F4 -> R12
         ...
         MVI   0(1),C'-'
G0001    DS    0H
         MVC   D0011(17),EDWK+1    the edited result
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0001
         MVC   DSPBUF+16(17),D0011+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
...
* COMPUTE F4 = ...
         ...
         L     15,VPKF
         BALR  14,15               packed -> floating
         STD   0,FSTK+8            the left operand waits
         ZAP   PWK1(16),D0007(5)
         LA    1,PWK1
         LA    0,3                 its scale
         L     15,VPKF
...
* MOVE F4 -> I3
         ...
         L     15,VFPK
         BALR  14,15               floating -> packed
         UNPK  D0009(3),PWK1(16)   packed -> zoned
T0021    DS    0H
* MOVE I3 -> E3
...
G0013    MVI   EDWK+3,C' '
G0014    DS    0H
         MVC   D0010(4),EDWK+3     the edited result
T0022    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0007
         MVC   DSPBUF+16(4),D0010+0
         LA    1,PARM0007
         L     15,VDISP
         BALR  14,15
T0023    DS    0H
...
* COMPUTE F4 = ... (ON SIZE ERROR)
         ...
         L     15,VFPW
         BALR  14,15               x ** y
         LTR   15,15               a negative base to a fraction, or ze
         BZ    *+12
...
M0002    DC    XL7'40202140202020'
H0001    DC    H'8'                element sizes
S0001    DC    CL16'A 15/10 ->F     '  nonnumeric constants
S0002    DC    CL16'B DIVIDE GIVING '
S0003    DC    CL16'C 15/10*1.0     '
S0004    DC    CL16'D F1(15)/D10    '
S0005    DC    CL16'E F2*(P3/P7)    '
S0006    DC    CL16'F P3/P7+0       '
S0007    DC    CL16'G 2.5 ->S9(3)   '
S0008    DC    CL16'H -2.5 ->S9(3)  '
S0009    DC    CL16'I 2/3 -> 9V99   '
S0010    DC    CL16'J 1.5/2.25->9V99'
S0011    DC    CL16'K 1.5/2.25->R12 '
S0012    DC    CL16'L 1500 ->S9(3)  '
S0013    DC    CL16'M ROUNDED 6.67  '
S0014    DC    CL16'N UNROUNDED     '
S0015    DC    CL16'O DISPLAY S1    '
S0016    DC    CL16'P DISPLAY 1000  '
S0017    DC    CL16'Q DISPLAY 0.001 '
S0018    DC    CL16'R DISPLAY 0     '
S0019    DC    CL16'S DISPLAY 123.. '
S0020    DC    CL16'T DISPLAY -0.5  '
S0021    DC    CL16'U DISPLAY FE(2) '
S0022    DC    CL16'V 2.5**0        '
S0023    DC    CL16'W 0**0          '
S0024    DC    CL16'X -8**3         '
S0025    DC    CL12'Y SIZE ERROR'
S0026    DC    CL16'Y -8**0.5       '
S0027    DC    CL12'Z SIZE ERROR'
S0028    DC    CL16'Z 0.5/0         '
S0029    DC    CL16'AA F1/3         '
S0030    DC    CL16'AB F4 < 0.34 YES'
S0031    DC    CL15'AB F4 < 0.34 NO'
S0032    DC    CL13'AC F4 = 7 YES'
S0033    DC    CL12'AC F4 = 7 NO'
S0034    DC    CL17'AD FE(2) > F2 YES'
S0035    DC    CL16'AD FE(2) > F2 NO'
S0036    DC    CL16'AE 0.5 via S1   '
S0037    DC    CL16'AF S1*3         '
...
SPIENUM  DC    H'108'              statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0F
         ...
         DC    A(T0009-COBBEG),AL2(37,0)
         DC    A(T0010-COBBEG),AL2(38,0)
         DC    A(T0011-COBBEG),AL2(38,0)
         DC    A(T0012-COBBEG),AL2(39,0)
         DC    A(T0013-COBBEG),AL2(40,0)
         DC    A(T0014-COBBEG),AL2(40,0)
         DC    A(T0015-COBBEG),AL2(41,0)
         DC    A(T0016-COBBEG),AL2(42,0)
         DC    A(T0017-COBBEG),AL2(43,0)
         DC    A(T0018-COBBEG),AL2(44,0)
         DC    A(T0019-COBBEG),AL2(45,0)
         DC    A(T0020-COBBEG),AL2(45,0)
         DC    A(T0021-COBBEG),AL2(45,0)
         DC    A(T0022-COBBEG),AL2(46,0)
         DC    A(T0023-COBBEG),AL2(47,0)
         DC    A(T0024-COBBEG),AL2(47,0)
         DC    A(T0025-COBBEG),AL2(47,0)
         DC    A(T0026-COBBEG),AL2(48,0)
         DC    A(T0027-COBBEG),AL2(49,0)
         DC    A(T0028-COBBEG),AL2(49,0)
         DC    A(T0029-COBBEG),AL2(50,0)
         DC    A(T0030-COBBEG),AL2(51,0)
         DC    A(T0031-COBBEG),AL2(51,0)
         DC    A(T0032-COBBEG),AL2(52,0)
         DC    A(T0033-COBBEG),AL2(53,0)
         DC    A(T0034-COBBEG),AL2(53,0)
         DC    A(T0035-COBBEG),AL2(54,0)
         DC    A(T0036-COBBEG),AL2(55,0)
         DC    A(T0037-COBBEG),AL2(55,0)
         DC    A(T0038-COBBEG),AL2(55,0)
         DC    A(T0039-COBBEG),AL2(56,0)
         DC    A(T0040-COBBEG),AL2(57,0)
         DC    A(T0041-COBBEG),AL2(57,0)
         DC    A(T0042-COBBEG),AL2(58,0)
         DC    A(T0043-COBBEG),AL2(59,0)
         DC    A(T0044-COBBEG),AL2(59,0)
         DC    A(T0045-COBBEG),AL2(60,0)
         DC    A(T0046-COBBEG),AL2(61,0)
         DC    A(T0047-COBBEG),AL2(62,0)
         DC    A(T0048-COBBEG),AL2(63,0)
         DC    A(T0049-COBBEG),AL2(64,0)
         DC    A(T0050-COBBEG),AL2(65,0)
         DC    A(T0051-COBBEG),AL2(66,0)
         DC    A(T0052-COBBEG),AL2(67,0)
         DC    A(T0053-COBBEG),AL2(68,0)
         DC    A(T0054-COBBEG),AL2(69,0)
         DC    A(T0055-COBBEG),AL2(70,0)
         DC    A(T0056-COBBEG),AL2(71,0)
         DC    A(T0057-COBBEG),AL2(72,0)
         DC    A(T0058-COBBEG),AL2(73,0)
         DC    A(T0059-COBBEG),AL2(74,0)
         DC    A(T0060-COBBEG),AL2(75,0)
         DC    A(T0061-COBBEG),AL2(76,0)
         DC    A(T0062-COBBEG),AL2(76,0)
         DC    A(T0063-COBBEG),AL2(77,0)
         DC    A(T0064-COBBEG),AL2(78,0)
         DC    A(T0065-COBBEG),AL2(79,0)
         DC    A(T0066-COBBEG),AL2(79,0)
         DC    A(T0067-COBBEG),AL2(80,0)
         DC    A(T0068-COBBEG),AL2(81,0)
         DC    A(T0069-COBBEG),AL2(81,0)
         DC    A(T0070-COBBEG),AL2(82,0)
         DC    A(T0071-COBBEG),AL2(82,0)
         DC    A(T0072-COBBEG),AL2(83,0)
         DC    A(T0073-COBBEG),AL2(84,0)
         DC    A(T0074-COBBEG),AL2(85,0)
         DC    A(T0075-COBBEG),AL2(85,0)
         DC    A(T0076-COBBEG),AL2(86,0)
         DC    A(T0077-COBBEG),AL2(87,0)
         DC    A(T0078-COBBEG),AL2(88,0)
         DC    A(T0079-COBBEG),AL2(89,0)
         DC    A(T0080-COBBEG),AL2(89,0)
         DC    A(T0081-COBBEG),AL2(90,0)
         DC    A(T0082-COBBEG),AL2(91,0)
         DC    A(T0083-COBBEG),AL2(92,0)
         DC    A(T0084-COBBEG),AL2(93,0)
         DC    A(T0085-COBBEG),AL2(93,0)
         DC    A(T0086-COBBEG),AL2(94,0)
         DC    A(T0087-COBBEG),AL2(95,0)
         DC    A(T0088-COBBEG),AL2(95,0)
         DC    A(T0089-COBBEG),AL2(96,0)
         DC    A(T0090-COBBEG),AL2(96,0)
         DC    A(T0091-COBBEG),AL2(97,0)
         DC    A(T0092-COBBEG),AL2(98,0)
         DC    A(T0093-COBBEG),AL2(98,0)
         DC    A(T0094-COBBEG),AL2(99,0)
         DC    A(T0095-COBBEG),AL2(99,0)
         DC    A(T0096-COBBEG),AL2(100,0)
         DC    A(T0097-COBBEG),AL2(100,0)
         DC    A(T0098-COBBEG),AL2(101,0)
         DC    A(T0099-COBBEG),AL2(101,0)
         DC    A(T0100-COBBEG),AL2(102,0)
         DC    A(T0101-COBBEG),AL2(102,0)
         DC    A(T0102-COBBEG),AL2(102,0)
         DC    A(T0103-COBBEG),AL2(103,0)
         DC    A(T0104-COBBEG),AL2(104,0)
         DC    A(T0105-COBBEG),AL2(104,0)
         DC    A(T0106-COBBEG),AL2(105,0)
         DC    A(T0107-COBBEG),AL2(106,0)
...
D0002    DC    DL8'0'              F4 COMP-2, long hex float
D0003    DC    EL4'0'              S1 COMP-1, short hex float
...
D0006    DC    PL5'3000'           P3 PIC S9(8)v3 COMP-3
         DS    XL3                 reserve the rest of a table
D0007    DC    PL5'7000'           P7 PIC S9(8)v3 COMP-3
         DS    XL3                 reserve the rest of a table
D0008    DC    CL3'000'            Q2 PIC 9(3)v2 DISP
         DS    XL5                 reserve the rest of a table
D0009    DC    ZL3'0'              I3 PIC S9(3)v0 DISP
         DS    XL5                 reserve the rest of a table
D0010    DC    CL4' '              E3 edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0011    DC    CL17' '             R12 edited, 17 chars
         DS    XL7                 reserve the rest of a table
D0012    DS    0CL24               FT (01 group)
D0013    DC    3DL8'0'             FE COMP-2, long hex float
*---------------------------------------------------------------
