*---------------------------------------------------------------
* Generated by cobc370 from nextsent.cbl
...
* MOVE 1 -> B
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0001(1),S0001      numeric literal as zoned digits
         DROP  8
L0002    DS    0H
L0003    DS    0H
T0004    DS    0H
...
K0001    EQU   *-15                numeric constants, as long as used
         DC    PL1'1'
S0001    DC    CL1'1'              nonnumeric constants
...
SPIELTB  DS    0F
         ...
         DC    A(T0002-COBBEG),AL2(11,0)
         DC    A(T0003-COBBEG),AL2(11,0)
         DC    A(T0004-COBBEG),AL2(12,0)
         DC    A(T0005-COBBEG),AL2(13,0)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL1'1'              A PIC 9(1)v0 DISP
         DS    XL7                 reserve the rest of a table
D0001    DC    CL1'0'              B PIC 9(1)v0 DISP
*---------------------------------------------------------------
