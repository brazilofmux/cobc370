*---------------------------------------------------------------
* Generated by cobc370 from rptdate.cbl
...
RG000    ST    14,RGS000           save the return
         ...
         MVC   RBUF+1(6),S0004     COLUMN literal
         L     8,BL0000            base locator
         USING WSC0000,8
         L     2,D0010
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+8(5),D0011     COLUMN placement
         LA    1,RGP000
         L     15,VWRL
         BALR  14,15
         DROP  8
...
L0017    DS    0H
         ...
         MVI   RBUF+1,C' '
         MVC   RBUF+2(133),RBUF+1  blank the line
         MVC   D0013(10),D0002     alphanumeric move
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+1(10),D0013    COLUMN placement
         LA    1,RGP001
         L     15,VWRL
         BALR  14,15
         DROP  8
...
FD001    DCB   DDNAME=PROUT,DSORG=PS,MACRF=(PM),RECFM=FA,              X
...
D0002    DC    CL10' '             IN-NAME PIC X(10)
D0003    DC    CL70' '             FILL0003 PIC X(70)
         DS    XL4                 reserve the rest of a table
D0004    DC    CL4' '              *RDW PIC X(4)
D0005    DC    CL1'N'              EOF PIC X(1)
         DS    XL3                 reserve the rest of a table
D0006    DS    0CL8                DATE-RPT (01 group)
D0007    DC    FL4'0'              LINE-COUNTER PIC 9(6)v0 COMP
D0008    DC    FL4'0'              PAGE-COUNTER PIC 9(6)v0 COMP
D0009    DC    CL6' '              RPT0 PIC X(6)
         DS    XL2                 reserve the rest of a table
D0010    DC    FL4'0'              TALLY PIC 9(5)v0 COMP
D0011    DC    CL5'00000'          RPT1 PIC 9(5)v0 DISP
D0012    DS    0C                  DL (02 group)
D0013    DC    CL10' '             RPT2 PIC X(10)
*---------------------------------------------------------------
