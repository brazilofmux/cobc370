*---------------------------------------------------------------
* Generated by cobc370 from ksdsnatl.cbl
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0006(2),S0004      alphanumeric compare
         BE    L0001
T0006    DS    0H
* DISPLAY
         MVC   DSPBUF+0(31),S0005
         MVC   DSPBUF+31(2),D0006+0
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0007    DS    0H
* MOVE Y -> LOAD-FAILED-SWITCH
         MVC   D0009(1),S0006      literal move, space padded
         DROP  8
L0001    DS    0H
* 010-PROCESS.
P0001    DS    0H
...
L0012    DS    0H
         ...
         BE    L0013
         CLC   D0009(1),S0006      alphanumeric compare
         BE    L0013
...
* MOVE RECORD-COUNTER -> COUNTER-EDIT
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  PWK1(16),D0013(8)   zoned -> packed
         ZAP   EDSRC(5),PWK1(16)   source, sized to the selector count
         MVC   EDWK(12),M0001      load the ED pattern
         ED    EDWK(12),EDSRC
         MVC   D0014(10),EDWK+2    the edited result
T0014    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),D0014+0
         MVC   DSPBUF+10(33),S0008
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0015    DS    0H
...
P0005    DS    0H
T0021    DS    0H
* MOVE RECORD-IMAGE -> KSDS-RECORD
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(80),D0001     alphanumeric move
T0022    DS    0H
* MOVE N -> WRITE-FAILED-SWITCH
         MVC   D0011(1),S0009      literal move, space padded
T0023    DS    0H
* WRITE KSDS-RECORD
...
* ADD 1 -> RECORD-COUNTER
         ...
         AP    PWK1(16),PWK2(16)
         UNPK  D0013(8),PWK1(16)   packed -> zoned
         DROP  8
L0008    DS    0H
T0027    DS    0H
* IF
         ...
         CLC   D0011(1),S0006      alphanumeric compare
         BNE   L0009
         CLC   D0006(2),S0010      alphanumeric compare
         BNE   L0009
T0028    DS    0H
* DISPLAY
         MVC   DSPBUF+0(41),S0011
         MVC   DSPBUF+41(40),S0012
         LA    1,PARM0007
         L     15,VDISP
         BALR  14,15
T0029    DS    0H
...
* IF
         ...
         CLC   D0011(1),S0006      alphanumeric compare
         BNE   L0010
         CLC   D0006(2),S0013      alphanumeric compare
         BNE   L0010
T0031    DS    0H
* DISPLAY
...
T0032    DS    0H
* DISPLAY
         MVC   DSPBUF+0(17),S0015
         MVC   DSPBUF+17(80),D0001+0
         LA    1,PARM0009
         L     15,VDISP
         BALR  14,15
         DROP  8
...
FD001R   RPL   ACB=FD001,AREA=D0003,                                   X
...
S0001    DC    CL33'KSDSLOAD: WRITE KSDS SEQUENTIALLY'  nonnumeric cons
S0002    DC    CL33'---------------------------------'
S0003    DC    CL1' '
S0004    DC    CL2'00'
...
S0008    DC    CL33' RECORDS WERE LOADED SUCCESSFULLY'
S0009    DC    CL1'N'
S0010    DC    CL2'24'
S0011    DC    CL41'INSUFFICIENT SPACE DEFINED IN CLUSTER TO '
S0012    DC    CL40'CONTAIN ALL RECORDS - LOADING TERMINATED'
S0013    DC    CL2'21'
S0014    DC    CL30'KEY SEQUENCE ERROR DURING LOAD'
S0015    DC    CL17'RECORD BYPASSED: '
S0016    DC    CL32'VSAM ERROR DURING WRITE, STATUS '
...
SPIELTB  DS    0H
         DC    AL2(T0000-COBBEG),AL2(39)
         DC    AL2(T0001-COBBEG),AL2(40)
         DC    AL2(T0002-COBBEG),AL2(41)
         DC    AL2(T0003-COBBEG),AL2(42)
         DC    AL2(T0004-COBBEG),AL2(43)
         DC    AL2(T0005-COBBEG),AL2(45)
         DC    AL2(T0006-COBBEG),AL2(45)
         DC    AL2(T0007-COBBEG),AL2(46)
         DC    AL2(T0008-COBBEG),AL2(48)
         DC    AL2(T0009-COBBEG),AL2(51)
         DC    AL2(T0010-COBBEG),AL2(52)
         DC    AL2(T0011-COBBEG),AL2(54)
         DC    AL2(T0012-COBBEG),AL2(54)
         DC    AL2(T0013-COBBEG),AL2(55)
         DC    AL2(T0014-COBBEG),AL2(56)
         DC    AL2(T0015-COBBEG),AL2(57)
         DC    AL2(T0016-COBBEG),AL2(60)
         DC    AL2(T0017-COBBEG),AL2(60)
         DC    AL2(T0018-COBBEG),AL2(62)
         DC    AL2(T0019-COBBEG),AL2(62)
         DC    AL2(T0020-COBBEG),AL2(64)
         DC    AL2(T0021-COBBEG),AL2(66)
         DC    AL2(T0022-COBBEG),AL2(67)
         DC    AL2(T0023-COBBEG),AL2(69)
         DC    AL2(T0024-COBBEG),AL2(69)
         DC    AL2(T0025-COBBEG),AL2(71)
         DC    AL2(T0026-COBBEG),AL2(71)
         DC    AL2(T0027-COBBEG),AL2(73)
         DC    AL2(T0028-COBBEG),AL2(73)
         DC    AL2(T0029-COBBEG),AL2(75)
         DC    AL2(T0030-COBBEG),AL2(77)
         DC    AL2(T0031-COBBEG),AL2(77)
         DC    AL2(T0032-COBBEG),AL2(78)
         DC    AL2(T0033-COBBEG),AL2(81)
         DC    AL2(T0034-COBBEG),AL2(81)
         DC    AL2(T0035-COBBEG),AL2(82)
         DC    AL2(T0036-COBBEG),AL2(84)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
         DS    XL4                 reserve the rest of a table
D0000    DC    CL4' '              *RDW PIC X(4)
D0001    DC    CL80' '             RECORD-IMAGE PIC X(80)
         DS    XL4                 reserve the rest of a table
D0002    DC    CL4' '              *RDW PIC X(4)
D0003    DS    0CL80               KSDS-RECORD (01 group)
D0004    DC    CL10' '             KSDS-KEY PIC X(10)
D0005    DC    CL70' '             FILL0005 PIC X(70)
D0006    DC    CL2'00'             WS-STATUS PIC X(2)
         DS    XL6                 reserve the rest of a table
D0007    DC    CL1'N'              END-OF-FILE-SWITCH PIC X(1)
         DS    XL7                 reserve the rest of a table
D0009    DC    CL1'N'              LOAD-FAILED-SWITCH PIC X(1)
         DS    XL7                 reserve the rest of a table
D0011    DC    CL1'N'              WRITE-FAILED-SWITCH PIC X(1)
         DS    XL7                 reserve the rest of a table
D0013    DC    ZL8'0'              RECORD-COUNTER PIC S9(8)v0 DISP
D0014    DC    CL10' '             COUNTER-EDIT edited, 10 chars
*---------------------------------------------------------------
