*---------------------------------------------------------------
* Generated by cobc370 from setindex.cbl
...
* MOVE IX -> N
         ...
         OI    D0004+3,X'F0'       unsigned: force an F zone
T0017    DS    0H
* DISPLAY
         MVC   DSPBUF+0(6),S0006
         MVC   DSPBUF+6(4),D0004+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0018    DS    0H
...
* MOVE 3 -> NUM
         ...
         UNPK  0(4,6),PWK1(16)     packed -> zoned
         OI    3(6),X'F0'          unsigned: force an F zone
T0031    DS    0H
* MOVE NUM -> IX
         LA    7,1                 subscript-1
...
* DISPLAY
         ...
         MVC   DSPBUF+3(1),D0006+0
         MVC   DSPBUF+4(1),S0013
         MVC   DSPBUF+5(4),D0007+0
         LA    1,PARM0007
         L     15,VDISP
         BALR  14,15
...
S0001    DC    CL4'AAAA'           nonnumeric constants
S0002    DC    CL4'BBBB'
S0003    DC    CL4'CCCC'
S0004    DC    CL4'DDDD'
S0005    DC    CL4'EEEE'
S0006    DC    CL6'N IS  '
S0007    DC    CL11'IX EQ SAVED'
S0008    DC    CL11'IX NE SAVED'
S0009    DC    CL11'IX LT SAVED'
S0010    DC    CL11'IX GE SAVED'
S0011    DC    CL6'NUM4  '
S0012    DC    CL3'AT '
S0013    DC    CL1' '
...
SPIENUM  DC    H'40'               statements in the table
SPIEREGS DS    15F
SPIEDW   DS    D
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0005-COBBEG),AL2(26)
         DC    AL2(T0006-COBBEG),AL2(27)
         DC    AL2(T0007-COBBEG),AL2(28)
         DC    AL2(T0008-COBBEG),AL2(29)
         DC    AL2(T0009-COBBEG),AL2(30)
         DC    AL2(T0010-COBBEG),AL2(31)
         DC    AL2(T0011-COBBEG),AL2(32)
         DC    AL2(T0012-COBBEG),AL2(33)
         DC    AL2(T0013-COBBEG),AL2(34)
         DC    AL2(T0014-COBBEG),AL2(35)
         DC    AL2(T0015-COBBEG),AL2(36)
         DC    AL2(T0016-COBBEG),AL2(37)
         DC    AL2(T0017-COBBEG),AL2(38)
         DC    AL2(T0018-COBBEG),AL2(39)
         DC    AL2(T0019-COBBEG),AL2(40)
         DC    AL2(T0020-COBBEG),AL2(41)
         DC    AL2(T0021-COBBEG),AL2(43)
         DC    AL2(T0022-COBBEG),AL2(43)
         DC    AL2(T0023-COBBEG),AL2(45)
         DC    AL2(T0024-COBBEG),AL2(45)
         DC    AL2(T0025-COBBEG),AL2(46)
         DC    AL2(T0026-COBBEG),AL2(48)
         DC    AL2(T0027-COBBEG),AL2(48)
         DC    AL2(T0028-COBBEG),AL2(50)
         DC    AL2(T0029-COBBEG),AL2(50)
         DC    AL2(T0030-COBBEG),AL2(51)
         DC    AL2(T0031-COBBEG),AL2(52)
         DC    AL2(T0032-COBBEG),AL2(53)
         DC    AL2(T0033-COBBEG),AL2(54)
         DC    AL2(T0034-COBBEG),AL2(55)
         DC    AL2(T0035-COBBEG),AL2(56)
         DC    AL2(T0036-COBBEG),AL2(57)
         DC    AL2(T0037-COBBEG),AL2(59)
         DC    AL2(T0038-COBBEG),AL2(60)
         DC    AL2(T0039-COBBEG),AL2(61)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DS    0CL20               TBL (01 group)
D0001    DC    5CL4' '             ENT PIC X(4) table
         DS    XL4                 reserve the rest of a table
D0002    DC    FL4'0'              SAVED-IX PIC S9(9)v0 COMP
         DS    XL4                 reserve the rest of a table
D0003    DC    FL4'0'              OTHER-IX PIC S9(9)v0 COMP
         DS    XL4                 reserve the rest of a table
D0004    DC    CL4'0000'           N PIC 9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0005    DC    HL2'2'              BUMP PIC S9(4)v0 COMP
         DS    XL6                 reserve the rest of a table
D0006    DC    CL1'0'              SHOWN PIC 9(1)v0 DISP
         DS    XL7                 reserve the rest of a table
D0007    DC    CL4' '              WORK PIC X(4)
         DS    XL4                 reserve the rest of a table
