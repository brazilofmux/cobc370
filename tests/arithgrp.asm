*---------------------------------------------------------------
* Generated by cobc370 from arithgrp.cbl
...
T0026    DS    0H
* MOVE Q -> E-Q
         PACK  PWK1(16),D0010(5)   zoned -> packed
...
T0027    DS    0H
* MOVE R -> E-R
         PACK  PWK1(16),D0011(5)   zoned -> packed
         ZAP   EDSRC(3),PWK1(16)   source, sized to the selector count
         MVC   EDWK(7),M0001       load the ED pattern
         ED    EDWK(7),EDSRC
         MVC   D0013(6),EDWK+1     the edited result
T0028    DS    0H
* DISPLAY
         MVC   DSPBUF+0(4),S0008
...
* COMPUTE P = ...
         ...
         PACK  WK2(16),D0008(1)    zoned -> packed
         ZAP   DWK(8),WK2(16)
         CVB   3,DWK               the exponent
         ZAP   WK0(16),K0001+15(1)  start from one
         LTR   3,3
         BNP   L0009               exponent of zero: one
L0008    ZAP   MULT8(8),WK1(16)    the base
         MP    WK0(16),MULT8+5(3)  the multiplier as long as the base (
...
* COMPUTE S2 = ... (ON SIZE ERROR)
         ...
         CP    WK1(16),K0010+14(2)  against 10 ** digits
         BL    L0010               fits
...
L0010    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         UNPK  D0004(2),PWK1(16)   packed -> zoned
         OI    D0004+1,X'F0'       unsigned: force an F zone
L0011    DS    0H
         DROP  8
...
L0020    DS    0H
         ...
         ZAP   WK1(16),PWK1(16)
         OI    WK1+15,X'0F'        magnitude
         CP    WK1(16),K0013+12(4)  against 10 ** digits
         BL    L0018               fits
         MVI   SZFLG,X'01'         size error: the item is left alone
         B     L0019
L0018    DS    0H
...
L0022    DS    0H
         DROP  8
         CLI   SZFLG,X'00'         any size error in the series?
         BE    L0005               none: past the imperative statements
T0056    DS    0H
* DISPLAY
...
L0025    DS    0H
         DROP  8
         CLI   SZFLG,X'00'         any size error in the series?
         BE    L0006               none: past the imperative statements
T0058    DS    0H
* DISPLAY
...
L0027    DS    0H
         DROP  8
         CLI   SZFLG,X'00'         any size error in the series?
         BE    L0007               none: past the imperative statements
T0060    DS    0H
* DISPLAY
...
S0001    DC    CL7'SERIES '        nonnumeric constants
S0002    DC    CL1' '
S0003    DC    CL7'ADD TO '
S0004    DC    CL9'SUB FROM '
S0005    DC    CL7'MUL BY '
S0006    DC    CL9'DIV INTO '
S0007    DC    CL7'GIVING '
S0008    DC    CL4'REM '
S0009    DC    CL12'REM ROUNDED '
S0010    DC    CL4'POW '
S0011    DC    CL7'SIZE 1 '
S0012    DC    CL12'SIZE 2 WRONG'
S0013    DC    CL6'AFTER '
S0014    DC    CL7'SIZE 3 '
S0015    DC    CL7'SIZE 4 '
S0016    DC    CL7'SIZE 5 '
...
SPIENUM  DC    H'65'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(25,0)
         DC    A(T0001-COBBEG),AL2(25,0)
         DC    A(T0002-COBBEG),AL2(26,0)
         DC    A(T0003-COBBEG),AL2(27,0)
         DC    A(T0004-COBBEG),AL2(27,0)
         DC    A(T0005-COBBEG),AL2(28,0)
         DC    A(T0006-COBBEG),AL2(29,0)
         DC    A(T0007-COBBEG),AL2(29,0)
         DC    A(T0008-COBBEG),AL2(30,0)
         ...
         DC    A(T0014-COBBEG),AL2(34,0)
         DC    A(T0015-COBBEG),AL2(35,0)
         DC    A(T0016-COBBEG),AL2(35,0)
         DC    A(T0017-COBBEG),AL2(36,0)
         DC    A(T0018-COBBEG),AL2(37,0)
         DC    A(T0019-COBBEG),AL2(37,0)
         DC    A(T0020-COBBEG),AL2(38,0)
         DC    A(T0021-COBBEG),AL2(39,0)
         DC    A(T0022-COBBEG),AL2(39,0)
         DC    A(T0023-COBBEG),AL2(40,0)
         DC    A(T0024-COBBEG),AL2(41,0)
         DC    A(T0025-COBBEG),AL2(41,0)
         DC    A(T0026-COBBEG),AL2(42,0)
         DC    A(T0027-COBBEG),AL2(42,0)
         DC    A(T0028-COBBEG),AL2(43,0)
         DC    A(T0029-COBBEG),AL2(44,0)
         DC    A(T0030-COBBEG),AL2(44,0)
         DC    A(T0031-COBBEG),AL2(45,0)
         DC    A(T0032-COBBEG),AL2(45,0)
         DC    A(T0033-COBBEG),AL2(46,0)
         DC    A(T0034-COBBEG),AL2(47,0)
         DC    A(T0035-COBBEG),AL2(48,0)
         DC    A(T0036-COBBEG),AL2(49,0)
         DC    A(T0037-COBBEG),AL2(50,0)
         DC    A(T0038-COBBEG),AL2(51,0)
         DC    A(T0039-COBBEG),AL2(52,0)
         DC    A(T0040-COBBEG),AL2(53,0)
         DC    A(T0041-COBBEG),AL2(54,0)
         DC    A(T0042-COBBEG),AL2(55,0)
         DC    A(T0043-COBBEG),AL2(56,0)
         DC    A(T0044-COBBEG),AL2(57,0)
         DC    A(T0045-COBBEG),AL2(58,0)
         DC    A(T0046-COBBEG),AL2(58,0)
         DC    A(T0047-COBBEG),AL2(59,0)
         DC    A(T0048-COBBEG),AL2(59,0)
         DC    A(T0049-COBBEG),AL2(60,0)
         DC    A(T0050-COBBEG),AL2(61,0)
         DC    A(T0051-COBBEG),AL2(61,0)
         DC    A(T0052-COBBEG),AL2(62,0)
         DC    A(T0053-COBBEG),AL2(63,0)
         DC    A(T0054-COBBEG),AL2(63,0)
         DC    A(T0055-COBBEG),AL2(64,0)
         DC    A(T0056-COBBEG),AL2(64,0)
         DC    A(T0057-COBBEG),AL2(65,0)
         DC    A(T0058-COBBEG),AL2(65,0)
         DC    A(T0059-COBBEG),AL2(66,0)
         DC    A(T0060-COBBEG),AL2(66,0)
         DC    A(T0061-COBBEG),AL2(67,0)
         DC    A(T0062-COBBEG),AL2(68,0)
...
* WORKING-STORAGE
D0000    DC    CL5'00010'          A PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0001    DC    CL5'00020'          B PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0002    DC    CL5'00000'          C PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0003    DC    CL5'00000'          D PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0004    DC    CL2'05'             S2 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0005    DC    CL2'06'             T2 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0006    DC    XL2'005F'           C3 PIC 9(2)v0 COMP-3
         DS    XL6                 reserve the rest of a table
D0007    DC    CL2'00'             C3-SHOW PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0008    DC    CL1'3'              N PIC 9(1)v0 DISP
         DS    XL7                 reserve the rest of a table
D0009    DC    CL9'000000000'      P PIC 9(9)v0 DISP
         DS    XL7                 reserve the rest of a table
D0010    DC    CL5'00000'          Q PIC 9(5)v2 DISP
         DS    XL3                 reserve the rest of a table
D0011    DC    CL5'00000'          R PIC 9(5)v2 DISP
         DS    XL3                 reserve the rest of a table
D0012    DC    CL6' '              E-Q edited, 6 chars
         DS    XL2                 reserve the rest of a table
D0013    DC    CL6' '              E-R edited, 6 chars
         DS    XL2                 reserve the rest of a table
D0014    DC    CL1'0'              ZED PIC 9(1)v0 DISP
*---------------------------------------------------------------
