*---------------------------------------------------------------
* Generated by cobc370 from float1.cbl
...
T0047    DS    0H
* COMPUTE F4 = ...
         LD    0,=D'1000000000000000'  literal
         STD   0,D0003             F4
T0048    DS    0H
* MOVE F4 -> R5
         LD    0,D0003             F4
         ...
         LA    1,EDWK+11           where printing starts if EDMK stays
         EDMK  EDWK(18),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0033               not negative?
         MVI   0(1),C'-'
G0033    DS    0H
         MVC   D0010(16),EDWK+2    the edited result
T0049    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0017
         MVC   DSPBUF+16(16),D0010+0
         LA    1,PARM0017
         L     15,VDISP
         BALR  14,15
T0050    DS    0H
...
* MOVE F4 -> I3
         LD    0,D0003             F4
         LA    1,PWK1
         LA    0,0                 the receiver's scale
         L     15,VFPK
         BALR  14,15               floating -> packed
         UNPK  D0011(3),PWK1(16)   packed -> zoned
T0052    DS    0H
* MOVE I3 -> E3
         ...
         MVC   EDWK(7),M0003       load the ED pattern
         ED    EDWK(7),EDSRC
         BNM   G0035               not negative?
         MVI   EDWK+3,C'-'
         B     G0036
G0035    MVI   EDWK+3,C' '
G0036    DS    0H
         MVC   D0012(4),EDWK+3     the edited result
T0053    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0018
         MVC   DSPBUF+16(4),D0012+0
         LA    1,PARM0018
         L     15,VDISP
         BALR  14,15
...
* MOVE F3 -> ED
         LD    0,D0002             F3
         LA    1,PWK1
         LA    0,3                 the receiver's scale
         L     15,VFPK
         BALR  14,15               floating -> packed
         ZAP   EDSRC(4),PWK1(16)   source, sized to the selector count
         NI    EDSRC,X'0F'         truncate to the picture: the spare d
         MVC   EDWK(10),M0004      load the ED pattern
         ED    EDWK(10),EDSRC
         BNM   G0037               not negative?
         MVI   EDWK+2,C'-'
         B     G0038
G0037    MVI   EDWK+2,C' '
G0038    DS    0H
         MVC   D0013(8),EDWK+2     the edited result
T0055    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0019
         MVC   DSPBUF+16(8),D0013+0
         LA    1,PARM0019
         L     15,VDISP
         BALR  14,15
T0056    DS    0H
...
* MOVE S1 -> R12
         ...
         EDMK  EDWK(18),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0047               not negative?
         MVI   0(1),C'-'
G0047    DS    0H
         MVC   D0009(17),EDWK+1    the edited result
T0083    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0030
         MVC   DSPBUF+16(17),D0009+0
         LA    1,PARM0030
         L     15,VDISP
         BALR  14,15
...
* MOVE S1 -> R12
         ...
         EDMK  EDWK(18),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0049               not negative?
         MVI   0(1),C'-'
G0049    DS    0H
         MVC   D0009(17),EDWK+1    the edited result
T0086    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0031
         MVC   DSPBUF+16(17),D0009+0
         LA    1,PARM0031
         L     15,VDISP
         BALR  14,15
...
* MOVE F4 -> R12
         ...
         EDMK  EDWK(18),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0053               not negative?
         MVI   0(1),C'-'
G0053    DS    0H
         MVC   D0009(17),EDWK+1    the edited result
T0092    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0033
         MVC   DSPBUF+16(17),D0009+0
         LA    1,PARM0033
         L     15,VDISP
         BALR  14,15
...
* MOVE F1 -> R12
         ...
         EDMK  EDWK(18),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0055               not negative?
         MVI   0(1),C'-'
G0055    DS    0H
         MVC   D0009(17),EDWK+1    the edited result
T0095    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0034
         MVC   DSPBUF+16(17),D0009+0
         LA    1,PARM0034
         L     15,VDISP
         BALR  14,15
...
T0099    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0036
         LD    0,D0001             F2
         LA    1,ZWK
         LA    0,17                the digits
         L     15,VFDS
         BALR  14,15               floating point as DISPLAY shows it
         MVC   DSPBUF+16(23),ZWK+0
         LA    1,PARM0036
         L     15,VDISP
         BALR  14,15
T0100    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0037
         LD    0,D0002             F3
         LA    1,ZWK
         LA    0,17                the digits
         L     15,VFDS
...
* DISPLAY
         ...
         L     15,VFDS
         BALR  14,15               floating point as DISPLAY shows it
         MVC   DSPBUF+16(14),ZWK+0
         LA    1,PARM0038
         L     15,VDISP
         BALR  14,15
T0102    DS    0H
* MOVE 123456789012345 -> F4
         LD    0,=D'123456789012345'  literal
         STD   0,D0003             F4
T0103    DS    0H
* MOVE F4 -> R5
         LD    0,D0003             F4
         ...
         EDMK  EDWK(18),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0059               not negative?
         MVI   0(1),C'-'
G0059    DS    0H
         MVC   D0010(16),EDWK+2    the edited result
T0104    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0039
         MVC   DSPBUF+16(16),D0010+0
         LA    1,PARM0039
         L     15,VDISP
         BALR  14,15
...
* MOVE F4 -> R12
         ...
         EDMK  EDWK(18),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0061               not negative?
         MVI   0(1),C'-'
G0061    DS    0H
         MVC   D0009(17),EDWK+1    the edited result
T0107    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0040
         MVC   DSPBUF+16(17),D0009+0
         LA    1,PARM0040
         L     15,VDISP
         BALR  14,15
...
LEN0030  DC    H'33'
PARM0031 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0031)  last parameter
LEN0031  DC    H'33'
PARM0032 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0032)  last parameter
LEN0032  DC    H'33'
PARM0033 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0033)  last parameter
LEN0033  DC    H'33'
PARM0034 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0034)  last parameter
LEN0034  DC    H'33'
PARM0035 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0035)  last parameter
LEN0035  DC    H'24'
PARM0036 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0036)  last parameter
LEN0036  DC    H'39'
PARM0037 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0037)  last parameter
LEN0037  DC    H'39'
PARM0038 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0038)  last parameter
LEN0038  DC    H'30'
PARM0039 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0039)  last parameter
LEN0039  DC    H'32'
PARM0040 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0040)  last parameter
LEN0040  DC    H'33'
...
WK4      DS    PL16
WK5      DS    PL16
M0001    DC    XL18'40402021204B202020202020202020202020'  ED patterns
M0002    DC    XL18'4020402020202020202021204B2020202020'
M0003    DC    XL7'40202140202020'
M0004    DC    XL10'4021402020204B202020'
S0001    DC    CL16'A VALUE 1.5     '  nonnumeric constants
S0002    DC    CL16'B VALUE -2.25   '
S0003    DC    CL16'C MOVE 0.1      '
S0004    DC    CL16'D MOVE P1(3)    '
S0005    DC    CL16'E MOVE D1       '
S0006    DC    CL16'F MOVE B1       '
S0007    DC    CL16'G P1/P2 ->F     '
S0008    DC    CL16'H 1/3 ->F       '
S0009    DC    CL16'I F2+F3         '
S0010    DC    CL16'J F2*F3         '
S0011    DC    CL16'K F2/F3         '
S0012    DC    CL16'L F2-F3         '
S0013    DC    CL16'M 2**0.5        '
S0014    DC    CL16'N 25**F1(.5)    '
S0015    DC    CL16'O 1.5**3        '
S0016    DC    CL16'P 1.5**-2.25    '
S0017    DC    CL16'Q 10**15        '
S0018    DC    CL16'R 150 ->S9(3)   '
S0019    DC    CL16'S -2.25 ->edit  '
S0020    DC    CL16'T -2.25 ->S9(3) '
S0021    DC    CL16'U -2.25 rounded '
S0022    DC    CL16'V 8.1 ->S9(3)   '
S0023    DC    CL16'W F2/7 ->P1     '
S0024    DC    CL12'X F3 < 0 YES'
S0025    DC    CL11'X F3 < 0 NO'
S0026    DC    CL14'Y F2 = 1.5 YES'
S0027    DC    CL13'Y F2 = 1.5 NO'
S0028    DC    CL13'Z F2 > P1 YES'
S0029    DC    CL12'Z F2 > P1 NO'
S0030    DC    CL16'AA COMP-1 0.1   '
S0031    DC    CL16'AB COMP-1 1/3   '
S0032    DC    CL16'AC ADD F2 TO F4 '
S0033    DC    CL16'AD MULT         '
S0034    DC    CL16'AE DIVIDE       '
S0035    DC    CL16'AF F2 -> P1     '
S0036    DC    CL16'AG DISPLAY F2   '
S0037    DC    CL16'AH DISPLAY F3   '
S0038    DC    CL16'AI DISPLAY S1   '
S0039    DC    CL16'AJ 15 DIGITS    '
S0040    DC    CL16'AK 1.0E+3       '
...
SPIENUM  DC    H'109'              statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(31,0)
         DC    A(T0001-COBBEG),AL2(31,0)
         DC    A(T0002-COBBEG),AL2(32,0)
         ...
         DC    A(T0008-COBBEG),AL2(35,0)
         DC    A(T0009-COBBEG),AL2(36,0)
         DC    A(T0010-COBBEG),AL2(37,0)
         DC    A(T0011-COBBEG),AL2(37,0)
         DC    A(T0012-COBBEG),AL2(38,0)
         DC    A(T0013-COBBEG),AL2(39,0)
         DC    A(T0014-COBBEG),AL2(39,0)
         DC    A(T0015-COBBEG),AL2(40,0)
         DC    A(T0016-COBBEG),AL2(41,0)
         DC    A(T0017-COBBEG),AL2(41,0)
         DC    A(T0018-COBBEG),AL2(42,0)
         DC    A(T0019-COBBEG),AL2(43,0)
         DC    A(T0020-COBBEG),AL2(43,0)
         DC    A(T0021-COBBEG),AL2(44,0)
         DC    A(T0022-COBBEG),AL2(45,0)
         DC    A(T0023-COBBEG),AL2(45,0)
         DC    A(T0024-COBBEG),AL2(46,0)
         DC    A(T0025-COBBEG),AL2(47,0)
         DC    A(T0026-COBBEG),AL2(47,0)
         DC    A(T0027-COBBEG),AL2(48,0)
         DC    A(T0028-COBBEG),AL2(49,0)
         DC    A(T0029-COBBEG),AL2(49,0)
         DC    A(T0030-COBBEG),AL2(50,0)
         DC    A(T0031-COBBEG),AL2(51,0)
         DC    A(T0032-COBBEG),AL2(51,0)
         DC    A(T0033-COBBEG),AL2(52,0)
         DC    A(T0034-COBBEG),AL2(53,0)
         DC    A(T0035-COBBEG),AL2(53,0)
         DC    A(T0036-COBBEG),AL2(54,0)
         DC    A(T0037-COBBEG),AL2(55,0)
         DC    A(T0038-COBBEG),AL2(56,0)
         DC    A(T0039-COBBEG),AL2(56,0)
         DC    A(T0040-COBBEG),AL2(57,0)
         DC    A(T0041-COBBEG),AL2(58,0)
         DC    A(T0042-COBBEG),AL2(58,0)
         DC    A(T0043-COBBEG),AL2(59,0)
         DC    A(T0044-COBBEG),AL2(60,0)
         DC    A(T0045-COBBEG),AL2(60,0)
         DC    A(T0046-COBBEG),AL2(61,0)
         DC    A(T0047-COBBEG),AL2(62,0)
         DC    A(T0048-COBBEG),AL2(62,0)
         DC    A(T0049-COBBEG),AL2(63,0)
         DC    A(T0050-COBBEG),AL2(64,0)
         DC    A(T0051-COBBEG),AL2(65,0)
         DC    A(T0052-COBBEG),AL2(65,0)
         DC    A(T0053-COBBEG),AL2(66,0)
         DC    A(T0054-COBBEG),AL2(67,0)
         DC    A(T0055-COBBEG),AL2(67,0)
         DC    A(T0056-COBBEG),AL2(68,0)
         DC    A(T0057-COBBEG),AL2(68,0)
         DC    A(T0058-COBBEG),AL2(69,0)
         DC    A(T0059-COBBEG),AL2(70,0)
         DC    A(T0060-COBBEG),AL2(70,0)
         DC    A(T0061-COBBEG),AL2(71,0)
         DC    A(T0062-COBBEG),AL2(72,0)
         DC    A(T0063-COBBEG),AL2(73,0)
         DC    A(T0064-COBBEG),AL2(73,0)
         DC    A(T0065-COBBEG),AL2(74,0)
         DC    A(T0066-COBBEG),AL2(75,0)
         DC    A(T0067-COBBEG),AL2(75,0)
         DC    A(T0068-COBBEG),AL2(76,0)
         DC    A(T0069-COBBEG),AL2(77,0)
         DC    A(T0070-COBBEG),AL2(77,0)
         DC    A(T0071-COBBEG),AL2(77,0)
         DC    A(T0072-COBBEG),AL2(77,0)
         DC    A(T0073-COBBEG),AL2(78,0)
         DC    A(T0074-COBBEG),AL2(78,0)
         DC    A(T0075-COBBEG),AL2(79,0)
         DC    A(T0076-COBBEG),AL2(79,0)
         DC    A(T0077-COBBEG),AL2(80,0)
         DC    A(T0078-COBBEG),AL2(80,0)
         DC    A(T0079-COBBEG),AL2(81,0)
         DC    A(T0080-COBBEG),AL2(81,0)
         DC    A(T0081-COBBEG),AL2(82,0)
         DC    A(T0082-COBBEG),AL2(82,0)
         DC    A(T0083-COBBEG),AL2(83,0)
         DC    A(T0084-COBBEG),AL2(84,0)
         DC    A(T0085-COBBEG),AL2(84,0)
         DC    A(T0086-COBBEG),AL2(85,0)
         DC    A(T0087-COBBEG),AL2(86,0)
         DC    A(T0088-COBBEG),AL2(86,0)
         DC    A(T0089-COBBEG),AL2(87,0)
         DC    A(T0090-COBBEG),AL2(88,0)
         DC    A(T0091-COBBEG),AL2(88,0)
         DC    A(T0092-COBBEG),AL2(89,0)
         DC    A(T0093-COBBEG),AL2(90,0)
         DC    A(T0094-COBBEG),AL2(90,0)
         DC    A(T0095-COBBEG),AL2(91,0)
         DC    A(T0096-COBBEG),AL2(92,0)
         DC    A(T0097-COBBEG),AL2(92,0)
         DC    A(T0098-COBBEG),AL2(93,0)
         DC    A(T0099-COBBEG),AL2(94,0)
         DC    A(T0100-COBBEG),AL2(95,0)
         DC    A(T0101-COBBEG),AL2(96,0)
         DC    A(T0102-COBBEG),AL2(97,0)
         DC    A(T0103-COBBEG),AL2(97,0)
         DC    A(T0104-COBBEG),AL2(98,0)
         DC    A(T0105-COBBEG),AL2(99,0)
         DC    A(T0106-COBBEG),AL2(99,0)
         DC    A(T0107-COBBEG),AL2(100,0)
         DC    A(T0108-COBBEG),AL2(101,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    DL8'0'              F1 COMP-2, long hex float
D0001    DC    DL8'1.5'            F2 COMP-2, long hex float
D0002    DC    DL8'-2.25'          F3 COMP-2, long hex float
D0003    DC    DL8'0'              F4 COMP-2, long hex float
D0004    DC    EL4'0'              S1 COMP-1, short hex float
         DS    XL4                 reserve the rest of a table
D0005    DC    PL5'3000'           P1 PIC S9(8)v3 COMP-3
         DS    XL3                 reserve the rest of a table
D0006    DC    PL5'7000'           P2 PIC S9(8)v3 COMP-3
         DS    XL3                 reserve the rest of a table
D0007    DC    ZL8'12345'          D1 PIC S9(8)v3 DISP
D0008    DC    FL4'100'            B1 PIC S9(8)v0 COMP
         DS    XL4                 reserve the rest of a table
D0009    DC    CL17' '             R12 edited, 17 chars
         DS    XL7                 reserve the rest of a table
D0010    DC    CL16' '             R5 edited, 16 chars
D0011    DC    ZL3'0'              I3 PIC S9(3)v0 DISP
         DS    XL5                 reserve the rest of a table
D0012    DC    CL4' '              E3 edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0013    DC    CL8' '              ED edited, 8 chars
*---------------------------------------------------------------
