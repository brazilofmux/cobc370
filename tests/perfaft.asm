*---------------------------------------------------------------
* Generated by cobc370 from perfaft.cbl
...
* DISPLAY
         ...
         MVC   DSPBUF+8(3),S0004
         MVC   DSPBUF+11(2),D0000+0
         MVC   DSPBUF+13(3),S0005
         MVC   DSPBUF+16(2),D0001+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
...
R0004    DS    0H
         ...
         OI    D0001+1,X'F0'       unsigned: force an F zone
         B     L0021
L0023    DS    0H                  AFTER level done: reset it, step the
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  WK0(16),D0000(2)    zoned -> packed
...
T0014    DS    0H
* MOVE J -> JX
         MVC   D0007(2),D0001      alphanumeric move
T0015    DS    0H
* STRING ... INTO LINE-OUT
...
X0001    DC    A(F0001)            SHOW-IJ
X0002    DC    A(F0002)            COUNT-IT
X0003    DC    A(F0003)            COUNT-X
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
VSTR     DC    V(COBSTR)
SB0017   DS    0F                  STRING parameter block
         DC    AL4(0)              the receiver
         DC    AL2(20),AL2(4)      its length, the item count
         DC    AL4(SP0017)         WITH POINTER cell
         ...
         DC    AL2(2),AL2(0)       length; DELIMITED BY SIZE
         DC    AL4(0)
         DC    AL4(S0002)          item, a constant
         DC    AL2(1),AL2(0)       length; DELIMITED BY SIZE
         DC    AL4(0)
SP0017   DS    F                   the POINTER as a fullword
PWK1     DS    PL16
PWK2     DS    PL16
...
SPIENUM  DC    H'20'               statements in the table
SPIEREGS DS    15F
SPIEDW   DS    D
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0008-COBBEG),AL2(35)
         DC    AL2(T0009-COBBEG),AL2(36)
         DC    AL2(T0010-COBBEG),AL2(39)
         DC    AL2(T0011-COBBEG),AL2(40)
         DC    AL2(T0012-COBBEG),AL2(42)
         DC    AL2(T0013-COBBEG),AL2(43)
         DC    AL2(T0014-COBBEG),AL2(43)
         DC    AL2(T0015-COBBEG),AL2(44)
         DC    AL2(T0016-COBBEG),AL2(46)
         DC    AL2(T0017-COBBEG),AL2(46)
         DC    AL2(T0018-COBBEG),AL2(48)
         DC    AL2(T0019-COBBEG),AL2(50)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL2'00'             I PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0001    DC    CL2'00'             J PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0002    DC    CL2'00'             K PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    CL2'00'             N PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0004    DC    CL20' '             LINE-OUT PIC X(20)
         DS    XL4                 reserve the rest of a table
D0005    DC    CL2'01'             P PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0006    DC    CL2' '              IX PIC X(2)
         DS    XL6                 reserve the rest of a table
D0007    DC    CL2' '              JX PIC X(2)
*---------------------------------------------------------------
