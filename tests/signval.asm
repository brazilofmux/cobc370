*---------------------------------------------------------------
* Generated by cobc370 from signval.cbl
...
* DISPLAY
         ...
         USING WSC0000,8
         MVC   DSPBUF+4(4),D0000+0
         MVC   DSPBUF+8(1),S0002
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0001    DS    0H
* MOVE V1 -> E
         MVC   ZWK(4),D0000        the item, sign and all
         PACK  PWK1(16),ZWK+1(3)   the digits, without the sign charact
...
G0001    MVI   EDWK+3,C' '
G0002    DS    0H
         MVC   D0004(4),EDWK+3     the edited result
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(5),S0003
         MVC   DSPBUF+5(4),D0004+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
* MOVE V2 -> E
         MVC   ZWK(3),D0001        the item, sign and all
         MVZ   ZWK+2(1),ZWK        the sign moves to where PACK looks f
         OI    ZWK,X'F0'           the leading digit is a digit again
         PACK  PWK1(16),ZWK(3)     zoned -> packed
         ZAP   EDSRC(3),PWK1(16)   source, sized to the selector count
         MVI   EDSRC,X'00'         truncate to the picture: the spare d
         MVC   EDWK(7),M0001       load the ED pattern
         ED    EDWK(7),EDSRC
...
T0006    DS    0H
* MOVE V3 -> E
         MVC   ZWK(4),D0002        the item, sign and all
         PACK  PWK1(16),ZWK+0(3)   the digits, without the sign charact
         CLI   ZWK+3,C'-'          negative?
         BNE   L0002
         NI    PWK1+15,X'F0'       clear the sign nibble
         OI    PWK1+15,X'0D'       and make it negative
L0002    DS    0H
...
T0008    DS    0H
* DISPLAY
         MVC   DSPBUF+0(4),S0007
         MVC   DSPBUF+4(4),D0003+0
         MVC   DSPBUF+8(1),S0002
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0009    DS    0H
* MOVE V4 -> E
         MVC   ZWK(4),D0003        the item, sign and all
         PACK  PWK1(16),ZWK+1(3)   the digits, without the sign charact
         CLI   ZWK+0,C'-'          negative?
         BNE   L0003
         NI    PWK1+15,X'F0'       clear the sign nibble
...
* ADD 1 -> V2
         ...
         AP    PWK1(16),PWK2(16)
         UNPK  ZWK(3),PWK1(16)     packed -> zoned
         MVZ   ZWK(1),ZWK+2        the sign moves to the leading digit
         OI    ZWK+2,X'F0'         the trailing digit is a digit again
         MVC   D0001(3),ZWK        the item, sign and all
T0012    DS    0H
* MOVE V2 -> E
         MVC   ZWK(3),D0001        the item, sign and all
         MVZ   ZWK+2(1),ZWK        the sign moves to where PACK looks f
...
S0001    DC    CL4'V1 ['           nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL5'V1 = '
S0004    DC    CL5'V2 = '
S0005    DC    CL4'V3 ['
...
SPIELTB  DS    0F
         ...
         DC    A(T0007-COBBEG),AL2(18,0)
         DC    A(T0008-COBBEG),AL2(19,0)
         DC    A(T0009-COBBEG),AL2(19,0)
         DC    A(T0010-COBBEG),AL2(19,0)
         DC    A(T0011-COBBEG),AL2(20,0)
         DC    A(T0012-COBBEG),AL2(20,0)
         DC    A(T0013-COBBEG),AL2(20,0)
         DC    A(T0014-COBBEG),AL2(21,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    C'-',CL3'005'       V1 PIC S9(3)v0 DISP
         DS    XL4                 reserve the rest of a table
D0001    DC    XL1'D0',CL2'05'     V2 PIC S9(3)v0 DISP
         DS    XL5                 reserve the rest of a table
D0002    DC    CL3'005',C'-'       V3 PIC S9(3)v0 DISP
         DS    XL4                 reserve the rest of a table
D0003    DC    C'+',CL3'012'       V4 PIC S9(3)v0 DISP
         DS    XL4                 reserve the rest of a table
D0004    DC    CL4' '              E edited, 4 chars
*---------------------------------------------------------------
