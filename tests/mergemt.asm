*---------------------------------------------------------------
* Generated by cobc370 from mergemt.cbl
...
L0044    DS    0H
T0003    DS    0H
* MOVE KEY02 F2 -> E2-REC
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(10),S0001     literal move, space padded
T0004    DS    0H
* WRITE E2-REC
         PUT   FD001,D0003
         DROP  8
L0002    DS    0H
T0005    DS    0H
* MOVE KEY05 F2 -> E2-REC
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(10),S0002     literal move, space padded
T0006    DS    0H
* WRITE E2-REC
         PUT   FD001,D0003
         DROP  8
...
T0014    DS    0H
         LA    14,L0010
         ST    14,MRGRET
         B     L0007               the file's first record
L0010    DS    0H
T0015    DS    0H
         LA    14,L0011
         ST    14,MRGRET
         B     L0008               the file's first record
L0011    DS    0H
T0016    DS    0H
         LA    14,L0012
         ST    14,MRGRET
         B     L0009               the file's first record
L0012    DS    0H
T0017    DS    0H
...
* RETURN MERGE-FILE
         ...
         BZ    L0015
         B     L0056               it is in the SD's record
L0055    DS    0H
...
L0054    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0009+0(10),0(1)    into the SD's record
L0056    DS    0H
         DROP  8
         B     L0016
L0015    DS    0H                  AT END
...
* MOVE M-REC -> OUT-REC
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0007(10),D0009     alphanumeric move
T0021    DS    0H
* WRITE OUT-REC
         PUT   FD003,D0007
T0022    DS    0H
...
L0006    DS    0H
         ...
         LTR   4,4
         BZ    L0063               the first candidate
         BAL   14,L0059            compare
         LTR   15,15
         BZ    L0062               the best so far stays
L0063    DS    0H
         LR    4,5
         LA    5,0
...
L0062    DS    0H
         ...
         LTR   4,4
         BZ    L0065               the first candidate
         BAL   14,L0059            compare
         LTR   15,15
         BZ    L0064               the best so far stays
L0065    DS    0H
         LR    4,5
         LA    5,1
         ST    5,MRGBST            the file it came from
L0064    DS    0H
         ...
         LTR   4,4
         BZ    L0067               the first candidate
         BAL   14,L0059            compare
         LTR   15,15
         BZ    L0066               the best so far stays
L0067    DS    0H
         LR    4,5
         LA    5,2
         ST    5,MRGBST            the file it came from
L0066    DS    0H
         LTR   4,4
         BZ    L0057               every file at end
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0009+0(10),0(4)    into the SD's record
         DROP  8
         L     15,MRGBST
         SLL   15,2
...
L0057    DS    0H
         ...
         L     14,MRGRT
         BR    14
L0059    DS    0H                  candidate before the best?
         CLC   0(5,4),0(5)         M-KEY
         BH    L0060               ASCENDING
         BL    L0061
L0061    DS    0H                  equal: the first-named file's
         SR    15,15
         BR    14
L0060    DS    0H
         LA    15,1
...
* MOVE SORT-RETURN -> SR
         ...
         ZAP   PWK1(16),DWK(8)
         UNPK  D0014(4),PWK1(16)   packed -> zoned
T0043    DS    0H
* DISPLAY
         MVC   DSPBUF+0(24),S0003
         MVC   DSPBUF+24(4),D0014+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0044    DS    0H
...
* READ OUT-FILE
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         GET   FD003,D0007         QSAM move mode
         B     L0024
L0023    DS    0H                  AT END
         DROP  8
T0046    DS    0H
* MOVE Y -> EOF
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0012(1),S0004      literal move, space padded
         DROP  8
L0024    DS    0H
T0047    DS    0H
* PERFORM SHOW-ONE
L0070    DS    0H
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0012(1),S0004      alphanumeric compare
         BE    L0071
...
T0049    DS    0H
* MERGE MERGE-FILE
         XC    MRGF001(16),MRGF001  no file at end
         L     8,BL0000            base locator
         USING WSC0000,8
         LA    1,D0001             E1
         ST    1,MRGA001+0
...
T0052    DS    0H
         LA    14,L0029
         ST    14,MRGRET
         B     L0027               the file's first record
L0029    DS    0H
T0053    DS    0H
         LA    14,L0030
         ST    14,MRGRET
         B     L0028               the file's first record
L0030    DS    0H
T0054    DS    0H
* PERFORM COUNT-IT
...
L0031    DS    0H                  AT END
         DROP  8
T0060    DS    0H
         MVI   MRGF001+0,1         that file is at end
T0061    DS    0H
         L     14,MRGRET
         BR    14                  back to whoever asked for the READ
L0032    DS    0H
...
L0033    DS    0H                  AT END
         DROP  8
T0064    DS    0H
         MVI   MRGF001+1,1         that file is at end
T0065    DS    0H
         L     14,MRGRET
         BR    14                  back to whoever asked for the READ
L0034    DS    0H
...
L0026    DS    0H
         ...
         CLI   MRGF001+0,0         E1
         BNE   L0083               at end
         L     5,MRGA001+0         its record
         LTR   4,4
         BZ    L0084               the first candidate
         BAL   14,L0080            compare
         LTR   15,15
         BZ    L0083               the best so far stays
L0084    DS    0H
         LR    4,5
         LA    5,0
         ST    5,MRGBST            the file it came from
L0083    DS    0H
         CLI   MRGF001+1,0         E3
         BNE   L0085               at end
         L     5,MRGA001+4         its record
         LTR   4,4
         BZ    L0086               the first candidate
         BAL   14,L0080            compare
         LTR   15,15
         BZ    L0085               the best so far stays
L0086    DS    0H
         LR    4,5
         LA    5,1
         ST    5,MRGBST            the file it came from
L0085    DS    0H
         ...
         L     15,MRGBST
         SLL   15,2
         L     15,MRGT001(15)      that file's READ
         LA    14,L0079
         ST    14,MRGRET
         BR    15                  read it again
L0079    DS    0H
...
L0078    DS    0H
         ...
         L     14,MRGRT
         BR    14
L0080    DS    0H                  candidate before the best?
         CLC   0(5,4),0(5)         M-KEY
         BH    L0081               ASCENDING
         BL    L0082
L0082    DS    0H                  equal: the first-named file's
         SR    15,15
         BR    14
L0081    DS    0H
         LA    15,1
...
T0068    DS    0H
* DISPLAY
         MVC   DSPBUF+0(22),S0005
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+22(2),D0013+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0069    DS    0H
...
* DISPLAY
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+0(10),D0007+0
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0071    DS    0H
* READ OUT-FILE
         LA    1,L0035             this READ's AT END
         STCM  1,7,FD003+33        into DCBEODAD
         GET   FD003,D0007         QSAM move mode
         B     L0036
L0035    DS    0H                  AT END
...
* RETURN MERGE-FILE
         ...
         LTR   1,1                 zero: no more
         BZ    L0037
         B     L0090               it is in the SD's record
L0089    DS    0H
         CLI   SRTHAVE,1           a record the sort handed over?
         BE    L0088
         LA    14,L0087
...
T0074    DS    0H
* DISPLAY
         MVC   DSPBUF+0(17),S0006
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+17(2),D0013+0
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0075    DS    0H
...
X0001    DC    A(F0001)            SHOW-ONE
X0004    DC    A(F0004)            C-EXIT
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
MRGT000  DC    A(L0007,L0008,L0009)  each file's READ
MRGF001  DS    XL16                MERGE: which USING files are at end
MRGA001  DS    16F                 each file's record area
MRGT001  DC    A(L0027,L0028)      each file's READ
PWK1     DS    PL16
PWK2     DS    PL16
...
FD002    DCB   DDNAME=MRGIN3,DSORG=PS,MACRF=(GM,PM),RECFM=FB,          X
               LRECL=10,BLKSIZE=10
FD003    DCB   DDNAME=OUTFILE,DSORG=PS,MACRF=(GM,PM),RECFM=FB,         X
               LRECL=10,BLKSIZE=10
K0001    EQU   *-15                numeric constants, as long as used
         DC    PL1'1'
S0001    DC    CL10'KEY02 F2  '    nonnumeric constants
S0002    DC    CL10'KEY05 F2  '
S0003    DC    CL24'FIRST MERGE SORT-RETURN '
S0004    DC    CL1'Y'
S0005    DC    CL22'SECOND MERGE RETURNED '
S0006    DC    CL17'AT END ON RETURN '
...
SPIELTB  DS    0F
         ...
         DC    A(T0001-COBBEG),AL2(35,0)
         DC    A(T0002-COBBEG),AL2(35,0)
         DC    A(T0003-COBBEG),AL2(36,0)
         DC    A(T0004-COBBEG),AL2(37,0)
         DC    A(T0005-COBBEG),AL2(38,0)
         DC    A(T0006-COBBEG),AL2(39,0)
         DC    A(T0007-COBBEG),AL2(40,0)
         DC    A(T0008-COBBEG),AL2(40,0)
         DC    A(T0009-COBBEG),AL2(40,0)
         DC    A(T0010-COBBEG),AL2(41,0)
         DC    A(T0011-COBBEG),AL2(42,0)
         DC    A(T0012-COBBEG),AL2(42,0)
         DC    A(T0013-COBBEG),AL2(42,0)
         DC    A(T0014-COBBEG),AL2(42,0)
         DC    A(T0015-COBBEG),AL2(42,0)
         DC    A(T0016-COBBEG),AL2(42,0)
         DC    A(T0017-COBBEG),AL2(42,0)
         DC    A(T0018-COBBEG),AL2(42,0)
         DC    A(T0019-COBBEG),AL2(42,0)
         DC    A(T0020-COBBEG),AL2(42,0)
         DC    A(T0021-COBBEG),AL2(42,0)
         DC    A(T0022-COBBEG),AL2(42,0)
         DC    A(T0023-COBBEG),AL2(42,0)
         DC    A(T0024-COBBEG),AL2(42,0)
         DC    A(T0025-COBBEG),AL2(42,0)
         DC    A(T0026-COBBEG),AL2(42,0)
         DC    A(T0027-COBBEG),AL2(42,0)
         DC    A(T0028-COBBEG),AL2(42,0)
         DC    A(T0029-COBBEG),AL2(42,0)
         DC    A(T0030-COBBEG),AL2(42,0)
         DC    A(T0031-COBBEG),AL2(42,0)
         DC    A(T0032-COBBEG),AL2(42,0)
         DC    A(T0033-COBBEG),AL2(42,0)
         DC    A(T0034-COBBEG),AL2(42,0)
         DC    A(T0035-COBBEG),AL2(42,0)
         DC    A(T0036-COBBEG),AL2(42,0)
         DC    A(T0037-COBBEG),AL2(42,0)
         DC    A(T0038-COBBEG),AL2(42,0)
         DC    A(T0039-COBBEG),AL2(42,0)
         DC    A(T0040-COBBEG),AL2(42,0)
         DC    A(T0041-COBBEG),AL2(42,0)
         DC    A(T0042-COBBEG),AL2(43,0)
         DC    A(T0043-COBBEG),AL2(44,0)
         DC    A(T0044-COBBEG),AL2(45,0)
         DC    A(T0045-COBBEG),AL2(46,0)
         DC    A(T0046-COBBEG),AL2(46,0)
         DC    A(T0047-COBBEG),AL2(47,0)
         DC    A(T0048-COBBEG),AL2(48,0)
         DC    A(T0049-COBBEG),AL2(49,0)
         DC    A(T0050-COBBEG),AL2(50,0)
         DC    A(T0051-COBBEG),AL2(50,0)
         DC    A(T0052-COBBEG),AL2(50,0)
         DC    A(T0053-COBBEG),AL2(50,0)
         DC    A(T0054-COBBEG),AL2(50,0)
         DC    A(T0055-COBBEG),AL2(50,0)
         DC    A(T0056-COBBEG),AL2(50,0)
         DC    A(T0057-COBBEG),AL2(50,0)
         DC    A(T0058-COBBEG),AL2(50,0)
         DC    A(T0059-COBBEG),AL2(50,0)
         DC    A(T0060-COBBEG),AL2(50,0)
         DC    A(T0061-COBBEG),AL2(50,0)
         DC    A(T0062-COBBEG),AL2(50,0)
         DC    A(T0063-COBBEG),AL2(50,0)
         DC    A(T0064-COBBEG),AL2(50,0)
         DC    A(T0065-COBBEG),AL2(50,0)
         DC    A(T0066-COBBEG),AL2(50,0)
         DC    A(T0067-COBBEG),AL2(50,0)
         DC    A(T0068-COBBEG),AL2(51,0)
         DC    A(T0069-COBBEG),AL2(52,0)
         DC    A(T0070-COBBEG),AL2(54,0)
         DC    A(T0071-COBBEG),AL2(55,0)
         DC    A(T0072-COBBEG),AL2(55,0)
         DC    A(T0073-COBBEG),AL2(58,0)
         DC    A(T0074-COBBEG),AL2(59,0)
         DC    A(T0075-COBBEG),AL2(60,0)
         DC    A(T0076-COBBEG),AL2(61,0)
         DC    A(T0077-COBBEG),AL2(62,0)
         DC    A(T0078-COBBEG),AL2(64,0)
...
D0001    DC    CL10' '             E1-REC PIC X(10)
         DS    XL2                 reserve the rest of a table
D0002    DC    CL4' '              *RDW PIC X(4)
D0003    DC    CL10' '             E2-REC PIC X(10)
         DS    XL2                 reserve the rest of a table
D0004    DC    CL4' '              *RDW PIC X(4)
D0005    DC    CL10' '             E3-REC PIC X(10)
         DS    XL2                 reserve the rest of a table
D0006    DC    CL4' '              *RDW PIC X(4)
D0007    DC    CL10' '             OUT-REC PIC X(10)
         DS    XL2                 reserve the rest of a table
D0008    DC    CL4' '              *RDW PIC X(4)
D0009    DS    0CL10               M-REC (01 group)
D0010    DC    CL5' '              M-KEY PIC X(5)
D0011    DC    CL5' '              M-REST PIC X(5)
         DS    XL6                 reserve the rest of a table
D0012    DC    CL1'N'              EOF PIC X(1)
         DS    XL7                 reserve the rest of a table
D0013    DC    CL2'00'             CNT PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0014    DC    ZL4'0'              SR PIC S9(4)v0 DISP
D0015    DC    HL2'0'              SORT-RETURN PIC S9(4)v0 COMP
         DS    XL2                 reserve the rest of a table
D0016    DC    FL4'0'              SORT-FILE-SIZE PIC S9(8)v0 COMP
*---------------------------------------------------------------
