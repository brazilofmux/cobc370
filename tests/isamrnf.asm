*---------------------------------------------------------------
* Generated by cobc370 from isamrnf.cbl
...
* READ DESCIDX
         ...
         MVC   D0001(81),0(1)      block-relative record into the FD ar
         MVC   D0006(2),=C'00'     FILE STATUS
         B     L0002
...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+3(2),D0006+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0005    DS    0H
* MOVE 555 -> WS-NOMKEY
         MVC   D0005(10),S0004     numeric literal as zoned digits
T0006    DS    0H
* READ DESCIDX
         MVI   ISFLG,X'00'
         XC    DB000(4),DB000      clear the ECB before each READ
...
T0009    DS    0H
* MOVE 300 -> WS-NOMKEY
         MVC   D0005(10),S0007     numeric literal as zoned digits
T0010    DS    0H
* READ DESCIDX
         MVI   ISFLG,X'00'
         XC    DB000(4),DB000      clear the ECB before each READ
...
* DISPLAY
         ...
         USING WSC0000,8
         MVC   DSPBUF+3(2),D0006+0
         MVC   DSPBUF+5(1),S0010
         MVC   DSPBUF+6(70),D0004+0
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0013    DS    0H
...
WK5      DS    PL16
* file control blocks
FD000    DCB   DDNAME=DESCIDX,DSORG=IS,MACRF=(R),SYNAD=ISYNAD
S0001    DC    CL10'0000000200'    nonnumeric constants
S0002    DC    CL4'IK1 '
S0003    DC    CL3'R1 '
S0004    DC    CL10'0000000555'
S0005    DC    CL4'IK2 '
S0006    DC    CL3'R2 '
...
D0005    DC    CL10'0000000000'    WS-NOMKEY PIC 9(10)v0 DISP
         DS    XL6                 reserve the rest of a table
D0006    DC    CL2' '              WS-ST PIC X(2)
*---------------------------------------------------------------
