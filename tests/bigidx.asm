*---------------------------------------------------------------
* Generated by cobc370 from bigidx.cbl
...
L0010    DS    0H
         ...
         BNP   L0001               AT END
         C     1,FC001             past the last occurrence?
         BH    L0001               AT END
         DROP  8
         L     8,BL0048            base locator
         USING WSC0048,8
...
SP012    DS    0H
         ...
         L     8,BL0048            base locator
         USING WSC0048,8
         ST    1,D0005             the index is the occurrence number
         L     7,D0005             subscript
         BCTR  7,0                 subscript-1
         MH    7,H0001             times element size
         L     9,BL0000            base locator
...
L0007    DS    0H
         ...
         L     1,D0005
         LA    1,1(1)
         ST    1,SL012             low = mid + 1
         B     SP012
         DROP  8
L0004    DS    0H
T0009    DS    0H
* DISPLAY
         MVC   DSPBUF+0(12),S0003
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0010    DS    0H
...
* MOVE SUB -> E-K
         ...
         UNPK  0(5,6),PWK1(16)     packed -> zoned
         OI    4(6),X'F0'          unsigned: force an F zone
...
SL012    DC    F'0'                SEARCH ALL low bound
SH012    DC    F'0'                high bound
X0001    DC    A(F0001)            B010
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
S0001    DC    CL12'SERIAL ATEND'  nonnumeric constants
S0002    DC    CL11'SERIAL HIT '
S0003    DC    CL12'BINARY ATEND'
S0004    DC    CL11'BINARY HIT '
...
SPIENUM  DC    H'15'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0006-COBBEG),AL2(23)
         DC    AL2(T0007-COBBEG),AL2(24)
         DC    AL2(T0008-COBBEG),AL2(25)
         DC    AL2(T0009-COBBEG),AL2(25)
         DC    AL2(T0010-COBBEG),AL2(26)
...
WSC0002  EQU   COBWS+8192
WSC0003  EQU   COBWS+12288
WSC0004  EQU   COBWS+16384
WSC0005  EQU   COBWS+20480
WSC0006  EQU   COBWS+24576
WSC0007  EQU   COBWS+28672
WSC0008  EQU   COBWS+32768
WSC0009  EQU   COBWS+36864
WSC0010  EQU   COBWS+40960
WSC0011  EQU   COBWS+45056
WSC0012  EQU   COBWS+49152
WSC0013  EQU   COBWS+53248
WSC0014  EQU   COBWS+57344
WSC0015  EQU   COBWS+61440
WSC0016  EQU   COBWS+65536
WSC0017  EQU   COBWS+69632
WSC0018  EQU   COBWS+73728
WSC0019  EQU   COBWS+77824
WSC0020  EQU   COBWS+81920
WSC0021  EQU   COBWS+86016
WSC0022  EQU   COBWS+90112
WSC0023  EQU   COBWS+94208
WSC0024  EQU   COBWS+98304
WSC0025  EQU   COBWS+102400
WSC0026  EQU   COBWS+106496
WSC0027  EQU   COBWS+110592
WSC0028  EQU   COBWS+114688
WSC0029  EQU   COBWS+118784
WSC0030  EQU   COBWS+122880
WSC0031  EQU   COBWS+126976
WSC0032  EQU   COBWS+131072
WSC0033  EQU   COBWS+135168
WSC0034  EQU   COBWS+139264
WSC0035  EQU   COBWS+143360
WSC0036  EQU   COBWS+147456
WSC0037  EQU   COBWS+151552
WSC0038  EQU   COBWS+155648
WSC0039  EQU   COBWS+159744
WSC0040  EQU   COBWS+163840
WSC0041  EQU   COBWS+167936
WSC0042  EQU   COBWS+172032
WSC0043  EQU   COBWS+176128
WSC0044  EQU   COBWS+180224
WSC0045  EQU   COBWS+184320
WSC0046  EQU   COBWS+188416
WSC0047  EQU   COBWS+192512
WSC0048  EQU   COBWS+196608
* WORKING-STORAGE
D0000    DS    0C                  T (01 group)
D0001    DS    0CL5                E (05 group, OCCURS 40000)
D0002    DC    CL5'00000'          E-K PIC 9(5)v0 DISP
         DS    199995X             reserve the rest of a table
D0003    DC    FL4'0'              SUB PIC S9(5)v0 COMP
         DS    XL4                 reserve the rest of a table
D0004    DC    CL5'00000'          SHOW PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0005    DC    FL4'0'              EX PIC S9(9)v0 COMP
*---------------------------------------------------------------
