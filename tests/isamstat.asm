*---------------------------------------------------------------
* Generated by cobc370 from isamstat.cbl
...
T0003    DS    0H
* MOVE TWO HUNDRED -> DESC-TEXT
         MVC   D0004(70),S0002     literal move, space padded
T0004    DS    0H
* WRITE DESC-RECORD
         MVI   ISFLG,X'00'
...
T0015    DS    0H
* MOVE 300 -> DESC-KEY
         MVC   D0003(10),S0010     numeric literal as zoned digits
T0016    DS    0H
* MOVE THREE HUNDRED -> DESC-TEXT
         MVC   D0004(70),S0011     literal move, space padded
T0017    DS    0H
* WRITE DESC-RECORD
         MVI   ISFLG,X'00'
         XC    FD000+80(2),FD000+80  clear DCBEXCD before each PUT
...
S0005    DC    CL4'IK2 '
S0006    DC    CL3'W2 '
S0007    DC    CL10'0000000100'
S0008    DC    CL4'IK3 '
S0009    DC    CL3'W3 '
S0010    DC    CL10'0000000300'
S0011    DC    CL48'THREE HUNDRED                                   '
         DC    CL22'                      '
S0012    DC    CL4'IK4 '
S0013    DC    CL3'W4 '
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0001-COBBEG),AL2(27)
         DC    AL2(T0002-COBBEG),AL2(28)
         DC    AL2(T0003-COBBEG),AL2(29)
         ...
         DC    AL2(T0018-COBBEG),AL2(40)
         DC    AL2(T0019-COBBEG),AL2(41)
