*---------------------------------------------------------------
* Generated by cobc370 from sortsize.cbl
...
* SORT SORT-FILE
         ...
         MVI   SRTHAVE,0
         L     15,D0011            SORT-FILE-SIZE
         LTR   15,15
         BNP   L0006
         CVD   15,DWK
         UNPK  SRT0002Z(7),DWK+4(4)
         OI    SRT0002Z+6,X'F0'
         LA    15,SRT0002G
         B     L0007
L0006    DS    0H
         LA    15,SRT0002F
L0007    DS    0H
         ST    15,SRT0002E+4       the SORT statement's last byte
         DROP  8
...
SRT0002S DC    C' SORT FIELDS=(0001,005,CH,A,0006,005,ZD,'  SORT statem
         DC    C'D,0011,004,PD,D,0015,004,FI,A,0019,002,F'
         DC    C'I,A,0021,020,CH,A)'
SRT0002F EQU   *-1                 its end without SIZE
         DC    C',SIZE=E'
SRT0002Z DC    C'0000000'          SORT-FILE-SIZE, when positive
SRT0002G EQU   *-1                 its end with SIZE
SRT0002R DC    C' RECORD TYPE=F,LENGTH=(00040)'  RECORD statement
SRT0002Q EQU   *-1
         DS    0F
         DC    H'0'
SRT0002L DC    AL2(24)             sort parameter list: its length
SRT0002E DC    A(SRT0002S,SRT0002F,SRT0002R,SRT0002Q)  SORT and RECORD,
         DC    A(SRTE15,SRTE35)    the exits
SRT0002P DC    X'80',AL3(SRT0002L)  R1 -> this
PWK1     DS    PL16
PWK2     DS    PL16
...
D0002    DS    0CL5                S-G (05 group)
D0003    DC    CL3' '              S-G1 PIC X(3)
D0004    DC    CL2'00'             S-G2 PIC 9(2)v0 DISP
D0005    DC    ZL5'0'              S-ZD PIC S9(5)v0 DISP
D0006    DC    PL4'0'              S-PD PIC S9(7)v0 COMP-3
D0007    DC    FL4'0'              S-FW PIC S9(9)v0 COMP
D0008    DC    HL2'0'              S-HW PIC 9(4)v0 COMP
D0009    DC    CL20' '             S-X PIC X(20)
D0010    DC    HL2'0'              SORT-RETURN PIC S9(4)v0 COMP
         DS    XL2                 reserve the rest of a table
D0011    DC    FL4'0'              SORT-FILE-SIZE PIC S9(8)v0 COMP
*---------------------------------------------------------------
