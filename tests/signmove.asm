*---------------------------------------------------------------
* Generated by cobc370 from signmove.cbl
...
* MOVE SL -> A4
         ...
         USING WSC0000,8
         MVC   D0003(3),D0000      alphanumeric move
         MVI   D0003+3,C' '        space fill the remainder
         OI    D0003+0,X'F0'       the sign is not moved
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(11),S0001
         MVC   DSPBUF+11(4),D0003+0
...
T0002    DS    0H
* MOVE SS -> A4
         MVC   ZWK(3),D0001+1      the digits, not the sign character
         MVC   D0003(3),ZWK        alphanumeric move
         MVI   D0003+3,C' '        space fill the remainder
T0003    DS    0H
* DISPLAY
...
T0004    DS    0H
* MOVE ST -> A4
         MVC   ZWK(3),D0002+0      the digits, not the sign character
         MVC   D0003(3),ZWK        alphanumeric move
         MVI   D0003+3,C' '        space fill the remainder
T0005    DS    0H
* DISPLAY
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL11'LEADING   ['   nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL11'LEAD SEP  ['
S0004    DC    CL11'TRAIL SEP ['
...
SPIELTB  DS    0F
         ...
         DC    A(T0005-COBBEG),AL2(17,0)
         DC    A(T0006-COBBEG),AL2(18,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    XL1'D1',CL2'23'     SL PIC S9(3)v0 DISP
         DS    XL5                 reserve the rest of a table
D0001    DC    C'+',CL3'123'       SS PIC S9(3)v0 DISP
         DS    XL4                 reserve the rest of a table
D0002    DC    CL3'456',C'-'       ST PIC S9(3)v0 DISP
         DS    XL4                 reserve the rest of a table
D0003    DC    CL4' '              A4 PIC X(4)
*---------------------------------------------------------------
