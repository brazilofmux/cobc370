*---------------------------------------------------------------
* Generated by cobc370 from pscale.cbl
...
* MOVE TRAIL2 -> SHOW
         ...
         MVI   EDWK+3,C'-'
G0001    DS    0H
         MVC   D0004(19),EDWK+3    the edited result
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(7),S0001
         MVC   DSPBUF+7(19),D0004+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
...
* COMPUTE ACC = ...
         ...
         OI    ZWK+1,X'F0'
         MVC   D0005(18),ZWK       the whole zoned item
T0009    DS    0H
* MOVE ACC -> SHOW
         MVC   ZWK(18),D0005       the whole zoned item
...
M0001    DC    XL22'4020214020202020202020204B202020202020202020'  ED p
S0001    DC    CL7'TRAIL2 '        nonnumeric constants
S0002    DC    CL7'TRAIL1 '
S0003    DC    CL7'LEAD2  '
S0004    DC    CL7'LEAD8  '
S0005    DC    CL7'SUM    '
...
D0004    DC    CL19' '             SHOW edited, 19 chars
         DS    XL5                 reserve the rest of a table
D0005    DC    CL17'00000000000000000',XL1'C0'  ACC PIC S9(18)v9 DISP
*---------------------------------------------------------------
