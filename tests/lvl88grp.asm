*---------------------------------------------------------------
* Generated by cobc370 from lvl88grp.cbl
...
* IF
         ...
         USING WSC0000,8
         CLC   D0002(10),S0001     alphanumeric compare
         BNE   L0001
T0001    DS    0H
* DISPLAY
...
* MOVE X -> N1
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0004(10),S0004     literal move, space padded
T0005    DS    0H
* IF
         CLC   D0002(10),S0001     alphanumeric compare
         BNE   L0003
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL10'          '    nonnumeric constants
S0002    DC    CL10'NAME BLANK'
S0003    DC    CL14'NAME NOT BLANK'
S0004    DC    CL10'X         '
S0005    DC    CL6'BB   ['
S0006    DC    CL1']'
S0007    DC    CL1'Z'
...
* WORKING-STORAGE
D0000    DS    0CL11               G (01 group)
D0001    DC    CL1'N'              FLAG PIC X(1)
D0002    DS    0CL10               NAME (05 group)
D0004    DC    CL10' '             N1 PIC X(10)
         DS    XL5                 reserve the rest of a table
D0005    DS    0CL11               REC (01 group)
D0006    DC    CL5'AAAAA'          RA PIC X(5)
D0007    DS    0CL6                RB (05 group)
D0008    DC    CL3'BBB'            RB1 PIC X(3)
D0009    DC    CL3'CCC'            RB2 PIC X(3)
D0010    EQU   COBWS+16            AB REDEFINES
D0011    EQU   COBWS+21            BB REDEFINES
*---------------------------------------------------------------
