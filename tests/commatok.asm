*---------------------------------------------------------------
* Generated by cobc370 from commatok.cbl
...
T0006    DS    0H
* DISPLAY
         MVC   DSPBUF+0(3),D0002+0
         MVC   DSPBUF+3(3),D0003+0
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0007    DS    0H
* DISPLAY
         ...
         MVC   DSPBUF+2(3),D0002+0
         MVC   DSPBUF+5(3),S0005
         MVC   DSPBUF+8(3),D0003+0
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0008    DS    0H
