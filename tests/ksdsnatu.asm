...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0004(15),S0008     alphanumeric compare
         BNE   L0006
T0018    DS    0H
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0004(15),S0009     alphanumeric compare
         BNE   L0007
T0020    DS    0H
...
T0024    DS    0H
* MOVE AUSTIN -> KR-CITY
         MVC   D0004(15),S0011     literal move, space padded
T0025    DS    0H
* MOVE N -> OP-FAILED-SWITCH
         MVC   D0009(1),S0012      literal move, space padded
T0026    DS    0H
* REWRITE KSDS-RECORD
...
SPIELTB  DS    0F
         ...
         DC    A(T0005-COBBEG),AL2(37,0)
         DC    A(T0006-COBBEG),AL2(38,0)
         ...
         DC    A(T0018-COBBEG),AL2(55,0)
         DC    A(T0019-COBBEG),AL2(57,0)
         DC    A(T0020-COBBEG),AL2(57,0)
         DC    A(T0021-COBBEG),AL2(59,0)
         DC    A(T0022-COBBEG),AL2(61,0)
         DC    A(T0023-COBBEG),AL2(62,0)
         DC    A(T0024-COBBEG),AL2(63,0)
         DC    A(T0025-COBBEG),AL2(64,0)
         DC    A(T0026-COBBEG),AL2(66,0)
         DC    A(T0027-COBBEG),AL2(66,0)
         DC    A(T0028-COBBEG),AL2(68,0)
         DC    A(T0029-COBBEG),AL2(68,0)
         DC    A(T0030-COBBEG),AL2(69,0)
         DC    A(T0031-COBBEG),AL2(71,0)
         DC    A(T0032-COBBEG),AL2(71,0)
         DC    A(T0033-COBBEG),AL2(73,0)
         DC    A(T0034-COBBEG),AL2(75,0)
         DC    A(T0035-COBBEG),AL2(76,0)
         DC    A(T0036-COBBEG),AL2(77,0)
         DC    A(T0037-COBBEG),AL2(79,0)
         DC    A(T0038-COBBEG),AL2(79,0)
         DC    A(T0039-COBBEG),AL2(81,0)
         DC    A(T0040-COBBEG),AL2(81,0)
         DC    A(T0041-COBBEG),AL2(83,0)
         DC    A(T0042-COBBEG),AL2(83,0)
         DC    A(T0043-COBBEG),AL2(85,0)
...
D0003    DC    CL49' '             FILL0003 PIC X(49)
D0004    DC    CL15' '             KR-CITY PIC X(15)
D0005    DC    CL6' '              FILL0005 PIC X(6)
...
D0009    DC    CL1'N'              OP-FAILED-SWITCH PIC X(1)
*---------------------------------------------------------------
