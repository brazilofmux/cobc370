*---------------------------------------------------------------
* Generated by cobc370 from sortug.cbl
...
L0024    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0005+0(80),0(1)    into the SD's record
         B     L0011
L0010    DS    0H                  AT END
         DROP  8
T0011    DS    0H
...
* MOVE S-REC -> OUT-REC
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(80),D0005     alphanumeric move
T0013    DS    0H
* WRITE OUT-REC
         PUT   FD001,D0003
T0014    DS    0H
...
* MOVE SORT-RETURN -> SR
         ...
         ZAP   PWK1(16),DWK(8)
         UNPK  D0010(4),PWK1(16)   packed -> zoned
T0018    DS    0H
* DISPLAY
         MVC   DSPBUF+0(12),S0001
         MVC   DSPBUF+12(4),D0010+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0019    DS    0H
...
* MOVE Y -> EOF
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0009(1),S0002      literal move, space padded
         DROP  8
L0013    DS    0H
T0022    DS    0H
* PERFORM SHOW-ONE
...
SRT0001S DC    C' SORT FIELDS=(0011,002,ZD,D,0001,010,CH,'  SORT statem
         DC    C'A)'
...
FD001    DCB   DDNAME=OUTFILE,DSORG=PS,MACRF=(GM,PM),RECFM=FB,         X
               LRECL=80,BLKSIZE=80
...
D0005    DS    0CL80               S-REC (01 group)
D0006    DC    CL10' '             S-NAME PIC X(10)
D0007    DC    CL2'00'             S-DEPT PIC 9(2)v0 DISP
D0008    DC    CL68' '             S-REST PIC X(68)
D0009    DC    CL1'N'              EOF PIC X(1)
         DS    XL7                 reserve the rest of a table
D0010    DC    ZL4'0'              SR PIC S9(4)v0 DISP
