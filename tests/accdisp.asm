*---------------------------------------------------------------
* Generated by cobc370 from accdisp.cbl
...
* ACCEPT DX FROM DATE
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(6),ZWK        alphanumeric move
         MVI   D0003+6,C' '        space fill the remainder
         MVC   D0003+7(1),D0003+6
         DROP  8
T0004    DS    0H
* MOVE D6 -> DX
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(6),D0000      alphanumeric move
         MVI   D0003+6,C' '        space fill the remainder
         MVC   D0003+7(1),D0003+6
T0005    DS    0H
* MOVE DX -> DXR
         MVC   D0004(8),D0003      alphanumeric move
T0006    DS    0H
* MOVE DX-YY -> YY1
         LA    1,D0007
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0007(2),D0008      unsigned zoned: a byte compare is ex
         BNE   L0002
T0012    DS    0H
* DISPLAY
...
* MOVE BBBB -> E
         ...
         MH    6,H0001             times element size
         LA    6,D0011(6)          element address
         MVC   0(4,6),S0006        literal move, space padded
T0019    DS    0H
* MOVE CCCC -> E
         LA    6,2                 subscript-1
         MH    6,H0001             times element size
         LA    6,D0011(6)          element address
         MVC   0(4,6),S0007        literal move, space padded
T0020    DS    0H
* DISPLAY
         MVC   DSPBUF+0(1),S0008
         LA    6,1                 subscript-1
         MH    6,H0001             times element size
         LA    6,D0011(6)          element address
         LA    6,0(,6)             the element
         MVC   DSPBUF+1(4),0(6)
         MVC   DSPBUF+5(2),S0009
         ...
         LA    6,0(,6)             the element
         MVC   DSPBUF+7(4),0(6)
         MVC   DSPBUF+11(2),S0009
         LA    6,2                 subscript-1
         MH    6,H0001             times element size
         LA    6,D0011(6)          element address
         LA    6,0(,6)             the element
         MVC   DSPBUF+13(4),0(6)
         MVC   DSPBUF+17(1),S0010
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
T0021    DS    0H
* DISPLAY
         MVC   DSPBUF+0(120),D0013+0
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0022    DS    0H
* DISPLAY
         MVC   DSPBUF+0(30),D0013+120
         LA    1,PARM0007
         L     15,VDISP
         BALR  14,15
T0023    DS    0H
* DISPLAY
         ...
         MVC   DSPBUF+1(119),D0013+0
         LA    1,PARM0008
         L     15,VDISP
         BALR  14,15
T0024    DS    0H
* DISPLAY
         MVC   DSPBUF+0(31),D0013+119
         MVC   DSPBUF+31(1),S0012
         LA    1,PARM0009
         L     15,VDISP
         BALR  14,15
T0025    DS    0H
...
* MOVE WIDER -> WIDE-R
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0016(100),D0015    alphanumeric move
T0027    DS    0H
* MOVE WR1 -> W1
         MVC   D0019(50),D0017     alphanumeric move
T0028    DS    0H
* MOVE WR2 -> W2
         MVC   D0020(50),D0018     alphanumeric move
T0029    DS    0H
* DISPLAY
         MVC   DSPBUF+0(1),S0008
         MVC   DSPBUF+1(50),D0019+0
         MVC   DSPBUF+51(1),S0010
         LA    1,PARM0010
         L     15,VDISP
         BALR  14,15
T0030    DS    0H
...
* DISPLAY UPON CONSOLE
         MVC   DSPBUF+0(15),S0013
         LA    1,15
         STH   1,WTOLEN
         LA    1,WTOPARM
         L     15,VWTO
         BALR  14,15               to the operator
T0034    DS    0H
* STOP RUN
...
VWTO     DC    V(COBWTO)
WTOPARM  DC    A(DSPBUF),X'80',AL3(WTOLEN)  DISPLAY UPON CONSOLE
WTOLEN   DS    H
VADT     DC    V(COBADT)
...
S0001    DC    CL21'DATE DAY TIME NUMERIC'  nonnumeric constants
S0002    DC    CL11'YEARS AGREE'
S0003    DC    CL13'HOUR IN RANGE'
S0004    DC    CL7'NONZERO'
S0005    DC    CL4'AAAA'
S0006    DC    CL4'BBBB'
S0007    DC    CL4'CCCC'
S0008    DC    CL1'['
...
SPIENUM  DC    H'35'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(47,0)
         DC    A(T0001-COBBEG),AL2(48,0)
         DC    A(T0002-COBBEG),AL2(49,0)
         DC    A(T0003-COBBEG),AL2(50,0)
         DC    A(T0004-COBBEG),AL2(51,0)
         DC    A(T0005-COBBEG),AL2(52,0)
         DC    A(T0006-COBBEG),AL2(53,0)
         DC    A(T0007-COBBEG),AL2(54,0)
         DC    A(T0008-COBBEG),AL2(55,0)
         DC    A(T0009-COBBEG),AL2(57,0)
         DC    A(T0010-COBBEG),AL2(57,0)
         DC    A(T0011-COBBEG),AL2(58,0)
         DC    A(T0012-COBBEG),AL2(58,0)
         DC    A(T0013-COBBEG),AL2(59,0)
         DC    A(T0014-COBBEG),AL2(59,0)
         DC    A(T0015-COBBEG),AL2(60,0)
         DC    A(T0016-COBBEG),AL2(60,0)
         DC    A(T0017-COBBEG),AL2(61,0)
         DC    A(T0018-COBBEG),AL2(62,0)
         DC    A(T0019-COBBEG),AL2(63,0)
         DC    A(T0020-COBBEG),AL2(64,0)
         DC    A(T0021-COBBEG),AL2(65,0)
         DC    A(T0022-COBBEG),AL2(65,0)
         DC    A(T0023-COBBEG),AL2(66,0)
         DC    A(T0024-COBBEG),AL2(66,0)
         DC    A(T0025-COBBEG),AL2(67,0)
         DC    A(T0026-COBBEG),AL2(68,0)
         DC    A(T0027-COBBEG),AL2(69,0)
         DC    A(T0028-COBBEG),AL2(69,0)
         DC    A(T0029-COBBEG),AL2(70,0)
         DC    A(T0030-COBBEG),AL2(71,0)
         DC    A(T0031-COBBEG),AL2(72,0)
         DC    A(T0032-COBBEG),AL2(73,0)
         DC    A(T0033-COBBEG),AL2(74,0)
         DC    A(T0034-COBBEG),AL2(75,0)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL6'000000'         D6 PIC 9(6)v0 DISP
         DS    XL2                 reserve the rest of a table
D0001    DC    CL5'00000'          D5 PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0002    DC    CL8'00000000'       T8 PIC 9(8)v0 DISP
D0003    DC    CL8' '              DX PIC X(8)
D0004    DS    0CL8                DXR (01 group)
D0005    DC    CL2' '              DX-YY PIC X(2)
D0006    DC    CL6' '              FILL0006 PIC X(6)
D0007    DC    CL2'00'             YY1 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0008    DC    CL2'00'             YY2 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0009    DC    CL2'00'             HH PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0010    DS    0CL12               T (01 group)
D0011    DC    3CL4' '             E PIC X(4) table
         DS    XL4                 reserve the rest of a table
D0012    DC    CL1'2'              I PIC 9(1)v0 DISP
         DS    XL7                 reserve the rest of a table
D0013    DC    CL48'ABABABABABABABABABABABABABABABABABABABABABABABAB'
         DC    CL48'ABABABABABABABABABABABABABABABABABABABABABABABAB'
         DC    CL48'ABABABABABABABABABABABABABABABABABABABABABABABAB'
         DC    CL6'ABABAB'
         DS    XL2                 reserve the rest of a table
D0014    DC    CL100' '            WIDE PIC X(100)
D0015    EQU   COBWS+240           WIDER REDEFINES
         DS    XL4                 reserve the rest of a table
D0016    DS    0CL100              WIDE-R (01 group)
D0017    DC    CL50' '             WR1 PIC X(50)
D0018    DC    CL50' '             WR2 PIC X(50)
         DS    XL4                 reserve the rest of a table
D0019    DC    CL50' '             W1 PIC X(50)
         DS    XL6                 reserve the rest of a table
D0020    DC    CL50' '             W2 PIC X(50)
*---------------------------------------------------------------
