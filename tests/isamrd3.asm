*---------------------------------------------------------------
* Generated by cobc370 from isamrd3.cbl
...
* OPEN INPUT DESCIDX
         ...
         USING WSC0000,8
         MVC   D0007(2),=C'30'     FILE STATUS
         B     L0006
L0005    DS    0H
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0007(2),=C'00'     FILE STATUS
...
* READ DESCIDX
         ...
         LA    2,D0001             the FD area
         LH    3,H0001
         LR    4,1                 the record in the block
         LR    5,3
         MVCL  2,4                 block-relative record into the FD ar
         MVC   D0007(2),=C'00'     FILE STATUS
         B     L0002
...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+3(2),D0007+0
         MVC   DSPBUF+5(1),S0004
         MVC   DSPBUF+6(10),D0005+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0005    DS    0H
* MOVE 300 -> WS-NOMKEY
         MVC   D0006(10),S0005     numeric literal as zoned digits
T0006    DS    0H
* READ DESCIDX
         MVI   ISFLG,X'00'
         XC    DB000(4),DB000      clear the ECB before each READ
...
H0001    DC    H'301'              element sizes
S0001    DC    CL10'0000000200'    nonnumeric constants
S0002    DC    CL6'B3 IK '
S0003    DC    CL3'B3 '
S0004    DC    CL1' '
S0005    DC    CL10'0000000300'
...
SPIENUM  DC    H'11'               statements in the table
SPIEREGS DS    15F
...
D0006    DC    CL10'0000000000'    WS-NOMKEY PIC 9(10)v0 DISP
         DS    XL6                 reserve the rest of a table
D0007    DC    CL2' '              WS-ST PIC X(2)
*---------------------------------------------------------------
