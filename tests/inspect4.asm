*---------------------------------------------------------------
* Generated by cobc370 from inspect4.cbl
...
* MOVE AABAA -> F
         ...
         USING WSC0000,8
         MVC   D0000(5),S0005      literal move, space padded
T0001    DS    0H
* MOVE 0 -> C1
         MVC   D0001(2),S0006      numeric literal as zoned digits
T0002    DS    0H
* MOVE 0 -> C2
         MVC   D0002(2),S0006      numeric literal as zoned digits
T0003    DS    0H
* INSPECT F
*  TALLYING pass
...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+4(5),D0000+0
         MVC   DSPBUF+9(1),S0011
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0011    DS    0H
...
T0014    DS    0H
* MOVE AAABA -> F
         MVC   D0000(5),S0013      literal move, space padded
T0015    DS    0H
* INSPECT F
*  REPLACING pass
         LA    7,D0000             the field
...
INSRLO   DS    2F                  INSPECT: each operand's range
INSRHI   DS    2F
INSNXT   DS    2F                  where a LEADING operand must match n
INSTLY   DS    2F                  each operand's tally
INSOPA   DS    2F                  the strings looked for
INSOPB   DS    2F                  the replacements
INSFLG   DS    XL2                 live flags
PWK1     DS    PL16
PWK2     DS    PL16
