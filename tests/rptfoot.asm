*---------------------------------------------------------------
* Generated by cobc370 from rptfoot.cbl
...
RG000    ST    14,RGS000           save the return
         ...
         MVC   RBUF+1(15),S0002    COLUMN literal
         LA    1,RGP000
         L     15,VWRL
         BALR  14,15
         L     8,BL0000            base locator
         USING WSC0000,8
         L     2,D0004             the last line printed
...
L0019    DS    0H
         ...
         MVI   RBUF+1,C' '
         MVC   RBUF+2(131),RBUF+1  blank the line
         MVC   RBUF+1(13),S0003    COLUMN literal
         MVC   RBUF+20(4),S0004    COLUMN literal
         L     2,D0005
         CVD   2,DWK               binary -> packed
         ZAP   PWK1(16),DWK(8)
         ZAP   EDSRC(2),PWK1(16)   source, sized to the selector count
...
L0023    DS    0H
         ...
         MVI   RBUF+1,C' '
         MVC   RBUF+2(131),RBUF+1  blank the line
         MVC   D0013(3),D0001      zoned to zoned, same picture
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+1(3),D0013     COLUMN placement
         MVC   RBUF+8(6),S0005     COLUMN literal
         LA    1,RGP002
         L     15,VWRL
         BALR  14,15
         DROP  8
...
L0028    DS    0H
         ...
         MVC   RBUF+8(6),S0006     COLUMN literal
         LA    1,RGP003
         L     15,VWRL
         BALR  14,15
         DROP  8
...
RG004    ST    14,RGS004           save the return
         ...
         MVI   RBUF+1,C' '
         MVC   RBUF+2(131),RBUF+1  blank the line
         MVC   RBUF+1(11),S0007    COLUMN literal
         L     8,BL0000            base locator
         USING WSC0000,8
         L     2,D0005
         CVD   2,DWK               binary -> packed
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+12(3),D0020    COLUMN placement
         LA    1,RGP004
         L     15,VWRL
         BALR  14,15
         DROP  8
         MVI   RPF000,X'01'        the PAGE FOOTING is on this page
         L     14,RGS004
         BR    14
...
L0032    DS    0H
         ...
         MVI   RBUF+1,C' '
         MVC   RBUF+2(131),RBUF+1  blank the line
         MVC   RBUF+1(16),S0008    COLUMN literal
         LA    1,RGP005
         L     15,VWRL
         BALR  14,15
         DROP  8
...
REJC000  ST    14,REJCS000
         ...
         L     14,REJCS000
         BR    14
* page advance, report FOOTED-RPT
RADV000  ST    14,RADVS000
         DROP  8
         BAL   14,RG004            PAGE FOOTING
...
RGP000   DC    A(FD000)            RPT-HEAD
         ...
         DC    X'80',AL3(D0004)    LINE-COUNTER; last parameter
...
X0001    DC    A(F0001)            SPACED-PARA
X0002    DC    A(F0002)            JUMPER-PARA
X0003    DC    A(F0003)            SHOW-LC
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
S0005    DC    CL6'spaced'
S0006    DC    CL6'jumper'
S0007    DC    CL11'-- foot of '
S0008    DC    CL16'** END OF REPORT'
...
SPIENUM  DC    H'18'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0003-COBBEG),AL2(56)
         DC    AL2(T0004-COBBEG),AL2(57)
         DC    AL2(T0005-COBBEG),AL2(59)
         DC    AL2(T0006-COBBEG),AL2(60)
         DC    AL2(T0007-COBBEG),AL2(61)
         DC    AL2(T0008-COBBEG),AL2(62)
         DC    AL2(T0009-COBBEG),AL2(63)
         DC    AL2(T0010-COBBEG),AL2(64)
         DC    AL2(T0011-COBBEG),AL2(65)
         DC    AL2(T0012-COBBEG),AL2(67)
         DC    AL2(T0013-COBBEG),AL2(68)
         DC    AL2(T0014-COBBEG),AL2(70)
         DC    AL2(T0015-COBBEG),AL2(71)
         DC    AL2(T0016-COBBEG),AL2(73)
         DC    AL2(T0017-COBBEG),AL2(74)
COBWS    CSECT
...
D0003    DS    0CL8                FOOTED-RPT (01 group)
D0004    DC    FL4'0'              LINE-COUNTER PIC 9(6)v0 COMP
D0005    DC    FL4'0'              PAGE-COUNTER PIC 9(6)v0 COMP
D0006    DS    0C                  RPT-HEAD (02 group)
D0007    DC    CL15' '             RPT0 PIC X(15)
D0008    DS    0C                  PAGE-HEAD (02 group)
D0009    DC    CL13' '             RPT1 PIC X(13)
D0010    DC    CL4' '              RPT2 PIC X(4)
D0011    DC    CL3' '              RPT3 edited, 3 chars
D0012    DS    0C                  SPACED (02 group)
D0013    DC    CL3'000'            RPT4 PIC 9(3)v0 DISP
D0014    DC    CL6' '              RPT5 PIC X(6)
D0015    DS    0C                  JUMPER (02 group)
D0016    DC    CL3'000'            RPT6 PIC 9(3)v0 DISP
D0017    DC    CL6' '              RPT7 PIC X(6)
D0018    DS    0C                  PAGE-FOOT (02 group)
D0019    DC    CL11' '             RPT8 PIC X(11)
D0020    DC    CL3' '              RPT9 edited, 3 chars
D0021    DS    0C                  RPT-FOOT (02 group)
D0022    DC    CL16' '             RPT10 PIC X(16)
*---------------------------------------------------------------
