*---------------------------------------------------------------
* Generated by cobc370 from upsisw.cbl
...
* MOVE YES -> R
         ...
         USING WSC0000,8
         MVC   D0003(3),S0001      literal move, space padded
T0002    DS    0H
         B     L0002
         DROP  8
L0001    DS    0H
...
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
UPSIB    DC    X'00'               the eight switches, UPSI-0 leftmost
VUPSI    DC    V(COBUPSI)
