*---------------------------------------------------------------
* Generated by cobc370 from inspect3.cbl
...
*  REPLACING pass
         ...
         ST    4,INSOPA+4
         LA    4,S0003             the replacement
         ST    4,INSOPB+4
         ST    7,INSRLO+4          the whole field
         ST    5,INSRHI+4
         ST    7,INSNXT+4
         MVI   INSFLG+1,X'01'      live
         LR    3,7                 the position
...
L0003    DS    0H
* operand 2
         CLI   INSFLG+1,X'00'      still live?
         BE    L0005
         C     3,INSRLO+4          in its range yet?
         BL    L0005
         LA    4,1(,3)
         C     4,INSRHI+4          room within its range?
         BH    L0005
         L     4,INSOPA+4
         CLC   0(1,3),0(4)         the string?
         BNE   L0005
...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+4(12),D0000+0
         MVC   DSPBUF+16(1),S0015
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
...
*  REPLACING pass
         ...
         L     5,FC001             its length
         AR    5,7                 its end
         LA    4,S0004             the string looked for
         ST    4,INSOPA+0
...
* operand 1
         ...
         BH    L0009
         L     4,INSOPA+0
         CLC   0(2,3),0(4)         the string?
         BNE   L0009
         L     4,INSOPB+0
         MVC   0(2,3),0(4)         replace
         LA    3,2(,3)             past it
         B     L0007
L0009    DS    0H
* operand 2
...
T0006    DS    0H
* MOVE AAABAAAXAAAA -> S
         MVC   D0000(12),S0017     literal move, space padded
T0007    DS    0H
* MOVE 0 -> C1
         MVC   D0001(2),S0018      numeric literal as zoned digits
T0008    DS    0H
* MOVE 0 -> C2
...
*  TALLYING pass
         ...
         ST    7,INSNXT+4
         MVI   INSFLG+1,X'01'      live
         XC    INSTLY+4(4),INSTLY+4  its tally
         ST    7,INSRLO+8          the whole field
         ST    5,INSRHI+8
         ST    7,INSNXT+8
         MVI   INSFLG+2,X'01'      live
         XC    INSTLY+8(4),INSTLY+8  its tally
         LR    3,7                 the position
...
* operand 1
         ...
         B     L0013
L0016    MVI   INSFLG+0,X'00'      LEADING: a break ends it
L0015    DS    0H
* operand 2
         CLI   INSFLG+1,X'00'      still live?
         BE    L0017
...
L0017    DS    0H
* operand 3
         CLI   INSFLG+2,X'00'      still live?
         BE    L0019
         C     3,INSRLO+8          in its range yet?
         BL    L0019
         LA    4,1(,3)
         C     4,INSRHI+8          room within its range?
         BH    L0019
         L     4,INSTLY+8          one more
         LA    4,1(4)
         ST    4,INSTLY+8
         LA    3,1(,3)             past it
         B     L0013
...
L0014    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  PWK2(16),D0001(2)   zoned -> packed
...
* DISPLAY
         ...
         MVC   DSPBUF+3(2),D0001+0
         MVC   DSPBUF+5(1),S0020
         MVC   DSPBUF+6(2),D0002+0
         MVC   DSPBUF+8(1),S0020
...
L0021    LR    4,5
         ...
         BL    L0023
         CLC   0(1,3),S0007        INITIAL
         BE    L0022
         LA    3,1(3)
         B     L0021
L0023    DS    0H                  not found
...
L0025    LR    4,5
         ...
         LA    3,1(3)
         B     L0025
L0027    DS    0H                  not found
         LR    3,5                 AFTER: nothing
         LR    4,5
         B     L0028
L0026    DS    0H                  found
         LA    3,1(3)              AFTER: from just past it
         LR    4,5
L0028    DS    0H
         ST    3,INSRLO+4          the range
         ST    4,INSRHI+4
         ST    3,INSNXT+4
         MVI   INSFLG+1,X'01'      live
         XC    INSTLY+4(4),INSTLY+4  its tally
...
* operand 1
         ...
         ST    3,INSNXT+0          contiguous so far
         B     L0045
L0048    MVI   INSFLG+0,X'00'      LEADING: a break ends it
L0047    DS    0H
* operand 2
         CLI   INSFLG+1,X'00'      still live?
         BE    L0049
...
T0021    DS    0H
* MOVE ABCABCABCABC -> S
         MVC   D0000(12),S0023     literal move, space padded
T0022    DS    0H
* INSPECT S
*  REPLACING pass
         LA    7,D0000             the field
...
* DISPLAY
         ...
         USING WSC0000,8
         MVC   DSPBUF+4(12),D0000+0
         MVC   DSPBUF+16(2),S0026
         MVC   DSPBUF+18(2),D0001+0
         LA    1,PARM0007
         L     15,VDISP
         BALR  14,15
T0028    DS    0H
...
INSRLO   DS    3F                  INSPECT: each operand's range
INSRHI   DS    3F
INSNXT   DS    3F                  where a LEADING operand must match n
INSTLY   DS    3F                  each operand's tally
INSOPA   DS    3F                  the strings looked for
INSOPB   DS    3F                  the replacements
INSFLG   DS    XL3                 live flags
PWK1     DS    PL16
PWK2     DS    PL16
...
S0011    DC    CL1'Y'
S0012    DC    CL2'CD'
S0013    DC    CL12'ABABABXYZAAB'
S0014    DC    CL4'R1 ['
S0015    DC    CL1']'
S0016    DC    CL4'R2 ['
S0017    DC    CL12'AAABAAAXAAAA'
S0018    DC    CL2'00'
S0019    DC    CL3'T1 '
S0020    DC    CL1' '
S0021    DC    CL3'T2 '
S0022    DC    CL4'R3 ['
S0023    DC    CL12'ABCABCABCABC'
S0024    DC    CL4'R4 ['
S0025    DC    CL4'TR ['
S0026    DC    CL2'] '
...
SPIELTB  DS    0F
         ...
         DC    A(T0003-COBBEG),AL2(21,0)
         DC    A(T0004-COBBEG),AL2(22,0)
         DC    A(T0005-COBBEG),AL2(23,0)
         DC    A(T0006-COBBEG),AL2(24,0)
         DC    A(T0007-COBBEG),AL2(25,0)
         DC    A(T0008-COBBEG),AL2(25,0)
         DC    A(T0009-COBBEG),AL2(25,0)
         DC    A(T0010-COBBEG),AL2(26,0)
         DC    A(T0011-COBBEG),AL2(29,0)
         DC    A(T0012-COBBEG),AL2(30,0)
         DC    A(T0013-COBBEG),AL2(31,0)
         DC    A(T0014-COBBEG),AL2(31,0)
         DC    A(T0015-COBBEG),AL2(31,0)
         DC    A(T0016-COBBEG),AL2(32,0)
         DC    A(T0017-COBBEG),AL2(35,0)
         DC    A(T0018-COBBEG),AL2(36,0)
         DC    A(T0019-COBBEG),AL2(37,0)
         DC    A(T0020-COBBEG),AL2(40,0)
         DC    A(T0021-COBBEG),AL2(41,0)
         ...
         DC    A(T0028-COBBEG),AL2(50,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL12' '             S PIC X(12)
         DS    XL4                 reserve the rest of a table
D0001    DC    CL2'00'             C1 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0002    DC    CL2'00'             C2 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    CL2'00'             C3 PIC 9(2)v0 DISP
*---------------------------------------------------------------
