*---------------------------------------------------------------
* Generated by cobc370 from aixnatr.cbl
...
* MOVE C200 -> AIX-CODE
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0005(4),S0006      literal move, space padded
T0012    DS    0H
* READ AIX-FILE
         LA    1,FD000Q2
         ST    1,FD000X            the key of reference
...
* MOVE DDD -> AIX-DEPT
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0004(3),S0008      literal move, space padded
T0015    DS    0H
* READ AIX-FILE
         LA    1,FD000Q1
         ST    1,FD000X            the key of reference
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0007(2),S0012      alphanumeric compare
         BE    L0011
T0023    DS    0H
* PERFORM SHOW
...
* DISPLAY
         ...
         MVC   DSPBUF+2(1),S0013
         MVC   DSPBUF+3(5),D0002+0
         MVC   DSPBUF+8(1),S0013
         MVC   DSPBUF+9(3),D0004+0
         MVC   DSPBUF+12(1),S0013
...
S0003    DC    CL6'NO AAA'
S0004    DC    CL4'C300'
S0005    DC    CL8'NO C300 '
S0006    DC    CL4'C200'
S0007    DC    CL8'NO C200 '
S0008    DC    CL3'DDD'
S0009    DC    CL7'NO DDD '
S0010    DC    CL6'CLOSE '
S0011    DC    CL7'AT END '
...
SPIENUM  DC    H'25'               statements in the table
SPIEREGS DS    15F
