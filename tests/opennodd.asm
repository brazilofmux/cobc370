*---------------------------------------------------------------
* Generated by cobc370 from opennodd.cbl
...
T0000    DS    0H
* DISPLAY
         MVC   DSPBUF+0(22),S0001
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+22(2),D0002+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
...
L0002    DS    0H
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0002(2),=C'00'     FILE STATUS
L0003    DS    0H
         DROP  8
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(19),S0002
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+19(2),D0002+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
* IF
         CLC   D0002(2),S0003      alphanumeric compare
         BNE   L0001
T0004    DS    0H
* DISPLAY
         MVC   DSPBUF+0(27),S0004
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
         DROP  8
...
WK5      DS    PL16
* file control blocks
FD000    DCB   DDNAME=NOSUCHDD,DSORG=PS,MACRF=(GM)
S0001    DC    CL22'USE PROCEDURE: STATUS '  nonnumeric constants
S0002    DC    CL19'AFTER OPEN: STATUS '
S0003    DC    CL2'30'
S0004    DC    CL27'NOT OPENED, AS IT SHOULD BE'
...
D0001    DC    CL80' '             NF-REC PIC X(80)
D0002    DC    CL2'  '             NF-STATUS PIC X(2)
*---------------------------------------------------------------
