...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+11(2),D0007+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
* MOVE AAA -> AIX-DEPT
         MVC   D0004(3),S0002      literal move, space padded
T0003    DS    0H
* READ AIX-FILE
         LA    1,FD000Q1
         ST    1,FD000X            the key of reference
...
* MOVE C200 -> AIX-CODE
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0005(4),S0004      literal move, space padded
T0008    DS    0H
* START AIX-FILE
...
G0018    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0007(2),=C'23'     nothing at or after the key
         B     G0020
G0019    DS    0H
         DROP  8
         L     8,BL0000            base locator
...
* MOVE ZZZZ -> AIX-CODE
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0005(4),S0009      literal move, space padded
T0018    DS    0H
* READ AIX-FILE
         LA    1,FD000Q2
         ST    1,FD000X            the key of reference
