*---------------------------------------------------------------
* Generated by cobc370 from aixnat.cbl
...
T0000    DS    0H
* OPEN INPUT AIX-FILE
         OPEN  (FD000,,FD000P1,,FD000P2)  VSAM ACB and its paths
...
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(11),S0001
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+11(2),D0006+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
* MOVE AAA -> AIX-DEPT
         MVC   D0003(3),S0002      literal move, space padded
T0003    DS    0H
* READ AIX-FILE
         LA    1,FD000Q1
         ST    1,FD000X            the key of reference
...
* MOVE C200 -> AIX-CODE
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0004(4),S0004      literal move, space padded
T0008    DS    0H
* START AIX-FILE
         MODCB RPL=FD000Q2,OPTCD=(KGE)  not less than
         LTR   15,15
         BNZ   L0003
         POINT RPL=FD000Q2         position by key
         MVI   FD000Q2A,X'01'      the RPL has carried a request
         ...
         LTR   15,15               VSAM request succeeded?
         BZ    G0016
         SHOWCB RPL=FD000Q2,FIELDS=FDBK,AREA=VSFB,LENGTH=4  why did it
...
G0018    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0006(2),=C'23'     nothing at or after the key
         B     G0020
G0019    DS    0H
         DROP  8
         L     8,BL0000            base locator
...
G0020    DS    0H
         ...
         BE    L0018
         ENDREQ RPL=FD000Q2        the failed request is over
         MVI   FD000Q2A,X'00'
L0018    DS    0H
G0017    DS    0H
         B     L0004
...
* MOVE ZZZZ -> AIX-CODE
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0004(4),S0009      literal move, space padded
T0018    DS    0H
* READ AIX-FILE
         LA    1,FD000Q2
         ST    1,FD000X            the key of reference
         MODCB RPL=FD000Q2,OPTCD=(DIR,NSP)  by key
         LTR   15,15
         BZ    G0038
         MVC   D0006(2),=C'30'     could not set the request type
         B     G0039
G0038    DS    0H
         DROP  8
         GET   RPL=FD000Q2         VSAM retrieval by key
         MVI   FD000Q2A,X'01'      the RPL has carried a request
         LTR   15,15               got a record?
         BNZ   L0007
         LTR   15,15               VSAM request succeeded?
...
G0040    DS    0H
         ...
         USING WSC0000,8
         MVC   D0006(2),=C'00'
         SHOWCB RPL=FD000Q2,FIELDS=FDBK,AREA=VSFB,LENGTH=4  a duplicate
         CLI   VSFB+3,X'08'
         BNE   G0044
         MVC   D0006(2),=C'02'     successful, duplicate alternate key
G0044    DS    0H
...
* DISPLAY
         ...
         MVC   DSPBUF+2(1),S0014
         MVC   DSPBUF+3(5),D0001+0
         MVC   DSPBUF+8(1),S0014
         MVC   DSPBUF+9(3),D0003+0
         MVC   DSPBUF+12(1),S0014
...
K0001    DC    PL16'4'             numeric constants
K0002    DC    PL16'3'
K0003    DC    PL16'2'
S0001    DC    CL11'OPEN INPUT '   nonnumeric constants
S0002    DC    CL3'AAA'
S0003    DC    CL6'NO AAA'
S0004    DC    CL4'C200'
S0005    DC    CL8'NO START'
S0006    DC    CL6'START '
S0007    DC    CL5'K0003'
S0008    DC    CL8'NO K0003'
S0009    DC    CL4'ZZZZ'
S0010    DC    CL8'NO ZZZZ '
S0011    DC    CL6'CLOSE '
S0012    DC    CL7'AT END '
S0013    DC    CL2'10'
S0014    DC    CL1' '
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0010-COBBEG),AL2(42)
         DC    AL2(T0011-COBBEG),AL2(43)
         DC    AL2(T0012-COBBEG),AL2(44)
         DC    AL2(T0013-COBBEG),AL2(45)
         DC    AL2(T0014-COBBEG),AL2(46)
         DC    AL2(T0015-COBBEG),AL2(47)
         DC    AL2(T0016-COBBEG),AL2(48)
         DC    AL2(T0017-COBBEG),AL2(49)
         DC    AL2(T0018-COBBEG),AL2(50)
         DC    AL2(T0019-COBBEG),AL2(51)
         DC    AL2(T0020-COBBEG),AL2(52)
         DC    AL2(T0021-COBBEG),AL2(53)
         DC    AL2(T0022-COBBEG),AL2(54)
         DC    AL2(T0023-COBBEG),AL2(57)
         DC    AL2(T0024-COBBEG),AL2(57)
         DC    AL2(T0025-COBBEG),AL2(58)
         DC    AL2(T0026-COBBEG),AL2(58)
