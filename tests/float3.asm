*---------------------------------------------------------------
* Generated by cobc370 from float3.cbl
...
* MOVE F4 -> I3
         ...
         UNPK  D0006(3),PWK1(16)   packed -> zoned
T0002    DS    0H
* MOVE I3 -> E3
         PACK  PWK1(16),D0006(3)   zoned -> packed
...
G0001    MVI   EDWK+3,C' '
G0002    DS    0H
         MVC   D0007(4),EDWK+3     the edited result
T0003    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0001
         MVC   DSPBUF+16(4),D0007+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0004    DS    0H
...
T0028    DS    0H
* MOVE 0125 -> F4
         LD    0,=D'0.125'         literal
         STD   0,D0003             F4
T0029    DS    0H
* MOVE F4 -> Q2
         LD    0,D0003             F4
         LA    1,PWK1
         LA    0,2                 the receiver's scale
         L     15,VFPK
         BALR  14,15               floating -> packed
         UNPK  D0008(3),PWK1(16)   packed -> zoned
         OI    D0008+2,X'F0'       unsigned: force an F zone
T0030    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),S0008
         MVC   DSPBUF+16(3),D0008+0
         LA    1,PARM0008
         L     15,VDISP
         BALR  14,15
T0031    DS    0H
* MOVE 0135 -> F4
         LD    0,=D'0.135'         literal
         STD   0,D0003             F4
T0032    DS    0H
* MOVE F4 -> Q2
         LD    0,D0003             F4
...
WK4      DS    PL16
WK5      DS    PL16
M0001    DC    XL7'40202140202020'  ED patterns
M0002    DC    XL18'40402021204B202020202020202020202020'
H0001    DC    H'8'                element sizes
S0001    DC    CL16'A 1.5 ->S9(3)   '  nonnumeric constants
S0002    DC    CL16'B 3.5           '
S0003    DC    CL16'C 0.5           '
S0004    DC    CL16'D 2.4999        '
S0005    DC    CL16'E 2.50001       '
S0006    DC    CL16'F 6.6           '
S0007    DC    CL16'G 6.4           '
S0008    DC    CL16'H 0.125 -> 9V99 '
S0009    DC    CL16'I 0.135 -> 9V99 '
S0010    DC    CL16'J 0.995 -> 9V99 '
S0011    DC    CL16'K 0.994 -> 9V99 '
S0012    DC    CL16'L 15/10+F0      '
S0013    DC    CL16'M (15/10)       '
S0014    DC    CL16'N 15/10.0       '
S0015    DC    CL16'O 15*1.0/10     '
S0016    DC    CL16'P 15/10*100     '
S0017    DC    CL16'Q F1/D10        '
S0018    DC    CL16'R 7/2           '
S0019    DC    CL16'S 7/2+0.5       '
S0020    DC    CL11'T BEFORE IF'
S0021    DC    CL16'U FE(2) > F2 YES'
S0022    DC    CL15'U FE(2) > F2 NO'
S0023    DC    CL10'V AFTER IF'
S0024    DC    CL13'W F4 > F2 YES'
S0025    DC    CL12'W F4 > F2 NO'
S0026    DC    CL16'X F2 < FE(2) YES'
S0027    DC    CL15'X F2 < FE(2) NO'
S0028    DC    CL16'Y DISPLAY F0    '
S0029    DC    CL16'Z DISPLAY 1-1   '
S0030    DC    CL16'AA -8*-8*-8     '
S0031    DC    CL16'AB -8 ** 3      '
S0032    DC    CL16'AC -8 ** 2      '
S0033    DC    CL16'AD 2 ** 10      '
S0034    DC    CL16'AE 2 ** 0.5     '
S0035    DC    CL16'AF 2 ** -1      '
S0036    DC    CL16'AG 10 ** 3      '
S0037    DC    CL16'AH 1.1 ** 2     '
...
SPIENUM  DC    H'114'              statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(27,0)
         DC    A(T0001-COBBEG),AL2(27,0)
         DC    A(T0002-COBBEG),AL2(27,0)
         DC    A(T0003-COBBEG),AL2(28,0)
         DC    A(T0004-COBBEG),AL2(29,0)
         DC    A(T0005-COBBEG),AL2(29,0)
         DC    A(T0006-COBBEG),AL2(29,0)
         DC    A(T0007-COBBEG),AL2(30,0)
         DC    A(T0008-COBBEG),AL2(31,0)
         DC    A(T0009-COBBEG),AL2(31,0)
         DC    A(T0010-COBBEG),AL2(31,0)
         DC    A(T0011-COBBEG),AL2(32,0)
         DC    A(T0012-COBBEG),AL2(33,0)
         DC    A(T0013-COBBEG),AL2(33,0)
         DC    A(T0014-COBBEG),AL2(33,0)
         DC    A(T0015-COBBEG),AL2(34,0)
         DC    A(T0016-COBBEG),AL2(35,0)
         DC    A(T0017-COBBEG),AL2(35,0)
         DC    A(T0018-COBBEG),AL2(35,0)
         DC    A(T0019-COBBEG),AL2(36,0)
         DC    A(T0020-COBBEG),AL2(37,0)
         DC    A(T0021-COBBEG),AL2(37,0)
         DC    A(T0022-COBBEG),AL2(37,0)
         DC    A(T0023-COBBEG),AL2(38,0)
         DC    A(T0024-COBBEG),AL2(39,0)
         DC    A(T0025-COBBEG),AL2(39,0)
         DC    A(T0026-COBBEG),AL2(39,0)
         DC    A(T0027-COBBEG),AL2(40,0)
         DC    A(T0028-COBBEG),AL2(41,0)
         DC    A(T0029-COBBEG),AL2(41,0)
         DC    A(T0030-COBBEG),AL2(42,0)
         DC    A(T0031-COBBEG),AL2(43,0)
         DC    A(T0032-COBBEG),AL2(43,0)
         DC    A(T0033-COBBEG),AL2(44,0)
         DC    A(T0034-COBBEG),AL2(45,0)
         DC    A(T0035-COBBEG),AL2(45,0)
         DC    A(T0036-COBBEG),AL2(46,0)
         DC    A(T0037-COBBEG),AL2(47,0)
         DC    A(T0038-COBBEG),AL2(47,0)
         DC    A(T0039-COBBEG),AL2(48,0)
         DC    A(T0040-COBBEG),AL2(49,0)
         DC    A(T0041-COBBEG),AL2(49,0)
         DC    A(T0042-COBBEG),AL2(50,0)
         DC    A(T0043-COBBEG),AL2(51,0)
         DC    A(T0044-COBBEG),AL2(51,0)
         DC    A(T0045-COBBEG),AL2(52,0)
         DC    A(T0046-COBBEG),AL2(53,0)
         DC    A(T0047-COBBEG),AL2(53,0)
         DC    A(T0048-COBBEG),AL2(54,0)
         DC    A(T0049-COBBEG),AL2(55,0)
         DC    A(T0050-COBBEG),AL2(55,0)
         DC    A(T0051-COBBEG),AL2(56,0)
         DC    A(T0052-COBBEG),AL2(57,0)
         DC    A(T0053-COBBEG),AL2(57,0)
         DC    A(T0054-COBBEG),AL2(58,0)
         DC    A(T0055-COBBEG),AL2(59,0)
         DC    A(T0056-COBBEG),AL2(59,0)
         DC    A(T0057-COBBEG),AL2(59,0)
         DC    A(T0058-COBBEG),AL2(60,0)
         DC    A(T0059-COBBEG),AL2(61,0)
         DC    A(T0060-COBBEG),AL2(61,0)
         DC    A(T0061-COBBEG),AL2(62,0)
         DC    A(T0062-COBBEG),AL2(63,0)
         DC    A(T0063-COBBEG),AL2(63,0)
         DC    A(T0064-COBBEG),AL2(64,0)
         DC    A(T0065-COBBEG),AL2(65,0)
         DC    A(T0066-COBBEG),AL2(65,0)
         DC    A(T0067-COBBEG),AL2(66,0)
         DC    A(T0068-COBBEG),AL2(67,0)
         DC    A(T0069-COBBEG),AL2(67,0)
         DC    A(T0070-COBBEG),AL2(68,0)
         DC    A(T0071-COBBEG),AL2(68,0)
         DC    A(T0072-COBBEG),AL2(69,0)
         DC    A(T0073-COBBEG),AL2(70,0)
         DC    A(T0074-COBBEG),AL2(71,0)
         DC    A(T0075-COBBEG),AL2(71,0)
         DC    A(T0076-COBBEG),AL2(72,0)
         DC    A(T0077-COBBEG),AL2(72,0)
         DC    A(T0078-COBBEG),AL2(73,0)
         DC    A(T0079-COBBEG),AL2(73,0)
         DC    A(T0080-COBBEG),AL2(74,0)
         DC    A(T0081-COBBEG),AL2(74,0)
         DC    A(T0082-COBBEG),AL2(75,0)
         DC    A(T0083-COBBEG),AL2(76,0)
         DC    A(T0084-COBBEG),AL2(77,0)
         DC    A(T0085-COBBEG),AL2(78,0)
         DC    A(T0086-COBBEG),AL2(79,0)
         DC    A(T0087-COBBEG),AL2(80,0)
         DC    A(T0088-COBBEG),AL2(80,0)
         DC    A(T0089-COBBEG),AL2(81,0)
         DC    A(T0090-COBBEG),AL2(82,0)
         DC    A(T0091-COBBEG),AL2(82,0)
         DC    A(T0092-COBBEG),AL2(83,0)
         DC    A(T0093-COBBEG),AL2(84,0)
         DC    A(T0094-COBBEG),AL2(84,0)
         DC    A(T0095-COBBEG),AL2(85,0)
         DC    A(T0096-COBBEG),AL2(86,0)
         DC    A(T0097-COBBEG),AL2(87,0)
         DC    A(T0098-COBBEG),AL2(87,0)
         DC    A(T0099-COBBEG),AL2(88,0)
         DC    A(T0100-COBBEG),AL2(89,0)
         DC    A(T0101-COBBEG),AL2(89,0)
         DC    A(T0102-COBBEG),AL2(90,0)
         DC    A(T0103-COBBEG),AL2(91,0)
         DC    A(T0104-COBBEG),AL2(91,0)
         DC    A(T0105-COBBEG),AL2(92,0)
         DC    A(T0106-COBBEG),AL2(93,0)
         DC    A(T0107-COBBEG),AL2(94,0)
         DC    A(T0108-COBBEG),AL2(94,0)
         DC    A(T0109-COBBEG),AL2(95,0)
         DC    A(T0110-COBBEG),AL2(96,0)
         DC    A(T0111-COBBEG),AL2(96,0)
         DC    A(T0112-COBBEG),AL2(97,0)
         DC    A(T0113-COBBEG),AL2(98,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    DL8'0'              F0 COMP-2, long hex float
D0001    DC    DL8'0'              F1 COMP-2, long hex float
D0002    DC    DL8'0.50'           F2 COMP-2, long hex float
D0003    DC    DL8'0'              F4 COMP-2, long hex float
D0004    DC    PL8'15'             W15 PIC S9(15)v0 COMP-3
D0005    DC    PL7'10'             D10 PIC S9(13)v0 COMP-3
         DS    XL1                 reserve the rest of a table
D0006    DC    ZL3'0'              I3 PIC S9(3)v0 DISP
         DS    XL5                 reserve the rest of a table
D0007    DC    CL4' '              E3 edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0008    DC    CL3'000'            Q2 PIC 9(3)v2 DISP
         DS    XL5                 reserve the rest of a table
D0009    DC    CL17' '             R12 edited, 17 chars
         DS    XL7                 reserve the rest of a table
D0010    DS    0CL24               FT (01 group)
D0011    DC    3DL8'0'             FE COMP-2, long hex float
*---------------------------------------------------------------
