*---------------------------------------------------------------
* Generated by cobc370 from num2aln.cbl
...
* MOVE U3 -> X3
         ...
         USING WSC0000,8
         MVC   D0004(3),D0000      alphanumeric move
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0001
         MVC   DSPBUF+8(3),D0004
...
T0002    DS    0H
* MOVE U3 -> X8
         MVC   D0005(3),D0000      alphanumeric move
         MVI   D0005+3,C' '        space fill the remainder
         MVC   D0005+4(4),D0005+3
T0003    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0003
         MVC   DSPBUF+8(8),D0005
...
T0004    DS    0H
* MOVE U3 -> X2
         MVC   D0006(2),D0000      alphanumeric move
T0005    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0004
         MVC   DSPBUF+8(2),D0006
...
T0006    DS    0H
* MOVE S5 -> X8
         MVC   D0005(5),D0001      alphanumeric move
         MVI   D0005+5,C' '        space fill the remainder
         MVC   D0005+6(2),D0005+5
         OI    D0005+4,X'F0'       the sign is not moved
T0007    DS    0H
* DISPLAY
...
* MOVE P5 -> X8
         ZAP   PWK1(16),D0002(3)
         UNPK  ZWK(5),PWK1(16)     packed -> zoned for an alphanumeric
         OI    ZWK+4,X'F0'         the sign is not moved
         MVC   D0005(5),ZWK        alphanumeric move
         MVI   D0005+5,C' '        space fill the remainder
         MVC   D0005+6(2),D0005+5
T0010    DS    0H
* DISPLAY
...
* MOVE B4 -> X8
         ...
         ZAP   PWK1(16),DWK(8)
         UNPK  ZWK(4),PWK1(16)     packed -> zoned for an alphanumeric
         OI    ZWK+3,X'F0'         the sign is not moved
         MVC   D0005(4),ZWK        alphanumeric move
         MVI   D0005+4,C' '        space fill the remainder
         MVC   D0005+5(3),D0005+4
T0013    DS    0H
* DISPLAY
...
T0015    DS    0H
* MOVE S5 -> X3
         MVC   D0004(3),D0001      alphanumeric move
T0016    DS    0H
* DISPLAY
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL8'U3-X3  ['       nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL8'U3-X8  ['
S0004    DC    CL8'U3-X2  ['
S0005    DC    CL8'S5-X8  ['
...
* WORKING-STORAGE
D0000    DC    CL3'042'            U3 PIC 9(3)v0 DISP
         DS    XL5                 reserve the rest of a table
D0001    DC    ZL5'-12345'         S5 PIC S9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0002    DC    PL3'-12345'         P5 PIC S9(5)v0 COMP-3
         DS    XL5                 reserve the rest of a table
D0003    DC    HL2'1234'           B4 PIC S9(4)v0 COMP
         DS    XL6                 reserve the rest of a table
D0004    DC    CL3' '              X3 PIC X(3)
         DS    XL5                 reserve the rest of a table
D0005    DC    CL8' '              X8 PIC X(8)
D0006    DC    CL2' '              X2 PIC X(2)
*---------------------------------------------------------------
