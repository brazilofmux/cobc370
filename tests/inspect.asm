*---------------------------------------------------------------
* Generated by cobc370 from inspect.cbl
...
* INSPECT W
         ...
         LA    5,10                its length
         SR    4,4                 the tally
L0010    CH    5,H0001             room for the string?
         BL    L0012
         CLC   0(1,3),D0004
         BNE   L0011
         LA    4,1(4)              one more
...
* INSPECT V
         ...
         LA    5,10                its length
L0013    CH    5,H0001             room for the string?
         BL    L0015
         CLC   0(1,3),S0001
         BNE   L0014
...
* INSPECT V
         LA    3,D0001             the field
         LA    5,10                its length
L0016    CH    5,H0001             room for the string?
         BL    L0018
         CLC   0(1,3),S0001
         BNE   L0018
         MVC   0(1,3),S0003        replace
...
* INSPECT V
         LA    3,D0001             the field
         LA    5,10                its length
L0019    CH    5,H0001             room for the string?
         BL    L0021
         CLC   0(1,3),S0004
         BNE   L0020
         MVC   0(1,3),S0003        replace
...
* INSPECT V
         LA    3,D0001             the field
         LA    5,10                its length
L0022    CH    5,H0001             room for the string?
         BL    L0024
         CLC   0(1,3),D0004
         BNE   L0023
...
* INSPECT V
         ...
         LA    5,10                its length
         SR    4,4                 the tally
L0026    CH    5,H0001             room for the string?
         BL    L0028
         CLC   0(1,3),S0004
         BNE   L0027
         LA    4,1(4)              one more
...
L0028    DS    0H
         ...
         LA    3,D0001             the field
         LA    5,10                its length
L0029    CH    5,H0001             room for the string?
         BL    L0031
         CLC   0(1,3),S0004
         BNE   L0030
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0018-COBBEG),AL2(35)
         DC    AL2(T0019-COBBEG),AL2(36)
         DC    AL2(T0020-COBBEG),AL2(37)
         ...
         DC    AL2(T0028-COBBEG),AL2(45)
         DC    AL2(T0029-COBBEG),AL2(46)
         DC    AL2(T0030-COBBEG),AL2(47)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL10'AABBAACCAA'    W PIC X(10)
         DS    XL6                 reserve the rest of a table
D0001    DC    CL10'AABBAACCAA'    V PIC X(10)
         DS    XL6                 reserve the rest of a table
D0002    DC    CL6'XYZXYZ'         U PIC X(6)
         DS    XL2                 reserve the rest of a table
D0003    DC    CL4'0000'           T PIC 9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0004    DC    CL1'A'              CMPCH PIC X(1)
         DS    XL7                 reserve the rest of a table
D0005    DC    CL1'Q'              REPCH PIC X(1)
*---------------------------------------------------------------
