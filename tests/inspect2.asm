*---------------------------------------------------------------
* Generated by cobc370 from inspect2.cbl
...
L0003    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  PWK2(16),D0002(2)   zoned -> packed
...
L0006    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  PWK2(16),D0003(2)   zoned -> packed
         AP    PWK1(16),PWK2(16)   TALLYING adds
...
* INSPECT S
         ...
         LA    5,24                its length
         SR    4,4                 the tally
L0007    CH    5,H0001             room for the string?
         BL    L0009
         CLC   0(2,3),S0002
         BNE   L0008
         LA    4,1(4)              one more
...
L0009    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  PWK2(16),D0004(2)   zoned -> packed
         AP    PWK1(16),PWK2(16)   TALLYING adds
...
* DISPLAY
         ...
         MVC   DSPBUF+3(2),D0002+0
         MVC   DSPBUF+5(1),S0012
         MVC   DSPBUF+6(2),D0003+0
         MVC   DSPBUF+8(1),S0012
         MVC   DSPBUF+9(2),D0004+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0004    DS    0H
* MOVE 0 -> C1
         MVC   D0002(2),S0018      numeric literal as zoned digits
T0005    DS    0H
* MOVE 0 -> C2
         MVC   D0003(2),S0018      numeric literal as zoned digits
T0006    DS    0H
* MOVE 0 -> C3
         MVC   D0004(2),S0018      numeric literal as zoned digits
T0007    DS    0H
* INSPECT S
         LA    3,D0000             the field
         LA    5,24                its length
         LR    7,3                 the field's start
L0010    CH    5,H0002             room for the bounding string?
         BL    L0012
         CLC   0(3,3),S0003        INITIAL
         BE    L0011
         LA    3,1(3)
         BCT   5,L0010
L0012    DS    0H                  not found
         LR    3,7
         LA    5,24                BEFORE: the whole field
         B     L0013
L0011    DS    0H                  found
         LR    5,3
...
L0013    DS    0H
         SR    4,4                 the tally
L0014    CH    5,H0001             room for the string?
         BL    L0016
         CLC   0(2,3),S0001
         BNE   L0015
         LA    4,1(4)              one more
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0017    CH    5,H0002             room for the bounding string?
         BL    L0019
         CLC   0(3,3),S0003        INITIAL
         BE    L0018
         LA    3,1(3)
...
L0019    DS    0H                  not found
         SR    5,5                 AFTER: nothing to scan
         B     L0020
L0018    DS    0H                  found
         LA    3,3(3)              AFTER: from just past it
         SH    5,H0002
L0020    DS    0H
         SR    4,4                 the tally
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0024    CH    5,H0003             room for the bounding string?
         BL    L0026
         CLC   0(1,3),S0004        INITIAL
         BE    L0025
         LA    3,1(3)
         BCT   5,L0024
L0026    DS    0H                  not found
         LR    3,7
         LA    5,24                BEFORE: the whole field
         B     L0027
L0025    DS    0H                  found
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0028    CH    5,H0001             room for the bounding string?
         BL    L0030
         CLC   0(2,3),S0005        INITIAL
         BE    L0029
         LA    3,1(3)
         BCT   5,L0028
L0030    DS    0H                  not found
         SR    5,5                 AFTER: nothing to scan
         B     L0031
L0029    DS    0H                  found
         LA    3,2(3)              AFTER: from just past it
         SH    5,H0001
L0031    DS    0H
         SR    4,4                 the tally
L0032    CH    5,H0001             room for the string?
         BL    L0034
         CLC   0(2,3),D0005
         BNE   L0033
         LA    4,1(4)              one more
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0035    CH    5,H0002             room for the bounding string?
         BL    L0037
         CLC   0(3,3),S0003        INITIAL
         BE    L0036
         LA    3,1(3)
         BCT   5,L0035
L0037    DS    0H                  not found
         SR    5,5                 AFTER: nothing to scan
         B     L0038
L0036    DS    0H                  found
         LA    3,3(3)              AFTER: from just past it
...
T0016    DS    0H
* MOVE S -> W
         MVC   D0001(24),D0000     alphanumeric move
T0017    DS    0H
* INSPECT W
...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+4(24),D0001+0
         MVC   DSPBUF+28(1),S0022
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0019    DS    0H
...
* INSPECT W
         LA    3,D0001             the field
         LA    5,24                its length
L0045    CH    5,H0001             room for the string?
         BL    L0047
         CLC   0(2,3),S0002
         BNE   L0046
         MVC   0(2,3),S0008        replace
         B     L0047               FIRST: done
         LA    3,2(3)              past the string
         SH    5,H0001
         B     L0045
...
* INSPECT W
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0048    CH    5,H0002             room for the bounding string?
         BL    L0050
         CLC   0(3,3),S0003        INITIAL
         BE    L0049
         LA    3,1(3)
         BCT   5,L0048
L0050    DS    0H                  not found
         SR    5,5                 AFTER: nothing to scan
         B     L0051
L0049    DS    0H                  found
         LA    3,3(3)              AFTER: from just past it
         SH    5,H0002
L0051    DS    0H
L0052    CH    5,H0001             room for the string?
         BL    L0054
         CLC   0(2,3),D0005
         BNE   L0053
         MVC   0(2,3),D0006        replace
         LA    3,2(3)              past the string
         SH    5,H0001
         B     L0052
L0053    DS    0H
...
* INSPECT W
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0055    CH    5,H0001             room for the bounding string?
         BL    L0057
         CLC   0(2,3),S0010        INITIAL
         BE    L0056
         LA    3,1(3)
         BCT   5,L0055
L0057    DS    0H                  not found
         LR    3,7
         LA    5,24                BEFORE: the whole field
         B     L0058
L0056    DS    0H                  found
...
L0058    DS    0H
         LTR   5,5
         BZ    L0059               nothing in range
         MVC   0(1,3),S0009        CHARACTERS BY: the first
         LR    4,5
         BCTR  4,0
         LTR   4,4
         BZ    L0059
...
* INSPECT W
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0060    CH    5,H0002             room for the bounding string?
         BL    L0062
         CLC   0(3,3),S0011        INITIAL
         BE    L0061
         LA    3,1(3)
         BCT   5,L0060
L0062    DS    0H                  not found
         SR    5,5                 AFTER: nothing to scan
         B     L0063
L0061    DS    0H                  found
         LA    3,3(3)              AFTER: from just past it
...
* INSPECT W
         LA    3,D0001             the field
         LA    5,24                its length
L0065    CH    5,H0003             room for the string?
         BL    L0067
         CLC   0(1,3),S0012
         BNE   L0066
         MVC   0(1,3),S0013        replace
...
L0067    DS    0H
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0068    CH    5,H0003             room for the bounding string?
         BL    L0070
         CLC   0(1,3),S0004        INITIAL
         BE    L0069
         LA    3,1(3)
         BCT   5,L0068
L0070    DS    0H                  not found
         LR    3,7
         LA    5,24                BEFORE: the whole field
         B     L0071
L0069    DS    0H                  found
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0075    CH    5,H0002             room for the bounding string?
         BL    L0077
         CLC   0(3,3),S0016        INITIAL
         BE    L0076
         LA    3,1(3)
         BCT   5,L0075
L0077    DS    0H                  not found
         LR    3,7
         LA    5,24                BEFORE: the whole field
         B     L0078
L0076    DS    0H                  found
...
L0078    DS    0H
         SR    4,4                 the tally
L0079    CH    5,H0003             room for the string?
         BL    L0081
         CLC   0(1,3),S0015
         BNE   L0080
         LA    4,1(4)              one more
...
SPIENUM  DC    H'41'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(17,0)
         DC    A(T0001-COBBEG),AL2(18,0)
         DC    A(T0002-COBBEG),AL2(19,0)
         DC    A(T0003-COBBEG),AL2(20,0)
         DC    A(T0004-COBBEG),AL2(21,0)
         DC    A(T0005-COBBEG),AL2(21,0)
         DC    A(T0006-COBBEG),AL2(21,0)
         DC    A(T0007-COBBEG),AL2(22,0)
         DC    A(T0008-COBBEG),AL2(23,0)
         DC    A(T0009-COBBEG),AL2(24,0)
         DC    A(T0010-COBBEG),AL2(25,0)
         DC    A(T0011-COBBEG),AL2(26,0)
         DC    A(T0012-COBBEG),AL2(26,0)
         DC    A(T0013-COBBEG),AL2(27,0)
         DC    A(T0014-COBBEG),AL2(28,0)
         DC    A(T0015-COBBEG),AL2(29,0)
         DC    A(T0016-COBBEG),AL2(30,0)
         DC    A(T0017-COBBEG),AL2(31,0)
         DC    A(T0018-COBBEG),AL2(32,0)
         DC    A(T0019-COBBEG),AL2(33,0)
         DC    A(T0020-COBBEG),AL2(34,0)
         DC    A(T0021-COBBEG),AL2(35,0)
         DC    A(T0022-COBBEG),AL2(36,0)
         DC    A(T0023-COBBEG),AL2(37,0)
         DC    A(T0024-COBBEG),AL2(38,0)
         DC    A(T0025-COBBEG),AL2(39,0)
         DC    A(T0026-COBBEG),AL2(40,0)
         DC    A(T0027-COBBEG),AL2(41,0)
         DC    A(T0028-COBBEG),AL2(42,0)
         DC    A(T0029-COBBEG),AL2(43,0)
         DC    A(T0030-COBBEG),AL2(44,0)
         DC    A(T0031-COBBEG),AL2(45,0)
         DC    A(T0032-COBBEG),AL2(46,0)
         DC    A(T0033-COBBEG),AL2(47,0)
         DC    A(T0034-COBBEG),AL2(48,0)
         DC    A(T0035-COBBEG),AL2(49,0)
         DC    A(T0036-COBBEG),AL2(51,0)
         DC    A(T0037-COBBEG),AL2(52,0)
         DC    A(T0038-COBBEG),AL2(53,0)
         DC    A(T0039-COBBEG),AL2(54,0)
         DC    A(T0040-COBBEG),AL2(55,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL24'ABABXXABCABXYZABAB    '  S PIC X(24)
D0001    DC    CL24' '             W PIC X(24)
D0002    DC    CL2'00'             C1 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    CL2'00'             C2 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0004    DC    CL2'00'             C3 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0005    DC    CL2'AB'             STR2 PIC X(2)
         DS    XL6                 reserve the rest of a table
D0006    DC    CL2'12'             RPL2 PIC X(2)
*---------------------------------------------------------------
