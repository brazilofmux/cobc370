...
* INSPECT S
         ...
         LA    5,24                its length
         SR    4,4                 the tally
L0001    C     5,=F'2'             room for the string?
         BL    L0003
         CLC   0(2,3),S0001
         BNE   L0002
         LA    4,1(4)              one more
...
* INSPECT S
         ...
         LA    5,24                its length
         SR    4,4                 the tally
L0004    C     5,=F'2'             room for the string?
         BL    L0006
         CLC   0(2,3),S0001
         BNE   L0006
         LA    4,1(4)              one more
...
* INSPECT S
         ...
         LA    5,24                its length
         SR    4,4                 the tally
L0007    C     5,=F'2'             room for the string?
         BL    L0009
         CLC   0(2,3),S0002
         BNE   L0008
         LA    4,1(4)              one more
...
L0010    C     5,=F'3'             room for the bounding string?
         BL    L0012
...
L0013    DS    0H
         SR    4,4                 the tally
L0014    C     5,=F'2'             room for the string?
         BL    L0016
         CLC   0(2,3),S0001
         BNE   L0015
         LA    4,1(4)              one more
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0017    C     5,=F'3'             room for the bounding string?
         BL    L0019
         CLC   0(3,3),S0003        INITIAL
         BE    L0018
         LA    3,1(3)
...
L0020    DS    0H
         SR    4,4                 the tally
L0021    C     5,=F'2'             room for the string?
         BL    L0023
         CLC   0(2,3),S0001
         BNE   L0022
         LA    4,1(4)              one more
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0024    C     5,=F'1'             room for the bounding string?
         BL    L0026
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0028    C     5,=F'2'             room for the bounding string?
         BL    L0030
...
L0031    DS    0H
         SR    4,4                 the tally
L0032    C     5,=F'2'             room for the string?
         BL    L0034
         CLC   0(2,3),D0005
         BNE   L0033
         LA    4,1(4)              one more
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0035    C     5,=F'3'             room for the bounding string?
         BL    L0037
         CLC   0(3,3),S0003        INITIAL
         BE    L0036
         LA    3,1(3)
...
* INSPECT W
         ...
         LA    5,24                its length
L0039    C     5,=F'2'             room for the string?
         BL    L0041
         CLC   0(2,3),S0001
         BNE   L0040
...
* INSPECT W
         LA    3,D0001             the field
         LA    5,24                its length
L0042    C     5,=F'2'             room for the string?
         BL    L0044
         CLC   0(2,3),S0001
         BNE   L0044
...
* INSPECT W
         LA    3,D0001             the field
         LA    5,24                its length
L0045    C     5,=F'2'             room for the string?
         BL    L0047
         CLC   0(2,3),S0002
         BNE   L0046
...
* INSPECT W
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0048    C     5,=F'3'             room for the bounding string?
         BL    L0050
         CLC   0(3,3),S0003        INITIAL
         BE    L0049
         LA    3,1(3)
...
L0049    DS    0H                  found
         ...
         S     5,=F'3'
L0051    DS    0H
L0052    C     5,=F'2'             room for the string?
         BL    L0054
         CLC   0(2,3),D0005
         BNE   L0053
...
* INSPECT W
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0055    C     5,=F'2'             room for the bounding string?
         BL    L0057
...
* INSPECT W
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0060    C     5,=F'3'             room for the bounding string?
         BL    L0062
...
* INSPECT W
         LA    3,D0001             the field
         LA    5,24                its length
L0065    C     5,=F'1'             room for the string?
         BL    L0067
         CLC   0(1,3),S0012
         BNE   L0066
...
L0067    DS    0H
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0068    C     5,=F'1'             room for the bounding string?
         BL    L0070
         CLC   0(1,3),S0004        INITIAL
         BE    L0069
         LA    3,1(3)
...
L0069    DS    0H                  found
         ...
         LR    3,7
L0071    DS    0H
L0072    C     5,=F'2'             room for the string?
         BL    L0074
         CLC   0(2,3),S0001
         BNE   L0073
...
* INSPECT S
         ...
         LA    5,24                its length
         LR    7,3                 the field's start
L0075    C     5,=F'3'             room for the bounding string?
         BL    L0077
...
L0078    DS    0H
         SR    4,4                 the tally
L0079    C     5,=F'1'             room for the string?
         BL    L0081
         CLC   0(1,3),S0015
         BNE   L0080
         LA    4,1(4)              one more
