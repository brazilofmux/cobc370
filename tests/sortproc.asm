*---------------------------------------------------------------
* Generated by cobc370 from sortproc.cbl
...
L0017    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  WK0+14(2),D0008(2)  zoned -> packed
...
* MOVE T-TAG -> W-TAG
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  DWK(8),D0008(2)     subscript
         CVB   7,DWK
         BCTR  7,0                 subscript-1
         MH    7,H0001             times element size
         LA    7,D0027(7)          element address
         MVC   D0010(4),0(7)       alphanumeric move
T0010    DS    0H
* MOVE T-ZD -> W-ZD
         PACK  DWK(8),D0008(2)     subscript
         CVB   7,DWK
...
* IF
         ...
         LA    6,D0028(6)          element address
         CLC   0(1,6),S0002        alphanumeric compare
         BNE   L0004
T0012    DS    0H
* COMPUTE W-ZD = ...
         ZAP   WK0+13(3),K0003+15(1)  literal
         PACK  WK1+14(2),D0011(3)  zoned -> packed
         SP    WK0+13(3),WK1+14(2)
         UNPK  D0011(3),WK0+13(3)  packed -> zoned
         DROP  8
L0004    DS    0H
T0013    DS    0H
* MOVE T-PD -> W-PD
...
* IF
         ...
         BCTR  6,0                 subscript-1
         MH    6,H0001             times element size
         LA    6,D0032(6)          element address
         CLC   0(1,6),S0002        alphanumeric compare
         BNE   L0006
T0018    DS    0H
* COMPUTE W-BI = ...
         ZAP   WK0+12(4),K0003+15(1)  literal
         MVC   DWK(2),D0013        COMP, not on its boundary
         LH    2,DWK
...
* MOVE T-UZ -> W-UZ
         ...
         BCTR  7,0                 subscript-1
         MH    7,H0001             times element size
         LA    7,D0034(7)          element address
         MVC   D0014(3),0(7)       zoned to zoned, same picture
T0020    DS    0H
* IF
         PACK  WK0+14(2),D0008(2)  zoned -> packed
...
T0021    DS    0H
* MOVE W-REC -> S-REC
         MVC   D0001(40),D0009     alphanumeric move
T0022    DS    0H
* RELEASE: the record to the sort, and back here for the next
         LA    14,L0019
         ST    14,SRTRES
         ST    12,SRTR12
         LA    1,D0001             the record
...
L0022    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0001+0(40),0(1)    into the SD's record
*  INTO: only reached when a record was returned
         MVC   D0009(40),D0001     alphanumeric move
         B     L0010
L0009    DS    0H                  AT END
         DROP  8
T0028    DS    0H
...
* ADD 1 -> CNT
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  PWK1(16),D0038(2)   zoned -> packed
         ZAP   PWK2(16),K0001+15(1)  literal
         AP    PWK1(16),PWK2(16)
         UNPK  D0038(2),PWK1(16)   packed -> zoned
         OI    D0038+1,X'F0'       unsigned: force an F zone
T0030    DS    0H
* MOVE W-ZD -> D-ZD
...
T0033    DS    0H
* DISPLAY
         MVC   DSPBUF+0(4),D0010+0
         MVC   DSPBUF+4(1),S0003
         MVC   DSPBUF+5(4),D0035+0
         MVC   DSPBUF+9(1),S0003
         MVC   DSPBUF+10(4),D0036+0
         MVC   DSPBUF+14(1),S0003
         MVC   DSPBUF+15(5),D0037+0
         MVC   DSPBUF+20(1),S0003
         MVC   DSPBUF+21(3),D0014+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0034    DS    0H
...
X0003    DC    A(F0003)            LOAD-ONE
X0004    DC    A(F0004)            L-EXIT
X0007    DC    A(F0007)            S-EXIT
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
SRT0001S DC    C' SORT FIELDS=(0005,003,ZD,D,0008,002,PD,'  SORT statem
         DC    C'A,0010,002,FI,A,0012,003,ZD,D)'
SRT0001F EQU   *-1                 its end without SIZE
         DC    C',SIZE=E'
SRT0001Z DC    C'0000000'          SORT-FILE-SIZE, when positive
SRT0001G EQU   *-1                 its end with SIZE
SRT0001R DC    C' RECORD TYPE=F,LENGTH=(00040)'  RECORD statement
SRT0001Q EQU   *-1
         DS    0F
         DC    H'0'
...
M0002    DC    XL7'40214020202020'
H0001    DC    H'20'               element sizes
S0001    DC    CL9'RETURNED '      nonnumeric constants
S0002    DC    CL1'-'
S0003    DC    CL1' '
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(58,0)
         DC    A(T0001-COBBEG),AL2(61,0)
         DC    A(T0002-COBBEG),AL2(62,0)
         DC    A(T0003-COBBEG),AL2(62,0)
         DC    A(T0004-COBBEG),AL2(62,0)
         DC    A(T0005-COBBEG),AL2(63,0)
         DC    A(T0006-COBBEG),AL2(64,0)
         DC    A(T0007-COBBEG),AL2(67,0)
         DC    A(T0008-COBBEG),AL2(68,0)
         DC    A(T0009-COBBEG),AL2(70,0)
         DC    A(T0010-COBBEG),AL2(71,0)
         DC    A(T0011-COBBEG),AL2(72,0)
         DC    A(T0012-COBBEG),AL2(72,0)
         DC    A(T0013-COBBEG),AL2(73,0)
         DC    A(T0014-COBBEG),AL2(74,0)
         DC    A(T0015-COBBEG),AL2(74,0)
         DC    A(T0016-COBBEG),AL2(75,0)
         DC    A(T0017-COBBEG),AL2(76,0)
         DC    A(T0018-COBBEG),AL2(76,0)
         DC    A(T0019-COBBEG),AL2(77,0)
         DC    A(T0020-COBBEG),AL2(78,0)
         DC    A(T0021-COBBEG),AL2(78,0)
         DC    A(T0022-COBBEG),AL2(79,0)
         DC    A(T0023-COBBEG),AL2(79,0)
         DC    A(T0024-COBBEG),AL2(79,0)
         DC    A(T0025-COBBEG),AL2(79,0)
         DC    A(T0026-COBBEG),AL2(81,0)
         DC    A(T0027-COBBEG),AL2(84,0)
         DC    A(T0028-COBBEG),AL2(84,0)
         DC    A(T0029-COBBEG),AL2(85,0)
         DC    A(T0030-COBBEG),AL2(86,0)
         DC    A(T0031-COBBEG),AL2(86,0)
         DC    A(T0032-COBBEG),AL2(86,0)
         DC    A(T0033-COBBEG),AL2(87,0)
         DC    A(T0034-COBBEG),AL2(88,0)
         DC    A(T0035-COBBEG),AL2(90,0)
...
D0001    DS    0CL40               S-REC (01 group)
D0002    DC    CL4' '              S-TAG PIC X(4)
D0003    DC    ZL3'0'              S-ZD PIC S9(3)v0 DISP
D0004    DC    PL2'0'              S-PD PIC S9(3)v0 COMP-3
D0005    DC    HL2'0'              S-BI PIC S9(4)v0 COMP
D0006    DC    CL3'000'            S-UZ PIC 9(3)v0 DISP
D0007    DC    CL26' '             FILL0007 PIC X(26)
D0008    DC    CL2'00'             I PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0009    DS    0CL40               W-REC (01 group)
D0010    DC    CL4' '              W-TAG PIC X(4)
D0011    DC    ZL3'0'              W-ZD PIC S9(3)v0 DISP
D0012    DC    PL2'0'              W-PD PIC S9(3)v0 COMP-3
D0013    DC    HL2'0'              W-BI PIC S9(4)v0 COMP
D0014    DC    CL3'000'            W-UZ PIC 9(3)v0 DISP
D0015    DC    CL26' '             FILL0015 PIC X(26)
D0016    DS    0CL240              TABV (01 group)
D0017    DC    CL30'R01 +005-003+0007001R02 -005+0'  FILL0017 PIC X(30)
D0018    DC    CL30'02-0001002R03 +005-003-0009003'  FILL0018 PIC X(30)
D0019    DC    CL30'R04 +000+001+0001004R05 +005+0'  FILL0019 PIC X(30)
D0020    DC    CL30'04+0000005R06 -005+002-0001009'  FILL0020 PIC X(30)
D0021    DC    CL30'R07 +012-008+0003007R08 +000+0'  FILL0021 PIC X(30)
D0022    DC    CL30'01+0001008R09 -012+000+0000000'  FILL0022 PIC X(30)
D0023    DC    CL30'R10 +005-003+0007006R11 +000-0'  FILL0023 PIC X(30)
D0024    DC    CL30'01+0002001R12 +999-099-0999012'  FILL0024 PIC X(30)
D0025    EQU   COBWS+96            TAB REDEFINES
D0026    EQU   COBWS+96            T REDEFINES
D0027    EQU   COBWS+96            T-TAG REDEFINES
D0028    EQU   COBWS+100           T-ZS REDEFINES
D0029    EQU   COBWS+101           T-ZD REDEFINES
D0030    EQU   COBWS+104           T-PS REDEFINES
D0031    EQU   COBWS+105           T-PD REDEFINES
D0032    EQU   COBWS+108           T-BS REDEFINES
D0033    EQU   COBWS+109           T-BI REDEFINES
D0034    EQU   COBWS+113           T-UZ REDEFINES
D0035    DC    CL4' '              D-ZD edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0036    DC    CL4' '              D-PD edited, 4 chars
         DS    XL4                 reserve the rest of a table
D0037    DC    CL5' '              D-BI edited, 5 chars
         DS    XL3                 reserve the rest of a table
D0038    DC    CL2'00'             CNT PIC 9(2)v0 DISP
D0039    DC    HL2'0'              SORT-RETURN PIC S9(4)v0 COMP
D0040    DC    FL4'0'              SORT-FILE-SIZE PIC S9(8)v0 COMP
*---------------------------------------------------------------
