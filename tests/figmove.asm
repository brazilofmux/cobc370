*---------------------------------------------------------------
* Generated by cobc370 from figmove.cbl
...
* DISPLAY
         ...
         MVC   DSPBUF+8(20),D0000
         MVC   DSPBUF+28(2),S0002
         MVC   DSPBUF+30(1),D0001
         MVC   DSPBUF+31(2),S0002
         MVC   DSPBUF+33(6),D0002
         MVC   DSPBUF+39(1),S0003
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
* DISPLAY
         ...
         MVC   DSPBUF+7(5),D0003
         MVC   DSPBUF+12(1),S0005
         MVC   DSPBUF+13(5),D0006
         MVC   DSPBUF+18(1),S0005
         MVC   DSPBUF+19(4),D0007
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0004    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0001
         MVC   DSPBUF+8(3),D0009
         MVC   DSPBUF+11(2),S0002
         MVC   DSPBUF+13(3),D0010
