*---------------------------------------------------------------
* Generated by cobc370 from tests/figmove.cbl
...
* DISPLAY
         ...
         BALR  14,15
* MOVE SPACES -> WS-NAME
         MVC   D0000(20),S0006     MOVE SPACES
* MOVE SPACES -> WS-CH
         MVC   D0001(1),S0005      MOVE SPACES
* MOVE ZEROS -> WS-DIG
         MVC   D0002(6),S0007      MOVE ZEROS
* MOVE 0 -> WS-NUM
...
* DISPLAY
         ...
         BALR  14,15
* IF
         CLC   D0000(20),S0006     alphanumeric compare
         BNE   L0001
* DISPLAY
         MVC   DSPBUF+0(14),S0011
         LA    1,PARM0007
         L     15,VDISP
         BALR  14,15
         B     L0002
...
* MOVE SPACES -> WS-FLAG
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0011(4),S0013      MOVE SPACES
* IF
         CLC   D0011(4),S0013      alphanumeric compare
         BNE   L0003
* DISPLAY
...
S0009    DC    CL8'AFTER  ['
S0010    DC    CL7'AFTER  '
S0011    DC    CL14'NAME IS SPACES'
S0012    DC    CL18'NAME IS NOT SPACES'
S0013    DC    CL4'    '
S0014    DC    CL12'FLAG CLEARED'
