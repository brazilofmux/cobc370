*---------------------------------------------------------------
* Generated by cobc370 from alterst.cbl
...
B0001    EQU   *
         USING B0001,12
T0000    DS    0H
* PERFORM RUN-ONE THRU WAYS-DONE
...
* DISPLAY
         ...
         USING WSC0000,8
         MVC   DSPBUF+7(8),D0000+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
* MOVE ........ -> TRACE
         MVC   D0000(8),S0002      literal move, space padded
T0003    DS    0H
* ALTER SWITCH-POINT TO PROCEED TO SECOND-WAY
         L     15,PA0004           the new target
         ST    15,AL0002           into that paragraph's branch cell
T0004    DS    0H
* PERFORM RUN-ONE THRU WAYS-DONE
         L     14,X0006            what the exit cell holds
...
* MOVE ........ -> TRACE
         MVC   D0000(8),S0002      literal move, space padded
T0007    DS    0H
* ALTER SWITCH-POINT TO PROCEED TO THIRD-WAY
         L     15,PA0005           the new target
         ST    15,AL0002           into that paragraph's branch cell
T0008    DS    0H
* PERFORM RUN-ONE THRU WAYS-DONE
         L     14,X0006            what the exit cell holds
...
* MOVE ........ -> TRACE
         MVC   D0000(8),S0002      literal move, space padded
T0011    DS    0H
* ALTER SWITCH-POINT TO PROCEED TO FIRST-WAY
         L     15,PA0003           the new target
         ST    15,AL0002           into that paragraph's branch cell
T0012    DS    0H
* PERFORM RUN-ONE THRU WAYS-DONE
         L     14,X0006            what the exit cell holds
...
T0016    DS    0H
* GO TO FIRST-WAY
         L     15,AL0002           the current target
         BR    15
* FIRST-WAY.
P0003    DS    0H
         BALR  12,0                this paragraph's code base
...
* MOVE ONE -> TRACE
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0000(8),S0006      literal move, space padded
T0018    DS    0H
* GO TO WAYS-DONE
         L     15,PA0006
         BR    15
...
* MOVE TWO -> TRACE
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0000(8),S0007      literal move, space padded
T0020    DS    0H
* GO TO WAYS-DONE
         L     15,PA0006
         BR    15
...
* MOVE THREE -> TRACE
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0000(8),S0008      literal move, space padded
         DROP  8
* WAYS-DONE.
P0006    DS    0H
         BALR  12,0                this paragraph's code base
...
AL0002   DC    A(P0003)            SWITCH-POINT
X0006    DC    A(F0006)            WAYS-DONE
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL7'FIRST  '        nonnumeric constants
S0002    DC    CL8'........'
S0003    DC    CL7'SECOND '
S0004    DC    CL7'THIRD  '
S0005    DC    CL7'BACK   '
...
PA0001   DC    A(P0001)            RUN-ONE
PA0002   DC    A(P0002)            SWITCH-POINT
PA0003   DC    A(P0003)            FIRST-WAY
PA0004   DC    A(P0004)            SECOND-WAY
PA0005   DC    A(P0005)            THIRD-WAY
PA0006   DC    A(P0006)            WAYS-DONE
