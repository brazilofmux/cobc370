*---------------------------------------------------------------
* Generated by cobc370 from exprsize.cbl
...
* COMPUTE P3 = ...
         ...
         USING WSC0000,8
         ZAP   WK0+8(8),D0000(4)
         MP    WK0+8(8),D0001(4)   scale becomes the sum of the scales
         ZAP   WK1+11(5),D0000(4)
         SRP   WK1+11(5),2,0       align scale (left)
         AP    WK0+8(8),WK1+11(5)
         SRP   WK0+8(8),62,0       align scale (right)
         ZAP   D0002(6),WK0+8(8)
T0001    DS    0H
* MOVE P3 -> E1
         ZAP   PWK1(16),D0002(6)
         ZAP   EDSRC(6),PWK1(16)   source, sized to the selector count
         MVC   EDWK(14),M0001      load the ED pattern
         LA    1,EDWK+10           where printing starts if EDMK stays
         EDMK  EDWK(14),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0001               not negative?
         MVI   0(1),C'-'
G0001    DS    0H
         MVC   D0014(13),EDWK+1    the edited result
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),S0001
         MVC   DSPBUF+10(13),D0014+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
* COMPUTE P3 = ...
         ZAP   WK0+4(12),D0000(4)
         MP    WK0+4(12),D0001(4)  scale becomes the sum of the scales
         MP    WK0+4(12),D0001(4)  scale becomes the sum of the scales
         SP    WK0+4(12),K0001+10(6)
         SRP   WK0+4(12),60,0      align scale (right)
         ZAP   D0002(6),WK0+4(12)
T0004    DS    0H
* MOVE P3 -> E1
         ZAP   PWK1(16),D0002(6)
         ZAP   EDSRC(6),PWK1(16)   source, sized to the selector count
...
T0006    DS    0H
* COMPUTE P3 = ...
         ZAP   WK0+5(11),D0000(4)
         SRP   WK0+5(11),6,0       align scale (left)
         DP    WK0+5(11),D0001(4)  quotient, then the remainder
...
* COMPUTE P3 ROUNDED = ...
         ZAP   WK0+9(7),D0000(4)
         SRP   WK0+9(7),4,0        align scale (left)
         DP    WK0+9(7),K0002+15(1)  quotient, then the remainder
         ZAP   QTMP(6),WK0+9(6)    the quotient on its own
         ZAP   WK0+10(6),QTMP(6)   drop the remainder
         SRP   WK0+10(6),60,5      align scale (right, ROUNDED)
         ZAP   D0002(6),WK0+10(6)
T0010    DS    0H
* MOVE P3 -> E1
         ZAP   PWK1(16),D0002(6)
         ZAP   EDSRC(6),PWK1(16)   source, sized to the selector count
...
T0012    DS    0H
* COMPUTE P3 = ...
         PACK  WK0+3(13),D0003(7)  zoned -> packed
         PACK  WK1+12(4),D0004(6)  zoned -> packed
         SRP   WK0+3(13),9,0       align scale (left)
         DP    WK0+3(13),WK1+12(4)  quotient, then the remainder
         ZAP   QTMP(9),WK0+3(9)    the quotient on its own
         ZAP   WK0+7(9),QTMP(9)    drop the remainder
         SRP   WK0+7(9),60,0       align scale (right)
         ZAP   D0002(6),WK0+7(9)
T0013    DS    0H
* MOVE P3 -> E1
         ZAP   PWK1(16),D0002(6)
...
* COMPUTE D3 = ...
         ZAP   WK0+8(8),D0000(4)
         PACK  WK1+12(4),D0004(6)  zoned -> packed
         MP    WK0+8(8),WK1+12(4)  scale becomes the sum of the scales
         SRP   WK0+8(8),63,0       align scale (right)
         UNPK  D0005(15),WK0+8(8)  packed -> zoned
T0016    DS    0H
* MOVE D3 -> E2
         PACK  PWK1(16),D0005(15)  zoned -> packed
         ZAP   EDSRC(8),PWK1(16)   source, sized to the selector count
         MVC   EDWK(18),M0002      load the ED pattern
         ...
         MVI   0(1),C'-'
G0011    DS    0H
         MVC   D0015(17),EDWK+1    the edited result
T0017    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),S0006
         MVC   DSPBUF+10(17),D0015+0
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0018    DS    0H
* COMPUTE D3 = ...
         ...
         CVD   2,DWK               binary -> packed
         ZAP   WK1+12(4),DWK(8)
         MP    WK1+12(4),K0003+15(1)  scale becomes the sum of the scal
         AP    WK0+8(8),WK1+12(4)
...
T0021    DS    0H
* COMPUTE D3 = ...
         ZAP   WK1+12(4),D0000(4)
         ZAP   WK0+10(6),K0004+15(1)  unary minus
         SP    WK0+10(6),WK1+12(4)
         AP    WK0+10(6),K0005+14(2)
         SRP   WK0+10(6),2,0       align scale (left)
         UNPK  D0005(15),WK0+10(6)  packed -> zoned
T0022    DS    0H
* MOVE D3 -> E2
         PACK  PWK1(16),D0005(15)  zoned -> packed
         ZAP   EDSRC(8),PWK1(16)   source, sized to the selector count
...
T0027    DS    0H
* COMPUTE W2 = ...
         MVC   ZWK(18),D0008       the whole zoned item
         XC    WK0(6),WK0          the high half of the work area is ze
         PACK  WK0+6(10),ZWK+2(16)  the low 16 digits, with the sign
         PACK  DWK(2),ZWK(2)       and the leading digits on their own
         MVC   WK0+6(1),DWK        digit 1 into the free byte
         MVZ   WK0+7(1),DWK+1      and the next one into the free nibbl
         SP    WK0+6(10),K0007+6(10)
         ZAP   PWK1(16),WK0+6(10)
         ...
         OI    ZWK+1,X'F0'
         MVC   D0009(18),ZWK       the whole zoned item
T0028    DS    0H
* MOVE W2 -> E3
         MVC   ZWK(18),D0009       the whole zoned item
         ...
         EDMK  EDWK(21),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0019               not negative?
         MVI   0(1),C'-'
G0019    DS    0H
         MVC   D0016(19),EDWK+2    the edited result
T0029    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),S0010
         MVC   DSPBUF+10(19),D0016+0
         LA    1,PARM0010
         L     15,VDISP
         BALR  14,15
T0030    DS    0H
* COMPUTE W2 = ...
         ...
         MVC   WK0+6(1),DWK        digit 1 into the free byte
         MVZ   WK0+7(1),DWK+1      and the next one into the free nibbl
         SRP   WK0+1(15),4,0       align scale (left)
         DP    WK0+1(15),K0008+13(3)  quotient, then the remainder
         ZAP   QTMP(12),WK0+1(12)  the quotient on its own
         ZAP   WK0+4(12),QTMP(12)  drop the remainder
         SRP   WK0+4(12),60,0      align scale (right)
         ZAP   PWK1(16),WK0+4(12)
         UNPK  ZWK+2(16),PWK1+7(9)  the low 16 digits, sign and all
         UNPK  DWK(3),PWK1+6(2)    the leading digits
         MVC   ZWK(2),DWK+1        into the front of the item
         OI    ZWK,X'F0'           as plain digits
...
T0033    DS    0H
* COMPUTE D3 = ...
         MVC   ZWK(6),D0010        the item, sign and all
         PACK  WK0(16),ZWK+1(5)    the digits, without the sign charact
         CLI   ZWK+0,C'-'          negative?
         BNE   L0011
         NI    WK0+15,X'F0'        clear the sign nibble
         OI    WK0+15,X'0D'        and make it negative
L0011    DS    0H
         MP    WK0+10(6),K0009+15(1)  scale becomes the sum of the scal
         SRP   WK0+10(6),2,0       align scale (left)
         AP    WK0+10(6),D0001(4)
         SRP   WK0+10(6),2,0       align scale (left)
         UNPK  D0005(15),WK0+10(6)  packed -> zoned
...
* COMPUTE T1 = ...
         ZAP   WK0+8(8),D0000(4)
         SRP   WK0+8(8),5,0        align scale (left)
         DP    WK0+8(8),K0003+15(1)  quotient, then the remainder
         ZAP   QTMP(7),WK0+8(7)    the quotient on its own
         ZAP   WK0+9(7),QTMP(7)    drop the remainder
         SRP   WK0+9(7),60,0       align scale (right)
         ZAP   D0011(6),WK0+9(7)
T0039    DS    0H
* MOVE T1 -> E4
         ...
         EDMK  EDWK(14),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0027               not negative?
         MVI   0(1),C'-'
G0027    DS    0H
         MVC   D0017(12),EDWK+2    the edited result
T0040    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),S0014
         MVC   DSPBUF+10(12),D0017+0
         LA    1,PARM0014
         L     15,VDISP
         BALR  14,15
T0041    DS    0H
* COMPUTE T1 = ...
         ...
         ZAP   WK1+11(5),D0000(4)
         SP    WK1+11(5),D0001(4)
         MP    WK0(16),WK1+11(5)   scale becomes the sum of the scales
         ZAP   WK1+11(5),D0000(4)
         AP    WK1+11(5),K0010+14(2)
         SRP   WK0(16),5,0         align scale (left)
         DP    WK0(16),WK1+11(5)   quotient, then the remainder
         ZAP   QTMP(11),WK0+0(11)  the quotient on its own
         ZAP   WK0+5(11),QTMP(11)  drop the remainder
         SRP   WK0+5(11),60,0      align scale (right)
         ZAP   D0011(6),WK0+5(11)
T0042    DS    0H
* MOVE T1 -> E4
         ZAP   PWK1(16),D0011(6)
         ZAP   EDSRC(6),PWK1(16)   source, sized to the selector count
         ...
         EDMK  EDWK(14),EDSRC
         BCTR  1,0                 one left of the first significant di
         BNM   G0029               not negative?
         MVI   0(1),C'-'
G0029    DS    0H
         MVC   D0017(12),EDWK+2    the edited result
T0043    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),S0015
         MVC   DSPBUF+10(12),D0017+0
         LA    1,PARM0015
         L     15,VDISP
         BALR  14,15
T0044    DS    0H
* COMPUTE T1 = ...
         ZAP   WK0+8(8),K0011+12(4)  literal
         MP    WK0+8(8),K0011+12(4)  scale becomes the sum of the scale
         SRP   WK0+8(8),63,0       align scale (right)
         ZAP   D0011(6),WK0+8(8)
T0045    DS    0H
* MOVE T1 -> E4
...
T0047    DS    0H
* MOVE 5 -> N1
         MVC   D0012(4),S0017      numeric literal as zoned digits
T0048    DS    0H
* COMPUTE N1 = ... (ON SIZE ERROR)
         MVI   SZFLG,X'00'         no size error yet
         PACK  WK0+10(6),D0012(4)  zoned -> packed
         PACK  WK1+15(1),D0013(1)  zoned -> packed
         CP    WK1+15(1),K0004+15(1)  dividing by zero?
         BNE   L0014
...
L0014    DS    0H
         ...
         CP    WK1(16),K0006(16)   against 10 ** digits
         BL    L0012               fits
...
L0012    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         UNPK  D0012(4),PWK1(16)   packed -> zoned
         OI    D0012+3,X'F0'       unsigned: force an F zone
L0013    DS    0H
         DROP  8
...
T0049    DS    0H
* DISPLAY
         MVC   DSPBUF+0(21),S0018
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+21(4),D0012+0
         LA    1,PARM0017
         L     15,VDISP
         BALR  14,15
         DROP  8
...
* COMPUTE N1 = ... (ON SIZE ERROR)
         ...
         USING WSC0000,8
         PACK  WK0+10(6),D0012(4)  zoned -> packed
         CP    K0004+15(1),K0004+15(1)  dividing by zero?
         BNE   L0017
         MVI   SZFLG,X'01'         size error
         B     L0016
L0017    DS    0H
         SRP   WK0+10(6),4,0       align scale (left)
         DP    WK0+10(6),K0004+15(1)  quotient, then the remainder
         ZAP   QTMP(5),WK0+10(5)   the quotient on its own
         ZAP   WK0+11(5),QTMP(5)   drop the remainder
         SRP   WK0+11(5),60,0      align scale (right)
         ZAP   PWK1(16),WK0+11(5)
...
L0016    DS    0H
         DROP  8
         CLI   SZFLG,X'00'         any size error in the series?
         BE    L0002               none: past the imperative statements
T0051    DS    0H
* DISPLAY
         MVC   DSPBUF+0(22),S0019
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+22(4),D0012+0
         LA    1,PARM0018
         L     15,VDISP
         BALR  14,15
         DROP  8
...
* COMPUTE N1 = ... (ON SIZE ERROR)
         MVI   SZFLG,X'00'         no size error yet
         ZAP   WK0+12(4),K0013+13(3)  literal
         MP    WK0+12(4),K0012+15(1)  scale becomes the sum of the scal
...
L0019    DS    0H
         DROP  8
         CLI   SZFLG,X'00'         any size error in the series?
         BE    L0003               none: past the imperative statements
T0053    DS    0H
* DISPLAY
         MVC   DSPBUF+0(21),S0020
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+21(4),D0012+0
         LA    1,PARM0019
...
T0054    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),S0021
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+10(4),D0012+0
         LA    1,PARM0020
         L     15,VDISP
         BALR  14,15
T0055    DS    0H
* COMPUTE N1 = ... (ON SIZE ERROR)
         MVI   SZFLG,X'00'         no size error yet
         ZAP   WK0+12(4),K0013+13(3)  literal
         MP    WK0+12(4),K0014+15(1)  scale becomes the sum of the scal
         ZAP   PWK1(16),WK0+12(4)
         ZAP   WK1(16),PWK1(16)
         OI    WK1+15,X'0F'        magnitude
         CP    WK1(16),K0006(16)   against 10 ** digits
...
L0021    DS    0H
         DROP  8
         CLI   SZFLG,X'00'         any size error in the series?
         BE    L0004               none: past the imperative statements
T0056    DS    0H
* DISPLAY
         MVC   DSPBUF+0(21),S0020
         L     8,BL0000            base locator
...
T0058    DS    0H
* IF
         ZAP   WK0+10(6),D0000(4)
         AP    WK0+10(6),D0001(4)
         ZAP   WK1+10(6),D0000(4)
         MP    WK1+10(6),K0015+14(2)  scale becomes the sum of the scal
         SRP   WK0+10(6),2,0       align scale (left)
         CP    WK0+10(6),WK1+10(6)  numeric compare
         BNH   L0005
T0059    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),S0022
         LA    1,PARM0023
         L     15,VDISP
         BALR  14,15
T0060    DS    0H
...
* IF
         ...
         ZAP   WK0+8(8),D0000(4)
         MP    WK0+8(8),D0001(4)   scale becomes the sum of the scales
         ZAP   WK1+12(4),K0016+14(2)  literal
         SRP   WK1+12(4),4,0       align scale (left)
         CP    WK0+8(8),WK1+12(4)  numeric compare
         BNL   L0007
T0063    DS    0H
* DISPLAY
         MVC   DSPBUF+0(7),S0024
         LA    1,PARM0025
         L     15,VDISP
         BALR  14,15
T0064    DS    0H
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  WK0+9(7),D0003(7)   zoned -> packed
         SRP   WK0+9(7),4,0        align scale (left)
         DP    WK0+9(7),K0002+15(1)  quotient, then the remainder
         ZAP   QTMP(6),WK0+9(6)    the quotient on its own
         ZAP   WK0+8(8),QTMP(6)    drop the remainder
         ZAP   WK1+9(7),K0017+9(7)  literal
         SRP   WK0+8(8),3,0        align scale (left)
         CP    WK0+8(8),WK1+9(7)   numeric compare
         BNE   L0009
T0067    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0026
         LA    1,PARM0027
         L     15,VDISP
         BALR  14,15
T0068    DS    0H
...
* MOVE 0 -> K
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0018(4),S0028      numeric literal as zoned digits
T0071    DS    0H
* PERFORM COUNT-ONE
...
* DISPLAY
         ...
         MVC   DSPBUF+10(4),D0018+0
         MVC   DSPBUF+14(1),S0031
         MVC   DSPBUF+15(13),D0014+0
         LA    1,PARM0030
         L     15,VDISP
         BALR  14,15
T0077    DS    0H
...
* ADD 1 -> K
         L     8,BL0000            base locator
         USING WSC0000,8
         PACK  PWK1(16),D0018(4)   zoned -> packed
         ZAP   PWK2(16),K0020(16)  literal
         AP    PWK1(16),PWK2(16)
         UNPK  D0018(4),PWK1(16)   packed -> zoned
         OI    D0018+3,X'F0'       unsigned: force an F zone
...
LEN0026  DC    H'11'
PARM0027 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0027)  last parameter
LEN0027  DC    H'8'
PARM0028 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0028)  last parameter
LEN0028  DC    H'12'
PARM0029 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0029)  last parameter
LEN0029  DC    H'14'
PARM0030 DC    A(DSPBUF)
         DC    X'80',AL3(LEN0030)  last parameter
LEN0030  DC    H'28'
* work areas for decimal arithmetic
DWK      DS    D                   CVD/CVB doubleword
SZFLG    DS    X                   ON SIZE ERROR: set by any receiver o
PWK1     DS    PL16
PWK2     DS    PL16
...
WK4      DS    PL16
WK5      DS    PL16
K0001    DC    PL16'1000000000'    numeric constants
K0002    DC    PL16'7'
K0003    DC    PL16'3'
K0004    DC    PL16'0'
K0005    DC    PL16'50'
K0006    DC    PL16'10000'
K0007    DC    PL16'123456789012345000'
K0008    DC    PL16'1000'
K0009    DC    PL16'2'
K0010    DC    PL16'100'
K0011    DC    PL16'9999999'
K0012    DC    PL16'9'
K0013    DC    PL16'1234'
K0014    DC    PL16'8'
K0015    DC    PL16'99'
K0016    DC    PL16'-100'
K0017    DC    PL16'1763667142857'
K0018    DC    PL16'500'
K0019    DC    PL16'15'
K0020    DC    PL16'1'
M0001    DC    XL14'40402020202020202021204B2020'  ED patterns
M0002    DC    XL18'404020202020202020202021204B20202020'
M0003    DC    XL21'402040202020202020202020202020202020202120'
M0004    DC    XL14'402040202020202021204B202020'
S0001    DC    CL10'MUL ADD   '    nonnumeric constants
S0002    DC    CL10'MUL MUL   '
S0003    DC    CL10'DIV       '
S0004    DC    CL10'DIV LIT R '
S0005    DC    CL10'DIV DISP  '
S0006    DC    CL10'SHIFT LEFT'
S0007    DC    CL10'COMP      '
S0008    DC    CL10'NEG       '
S0009    DC    CL10'POW       '
S0010    DC    CL10'WIDE      '
S0011    DC    CL10'WIDE DIV  '
S0012    DC    CL10'SIGN LEAD '
S0013    DC    CL10'EDITED    '
S0014    DC    CL10'DIV V999  '
S0015    DC    CL10'NESTED    '
S0016    DC    CL10'BIG LITS  '
S0017    DC    CL4'0005'
S0018    DC    CL21'DIV ZERO  SIZE ERROR '
S0019    DC    CL22'DIV ZERO L SIZE ERROR '
S0020    DC    CL21'TOO BIG   SIZE ERROR '
S0021    DC    CL10'AFTER     '
S0022    DC    CL10'IF GREATER'
S0023    DC    CL14'IF NOT GREATER'
S0024    DC    CL7'IF LESS'
S0025    DC    CL11'IF NOT LESS'
S0026    DC    CL8'IF EQUAL'
S0027    DC    CL12'IF NOT EQUAL'
S0028    DC    CL4'0000'
S0029    DC    CL10'TIMES     '
S0030    DC    CL10'VARYING   '
S0031    DC    CL1' '
...
SPIENUM  DC    H'79'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0H
         DC    AL2(T0000-COBBEG),AL2(33)
         DC    AL2(T0001-COBBEG),AL2(34)
         DC    AL2(T0002-COBBEG),AL2(34)
         DC    AL2(T0003-COBBEG),AL2(35)
         DC    AL2(T0004-COBBEG),AL2(36)
         DC    AL2(T0005-COBBEG),AL2(36)
         DC    AL2(T0006-COBBEG),AL2(37)
         DC    AL2(T0007-COBBEG),AL2(38)
         DC    AL2(T0008-COBBEG),AL2(38)
         DC    AL2(T0009-COBBEG),AL2(39)
         DC    AL2(T0010-COBBEG),AL2(40)
         DC    AL2(T0011-COBBEG),AL2(40)
         DC    AL2(T0012-COBBEG),AL2(41)
         DC    AL2(T0013-COBBEG),AL2(42)
         DC    AL2(T0014-COBBEG),AL2(42)
         DC    AL2(T0015-COBBEG),AL2(43)
         DC    AL2(T0016-COBBEG),AL2(44)
         DC    AL2(T0017-COBBEG),AL2(44)
         DC    AL2(T0018-COBBEG),AL2(45)
         DC    AL2(T0019-COBBEG),AL2(46)
         DC    AL2(T0020-COBBEG),AL2(46)
         DC    AL2(T0021-COBBEG),AL2(47)
         DC    AL2(T0022-COBBEG),AL2(48)
         DC    AL2(T0023-COBBEG),AL2(48)
         DC    AL2(T0024-COBBEG),AL2(49)
         DC    AL2(T0025-COBBEG),AL2(50)
         DC    AL2(T0026-COBBEG),AL2(50)
         DC    AL2(T0027-COBBEG),AL2(51)
         DC    AL2(T0028-COBBEG),AL2(52)
         DC    AL2(T0029-COBBEG),AL2(52)
         DC    AL2(T0030-COBBEG),AL2(53)
         DC    AL2(T0031-COBBEG),AL2(54)
         DC    AL2(T0032-COBBEG),AL2(54)
         DC    AL2(T0033-COBBEG),AL2(55)
         DC    AL2(T0034-COBBEG),AL2(56)
         DC    AL2(T0035-COBBEG),AL2(56)
         DC    AL2(T0036-COBBEG),AL2(57)
         DC    AL2(T0037-COBBEG),AL2(58)
         DC    AL2(T0038-COBBEG),AL2(59)
         DC    AL2(T0039-COBBEG),AL2(60)
         DC    AL2(T0040-COBBEG),AL2(60)
         DC    AL2(T0041-COBBEG),AL2(61)
         DC    AL2(T0042-COBBEG),AL2(62)
         DC    AL2(T0043-COBBEG),AL2(62)
         DC    AL2(T0044-COBBEG),AL2(63)
         DC    AL2(T0045-COBBEG),AL2(64)
         DC    AL2(T0046-COBBEG),AL2(64)
         DC    AL2(T0047-COBBEG),AL2(65)
         DC    AL2(T0048-COBBEG),AL2(66)
         DC    AL2(T0049-COBBEG),AL2(67)
         DC    AL2(T0050-COBBEG),AL2(68)
         DC    AL2(T0051-COBBEG),AL2(69)
         DC    AL2(T0052-COBBEG),AL2(70)
         DC    AL2(T0053-COBBEG),AL2(71)
         DC    AL2(T0054-COBBEG),AL2(72)
         DC    AL2(T0055-COBBEG),AL2(73)
         DC    AL2(T0056-COBBEG),AL2(74)
         DC    AL2(T0057-COBBEG),AL2(75)
         DC    AL2(T0058-COBBEG),AL2(76)
         DC    AL2(T0059-COBBEG),AL2(76)
         DC    AL2(T0060-COBBEG),AL2(77)
         DC    AL2(T0061-COBBEG),AL2(77)
         DC    AL2(T0062-COBBEG),AL2(78)
         DC    AL2(T0063-COBBEG),AL2(78)
         DC    AL2(T0064-COBBEG),AL2(79)
         DC    AL2(T0065-COBBEG),AL2(79)
         DC    AL2(T0066-COBBEG),AL2(80)
         DC    AL2(T0067-COBBEG),AL2(80)
         DC    AL2(T0068-COBBEG),AL2(81)
         DC    AL2(T0069-COBBEG),AL2(81)
         DC    AL2(T0070-COBBEG),AL2(82)
         DC    AL2(T0071-COBBEG),AL2(83)
         DC    AL2(T0072-COBBEG),AL2(84)
         DC    AL2(T0073-COBBEG),AL2(85)
         DC    AL2(T0074-COBBEG),AL2(86)
         DC    AL2(T0075-COBBEG),AL2(88)
         DC    AL2(T0076-COBBEG),AL2(88)
         DC    AL2(T0077-COBBEG),AL2(89)
         DC    AL2(T0078-COBBEG),AL2(91)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    PL4'12345'          P1 PIC S9(7)v2 COMP-3
         DS    XL4                 reserve the rest of a table
D0001    DC    PL4'-101'           P2 PIC S9(7)v2 COMP-3
         DS    XL4                 reserve the rest of a table
D0002    DC    PL6'000'            P3 PIC S9(11)v2 COMP-3
         DS    XL2                 reserve the rest of a table
D0003    DC    CL7'1234567'        D1 PIC 9(7)v0 DISP
         DS    XL1                 reserve the rest of a table
D0004    DC    CL6'002125'         D2 PIC 9(6)v3 DISP
         DS    XL2                 reserve the rest of a table
D0005    DC    ZL15'00000'         D3 PIC S9(15)v4 DISP
         DS    XL1                 reserve the rest of a table
D0006    DC    FL4'100000'         C1 PIC S9(8)v0 COMP
         DS    XL4                 reserve the rest of a table
D0007    DC    HL2'-7'             C2 PIC S9(4)v0 COMP
         DS    XL6                 reserve the rest of a table
D0008    DC    CL18'123456789012345678'  W1 PIC 9(18)v0 DISP
         DS    XL6                 reserve the rest of a table
...
D0011    DC    PL6'0000'           T1 PIC S9(10)v3 COMP-3
         DS    XL2                 reserve the rest of a table
D0012    DC    CL4'0000'           N1 PIC 9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0013    DC    CL1'0'              Z0 PIC 9(1)v0 DISP
         DS    XL7                 reserve the rest of a table
D0014    DC    CL13' '             E1 edited, 13 chars
         DS    XL3                 reserve the rest of a table
D0015    DC    CL17' '             E2 edited, 17 chars
         DS    XL7                 reserve the rest of a table
D0016    DC    CL19' '             E3 edited, 19 chars
         DS    XL5                 reserve the rest of a table
D0017    DC    CL12' '             E4 edited, 12 chars
         DS    XL4                 reserve the rest of a table
D0018    DC    CL4'0000'           K PIC 9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0019    DC    PL4'000'            V PIC S9(7)v2 COMP-3
         DS    XL4                 reserve the rest of a table
D0020    DC    XL2'012F'           K2 PIC 9(2)v0 COMP-3
*---------------------------------------------------------------
