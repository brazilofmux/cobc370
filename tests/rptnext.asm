...
RG001    ST    14,RGS001           save the return
         ...
         MVC   EDWK(4),M0001       load the ED pattern
         ED    EDWK(4),EDSRC
         MVC   D0007(3),EDWK+1     the edited result
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+6(3),D0007     COLUMN placement
         LA    1,RGP001
         L     15,VWRL
         BALR  14,15
         DROP  8
...
L0025    DS    0H
         ...
         MVI   RBUF+1,C' '
         MVC   RBUF+2(131),RBUF+1  blank the line
         MVC   D0008(3),D0000      zoned to zoned, same picture
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+1(3),D0008     COLUMN placement
...
L0026    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0010(3),D0000      zoned to zoned, same picture
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+1(3),D0010     COLUMN placement
...
RG004    ST    14,RGS004           save the return
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+14(3),D0013    COLUMN placement
         LA    1,RGP004
         L     15,VWRL
         BALR  14,15
         DROP  8
...
RGP000   DC    A(FD000)            RPT-HEAD
         ...
         DC    X'80',AL3(D0003)    LINE-COUNTER; last parameter
...
D0005    DC    CL10' '             RPT0 PIC X(10)
D0006    DC    CL4' '              RPT1 PIC X(4)
D0007    DC    CL3' '              RPT2 edited, 3 chars
D0008    DC    CL3'000'            RPT3 PIC 9(3)v0 DISP
D0009    DC    CL6' '              RPT4 PIC X(6)
D0010    DC    CL3'000'            RPT5 PIC 9(3)v0 DISP
D0011    DC    CL6' '              RPT6 PIC X(6)
D0012    DC    CL12' '             RPT7 PIC X(12)
D0013    DC    CL3' '              RPT8 edited, 3 chars
*---------------------------------------------------------------
