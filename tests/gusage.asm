*---------------------------------------------------------------
* Generated by cobc370 from gusage.cbl
...
* ADD 1 -> A
         ...
         USING WSC0000,8
         AP    D0001(3),K0001+15(1)  packed, same scale: in place
         OI    D0001+2,X'0F'       unsigned: the magnitude, F sign
T0001    DS    0H
* ADD 250 -> B
         AP    D0002(3),K0002+14(2)  packed, same scale: in place
T0002    DS    0H
* MOVE A -> SHOW
         ZAP   PWK1(16),D0001(3)
...
* DISPLAY
         ...
         MVC   DSPBUF+5(1),S0001
         MVC   DSPBUF+6(6),D0004+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0005    DS    0H
...
K0002    DC    PL16'250'
M0001    DC    XL9'4020212020204B2020'  ED patterns
...
SPIELTB  DS    0H
         DC    AL2(T0000-COBBEG),AL2(12)
         DC    AL2(T0001-COBBEG),AL2(13)
         DC    AL2(T0002-COBBEG),AL2(14)
         DC    AL2(T0003-COBBEG),AL2(15)
         DC    AL2(T0004-COBBEG),AL2(16)
         DC    AL2(T0005-COBBEG),AL2(17)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DS    0CL6                G (01 group)
D0001    DC    XL3'00000F'         A PIC 9(5)v0 COMP-3
D0002    DC    PL3'000'            B PIC S9(5)v2 COMP-3
         DS    XL2                 reserve the rest of a table
D0003    DC    CL5'00000'          SHOW PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0004    DC    CL6' '              SHOWB edited, 6 chars
*---------------------------------------------------------------
