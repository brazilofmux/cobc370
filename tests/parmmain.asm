*---------------------------------------------------------------
* Generated by cobc370 from parmmain.cbl
...
* DISPLAY
         ...
         MVC   DSPBUF+6(20),D0003+0
         MVC   DSPBUF+26(1),S0002
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
...
K0001    EQU   *-15                numeric constants, as long as used
         DC    PL1'5'
S0001    DC    CL5'LEN ['          nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL6'TEXT ['
S0004    DC    CL4'FIVE'
...
D0000    DC    CL2'00'             N PIC 9(2)v0 DISP
         DS    XL20                reserve the rest of the last table
LS0000   DSECT                     PARM-AREA (caller's storage)
D0001    DS    0CL22               PARM-AREA (01 group)
D0002    DS    CL2                 PARM-LEN
D0003    DS    CL20                PARM-TEXT
*---------------------------------------------------------------
