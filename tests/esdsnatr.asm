*---------------------------------------------------------------
* Generated by cobc370 from esdsnatr.cbl
...
WK5      DS    PL16
* file control blocks
FD000    ACB   DDNAME=ESDSF01,MACRF=(ADR,SEQ,IN)  VSAM access method co
...
S0001    DC    CL32'ESDSREAD: READ ESDS SEQUENTIALLY'  nonnumeric const
S0002    DC    CL32'--------------------------------'
S0003    DC    CL1' '
S0004    DC    CL1'Y'
S0005    DC    CL2': '
...
* WORKING-STORAGE
D0000    DC    CL80' '             ESDS-RECORD PIC X(80)
