*---------------------------------------------------------------
* Generated by cobc370 from powfix.cbl
...
* COMPUTE R1 = ...
         ...
         MP    WK0(16),MULT8+6(2)
         MP    WK0(16),MULT8+6(2)
         SRP   WK0(16),50,0        align scale (right)
         L     8,BL0000            base locator
         USING WSC0000,8
         UNPK  D0000(9),WK0(16)    packed -> zoned
         OI    D0000+8,X'F0'       unsigned: force an F zone
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(2),S0001
         MVC   DSPBUF+2(9),D0000+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
* COMPUTE R1 = ...
         PACK  WK0(16),D0003(3)    zoned -> packed
         ZAP   MULT8(8),WK0(16)    the base
         MP    WK0(16),MULT8+6(2)  ** unrolled
         MP    WK0(16),MULT8+6(2)
         MP    WK0(16),MULT8+6(2)
...
T0004    DS    0H
* COMPUTE R2 = ...
         ZAP   WK0+9(7),K0002+10(6)  literal
         SRP   WK0+9(7),2,0        align scale (left)
         UNPK  D0001(11),WK0+9(7)  packed -> zoned
         OI    D0001+10,X'F0'      unsigned: force an F zone
T0005    DS    0H
* DISPLAY
         MVC   DSPBUF+0(2),S0003
         MVC   DSPBUF+2(11),D0001+0
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0006    DS    0H
* COMPUTE R3 = ...
         ZAP   WK0+12(4),K0003+14(2)  literal
         SRP   WK0+12(4),3,0       align scale (left)
         UNPK  D0002(10),WK0+12(4)  packed -> zoned
T0007    DS    0H
* DISPLAY
         MVC   DSPBUF+0(2),S0004
         MVC   DSPBUF+2(10),D0002+0
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0008    DS    0H
* COMPUTE R3 ROUNDED = ...
         ZAP   WK0(16),K0004+14(2)  literal
         ZAP   MULT8(8),WK0(16)    the base
         MP    WK0(16),MULT8+6(2)  ** unrolled
         MP    WK0(16),MULT8+6(2)
         MP    WK0(16),MULT8+6(2)
         ...
         UNPK  D0002(10),WK0(16)   packed -> zoned
T0009    DS    0H
* DISPLAY
         MVC   DSPBUF+0(2),S0005
         MVC   DSPBUF+2(10),D0002+0
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
T0010    DS    0H
* COMPUTE R2 = ...
         ZAP   WK0+9(7),K0005+10(6)  literal
         SRP   WK0+9(7),2,0        align scale (left)
         UNPK  D0001(11),WK0+9(7)  packed -> zoned
         OI    D0001+10,X'F0'      unsigned: force an F zone
T0011    DS    0H
* DISPLAY
         MVC   DSPBUF+0(2),S0006
         MVC   DSPBUF+2(11),D0001+0
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
...
* WORKING-STORAGE
D0000    DC    CL9'000000000'      R1 PIC 9(9)v4 DISP
         DS    XL7                 reserve the rest of a table
D0001    DC    CL11'00000000000'   R2 PIC 9(11)v2 DISP
         DS    XL5                 reserve the rest of a table
D0002    DC    ZL10'0'             R3 PIC S9(10)v3 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    CL3'105'            BASE PIC 9(3)v2 DISP
         DS    XL5                 reserve the rest of a table
D0004    DC    CL2'00'             N PIC 9(2)v0 DISP
*---------------------------------------------------------------
