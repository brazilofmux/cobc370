*---------------------------------------------------------------
* Generated by cobc370 from rptdbg.cbl
...
L0006    DS    0H
         BAL   14,RG007            PAGE FOOTING, the last group of the
L0003    DS    0H
T0012    DS    0H
...
L0034    DS    0H
         ...
         BALR  14,15
         DROP  8
         CLI   RBRK000,3           the break is at this level?
...
L0040    DS    0H
         ...
         BALR  14,15
         DROP  8
         CLI   RBRK000,2           the break is at this level?
...
RG006    ST    14,RGS006           save the return
         DROP  8
         CLI   RBODY000,X'00'      a body group on this page yet?
         BE    L0044
         L     8,BL0000            base locator
...
L0046    DS    0H
         ...
         MVI   RBUF+1,C' '
         MVC   RBUF+2(131),RBUF+1  blank the line
         MVC   RBUF+1(13),S0014    COLUMN literal
         LA    1,RGP006
         L     15,VWRL
         BALR  14,15
         DROP  8
...
RG007    ST    14,RGS007           save the return
         LA    2,14                LINE n
         ST    2,RTGT
         MVI   RBUF+1,C' '
         MVC   RBUF+2(131),RBUF+1  blank the line
         MVC   RBUF+1(8),S0015     COLUMN literal
         LA    1,RGP007
         L     15,VWRL
         BALR  14,15
...
REJC000  ST    14,REJCS000
         ...
         L     14,REJCS000
         BR    14
* page advance, report CTL-RPT
RADV000  ST    14,RADVS000
         DROP  8
         BAL   14,RG007            PAGE FOOTING
...
RGP000   DC    A(FD000)            PAGE-HEAD
         ...
         DC    X'80',AL3(D0009)    LINE-COUNTER; last parameter
...
RGP007   DC    A(FD000)            PAGE-FOOT
         DC    A(RPHY000)          the physical line
         DC    A(RTGT)
         DC    A(RBUF)
         DC    A(RCTL000)          pending carriage control
         DC    X'80',AL3(D0009)    LINE-COUNTER; last parameter
RGS007   DS    F                   return address
RCTL000  DC    C' '                CTL-RPT
...
S0004    DC    CL4'BB03'
S0005    DC    CL4'CC01'
S0006    DC    CL20'LINE-COUNTER AT END '
S0007    DC    CL17'LINE-COUNTER NOW '
S0008    DC    CL11'CONTROL RPT'
S0009    DC    CL11'BEGIN DEPT '
S0010    DC    CL5'ACCT '
S0011    DC    CL9'END ACCT '
S0012    DC    CL3'OF '
S0013    DC    CL9'END DEPT '
S0014    DC    CL13'END OF REPORT'
S0015    DC    CL8'==FOOT=='
...
SPIELTB  DS    0H
         DC    AL2(T0000-COBBEG),AL2(62)
         DC    AL2(T0001-COBBEG),AL2(63)
         DC    AL2(T0002-COBBEG),AL2(64)
         DC    AL2(T0003-COBBEG),AL2(65)
         DC    AL2(T0004-COBBEG),AL2(66)
         DC    AL2(T0005-COBBEG),AL2(67)
         DC    AL2(T0006-COBBEG),AL2(68)
         DC    AL2(T0007-COBBEG),AL2(69)
         DC    AL2(T0008-COBBEG),AL2(70)
         DC    AL2(T0009-COBBEG),AL2(71)
         DC    AL2(T0010-COBBEG),AL2(72)
         DC    AL2(T0011-COBBEG),AL2(74)
         DC    AL2(T0012-COBBEG),AL2(75)
         DC    AL2(T0013-COBBEG),AL2(76)
         DC    AL2(T0014-COBBEG),AL2(77)
         DC    AL2(T0015-COBBEG),AL2(78)
         DC    AL2(T0016-COBBEG),AL2(80)
         DC    AL2(T0017-COBBEG),AL2(81)
         DC    AL2(T0018-COBBEG),AL2(82)
         DC    AL2(T0019-COBBEG),AL2(83)
         DC    AL2(T0020-COBBEG),AL2(84)
COBWS    CSECT
