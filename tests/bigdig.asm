*---------------------------------------------------------------
* Generated by cobc370 from bigdig.cbl
...
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(16),D0001
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
* SUBTRACT 1 -> ZR
         PACK  PWK1(16),D0001(16)  zoned -> packed
...
* DISPLAY
         ...
         BALR  14,15
T0018    DS    0H
* MOVE 1234567890123456 -> M18
         ZAP   PWK1(16),K0002(16)  literal
         ZAP   D0006(10),PWK1(16)
T0019    DS    0H
...
T0024    DS    0H
* MOVE GT    -> FLAG
         MVC   D0009(5),S0001      literal move, space padded
T0025    DS    0H
         B     L0002
         DROP  8
L0001    DS    0H
...
* MOVE NOTGT -> FLAG
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0009(5),S0002      literal move, space padded
         DROP  8
L0002    DS    0H
T0027    DS    0H
* DISPLAY
...
T0029    DS    0H
* MOVE NEG   -> FLAG
         MVC   D0009(5),S0003      literal move, space padded
T0030    DS    0H
         B     L0004
         DROP  8
L0003    DS    0H
...
* MOVE POS   -> FLAG
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0009(5),S0004      literal move, space padded
         DROP  8
L0004    DS    0H
T0032    DS    0H
* DISPLAY
...
K0002    DC    PL16'1234567890123456'
K0003    DC    PL16'12345678912345678'
K0004    DC    PL16'-12345678912345678'
K0005    DC    PL16'0'
M0001    DC    XL21'402140202020202020202020202020202020202020'  ED pat
M0002    DC    XL22'402021402020202020202020204B2020202020202020'
S0001    DC    CL5'GT   '          nonnumeric constants
S0002    DC    CL5'NOTGT'
S0003    DC    CL5'NEG  '
S0004    DC    CL5'POS  '
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0028-COBBEG),AL2(58)
         DC    AL2(T0029-COBBEG),AL2(58)
         DC    AL2(T0030-COBBEG),AL2(60)
         DC    AL2(T0031-COBBEG),AL2(60)
         DC    AL2(T0032-COBBEG),AL2(61)
         DC    AL2(T0033-COBBEG),AL2(62)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL16'1234567890123456'  Z16 PIC 9(16)v0 DISP
D0001    DC    CL16'0000000000000000'  ZR PIC 9(16)v0 DISP
D0002    DC    PL10'999999999999999999'  A18 PIC S9(18)v0 COMP-3
         DS    XL6                 reserve the rest of a table
D0003    DC    PL10'111111111111111111'  B18 PIC S9(18)v0 COMP-3
         DS    XL6                 reserve the rest of a table
D0004    DC    PL10'-123456789012345678'  N18 PIC S9(18)v0 COMP-3
         DS    XL6                 reserve the rest of a table
D0005    DC    PL10'0'             Q18 PIC S9(18)v0 COMP-3
         DS    XL6                 reserve the rest of a table
D0006    DC    PL10'000'           M18 PIC S9(18)v2 COMP-3
         DS    XL6                 reserve the rest of a table
D0007    DC    CL19' '             E18 edited, 19 chars
         DS    XL5                 reserve the rest of a table
D0008    DC    CL19' '             E17 edited, 19 chars
         DS    XL5                 reserve the rest of a table
D0009    DC    CL5' '              FLAG PIC X(5)
*---------------------------------------------------------------
