...
K0001    EQU   *-15                numeric constants, as long as used
         DC    PL1'1'
K0002    EQU   *-7
         DC    PL9'1234567890123456'
K0003    EQU   *-7
         DC    PL9'12345678912345678'
K0004    EQU   *-7
         DC    PL9'-12345678912345678'
K0005    EQU   *-15
         DC    PL1'0'
...
SPIELTB  DS    0F
         ...
         DC    A(T0028-COBBEG),AL2(58,0)
         DC    A(T0029-COBBEG),AL2(58,0)
         DC    A(T0030-COBBEG),AL2(60,0)
         DC    A(T0031-COBBEG),AL2(60,0)
         DC    A(T0032-COBBEG),AL2(61,0)
         DC    A(T0033-COBBEG),AL2(62,0)
