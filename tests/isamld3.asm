*---------------------------------------------------------------
* Generated by cobc370 from isamld3.cbl
...
* OPEN OUTPUT DESCIDX
         ...
         BO    L0007
         WTO   'COBC370: OPEN FAILED, DD DESCIDX',ROUTCDE=11
         ABEND 35
         B     L0008
L0007    DS    0H
L0008    DS    0H
...
* MOVE SPACES -> DESC-RECORD
         ...
         LA    1,D0001             SPACES
         MVI   0(1),C' '
         MVC   1(256,1),0(1)       propagate across the item
         MVC   257(44,1),1(1)      and on
T0002    DS    0H
* MOVE 100 -> DESC-KEY
         MVC   D0003(10),S0001     numeric literal as zoned digits
T0003    DS    0H
* MOVE TAIL-0100 -> DESC-TAIL
         MVC   D0005(10),S0002     literal move, space padded
T0004    DS    0H
* WRITE DESC-RECORD
         MVI   ISFLG,X'00'
         XC    FD000+80(2),FD000+80  clear DCBEXCD before each PUT
...
* MOVE 200 -> DESC-KEY
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(10),S0004     numeric literal as zoned digits
T0007    DS    0H
* MOVE TAIL-0200 -> DESC-TAIL
         MVC   D0005(10),S0005     literal move, space padded
T0008    DS    0H
* WRITE DESC-RECORD
         MVI   ISFLG,X'00'
         XC    FD000+80(2),FD000+80  clear DCBEXCD before each PUT
...
* MOVE 300 -> DESC-KEY
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(10),S0007     numeric literal as zoned digits
T0011    DS    0H
* MOVE TAIL-0300 -> DESC-TAIL
         MVC   D0005(10),S0008     literal move, space padded
T0012    DS    0H
* WRITE DESC-RECORD
         MVI   ISFLG,X'00'
         XC    FD000+80(2),FD000+80  clear DCBEXCD before each PUT
...
FD000    DCB   DDNAME=DESCIDX,DSORG=IS,MACRF=(PM),RECFM=FB,            X
               LRECL=301,BLKSIZE=1505,KEYLEN=10,RKP=1,OPTCD=L,         X
               SYNAD=ISYNAD
S0001    DC    CL10'0000000100'    nonnumeric constants
S0002    DC    CL10'TAIL-0100 '
S0003    DC    CL9'L3 IK 100'
S0004    DC    CL10'0000000200'
S0005    DC    CL10'TAIL-0200 '
S0006    DC    CL9'L3 IK 200'
S0007    DC    CL10'0000000300'
S0008    DC    CL10'TAIL-0300 '
S0009    DC    CL9'L3 IK 300'
S0010    DC    CL9'L3 LOADED'
...
D0001    DS    0C                  DESC-RECORD (01 group)
D0002    DC    CL1' '              DESC-DELETE PIC X(1)
D0003    DC    CL10'0000000000'    DESC-KEY PIC 9(10)v0 DISP
D0004    DC    280C' '             DESC-TEXT PIC X(280)
D0005    DC    CL10' '             DESC-TAIL PIC X(10)
*---------------------------------------------------------------
