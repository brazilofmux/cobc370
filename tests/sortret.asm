*---------------------------------------------------------------
* Generated by cobc370 from sortret.cbl
...
T0006    DS    0H
* DISPLAY
         MVC   DSPBUF+0(15),S0001
         MVC   DSPBUF+15(4),D0004+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0007    DS    0H
...
* MOVE 3 -> S-K
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0002(2),S0002      numeric literal as zoned digits
T0009    DS    0H
* MOVE THREE -> S-X
         MVC   D0003(38),S0003     literal move, space padded
T0010    DS    0H
...
T0013    DS    0H
* MOVE 1 -> S-K
         MVC   D0002(2),S0005      numeric literal as zoned digits
T0014    DS    0H
* MOVE ONE -> S-X
         MVC   D0003(38),S0006     literal move, space padded
T0015    DS    0H
* RELEASE: the record to the sort, and back here for the next
         LA    14,L0013
         ST    14,SRTRES
...
T0018    DS    0H
* MOVE TWO -> S-X
         MVC   D0003(38),S0009     literal move, space padded
T0019    DS    0H
* RELEASE: the record to the sort, and back here for the next
         LA    14,L0014
         ST    14,SRTRES
...
T0024    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0012
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+8(2),D0002+0
         MVC   DSPBUF+10(1),S0013
         MVC   DSPBUF+11(38),D0003+0
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0025    DS    0H
...
SRT0001S DC    C' SORT FIELDS=(0001,002,ZD,A)'  SORT statement
...
S0002    DC    CL2'03'
S0003    DC    CL38'THREE                                 '
S0004    DC    CL14'IN-STOP SET 16'
S0005    DC    CL2'01'
S0006    DC    CL38'ONE                                   '
S0007    DC    CL28'IN-STOP AFTER SECOND RELEASE'
S0008    DC    CL2'02'
S0009    DC    CL38'TWO                                   '
S0010    DC    CL27'IN-STOP AFTER THIRD RELEASE'
S0011    DC    CL15'OUT-STOP AT END'
S0012    DC    CL8'OUT GOT '
S0013    DC    CL1' '
...
SPIELTB  DS    0F
         ...
         DC    A(T0001-COBBEG),AL2(24,0)
         DC    A(T0002-COBBEG),AL2(24,0)
         DC    A(T0003-COBBEG),AL2(24,0)
         DC    A(T0004-COBBEG),AL2(24,0)
         DC    A(T0005-COBBEG),AL2(25,0)
         DC    A(T0006-COBBEG),AL2(25,0)
         DC    A(T0007-COBBEG),AL2(26,0)
         DC    A(T0008-COBBEG),AL2(29,0)
         DC    A(T0009-COBBEG),AL2(29,0)
         DC    A(T0010-COBBEG),AL2(29,0)
         DC    A(T0011-COBBEG),AL2(30,0)
         DC    A(T0012-COBBEG),AL2(31,0)
         DC    A(T0013-COBBEG),AL2(32,0)
         DC    A(T0014-COBBEG),AL2(32,0)
         DC    A(T0015-COBBEG),AL2(32,0)
         DC    A(T0016-COBBEG),AL2(33,0)
         DC    A(T0017-COBBEG),AL2(34,0)
         DC    A(T0018-COBBEG),AL2(34,0)
         DC    A(T0019-COBBEG),AL2(34,0)
         DC    A(T0020-COBBEG),AL2(35,0)
         DC    A(T0021-COBBEG),AL2(38,0)
         DC    A(T0022-COBBEG),AL2(39,0)
         DC    A(T0023-COBBEG),AL2(39,0)
         DC    A(T0024-COBBEG),AL2(40,0)
         DC    A(T0025-COBBEG),AL2(41,0)
         DC    A(T0026-COBBEG),AL2(42,0)
         DC    A(T0027-COBBEG),AL2(44,0)
COBWS    CSECT
...
D0002    DC    CL2'00'             S-K PIC 9(2)v0 DISP
D0003    DC    CL38' '             S-X PIC X(38)
D0004    DC    ZL4'0'              SR PIC S9(4)v0 DISP
D0005    DC    HL2'0'              SORT-RETURN PIC S9(4)v0 COMP
         DS    XL2                 reserve the rest of a table
D0006    DC    FL4'0'              SORT-FILE-SIZE PIC S9(8)v0 COMP
*---------------------------------------------------------------
