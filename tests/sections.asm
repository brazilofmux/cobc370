*---------------------------------------------------------------
* Generated by cobc370 from sections.cbl
...
* MOVE 1 -> T1
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0001(1),S0006      literal move, space padded
         DROP  8
* SECT-A.
P0003    DS    0H
* A-FIRST.
...
* MOVE a -> T2
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0002(1),S0007      literal move, space padded
         DROP  8
* A-SECOND.
P0005    DS    0H
T0014    DS    0H
* MOVE A -> T3
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0003(1),S0008      literal move, space padded
...
* MOVE B -> T5
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0005(1),S0010      literal move, space padded
         DROP  8
* SECT-C.
P0009    DS    0H
* C-ONLY.
...
* MOVE c -> T6
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0006(1),S0011      literal move, space padded
* end of a PERFORM range: return through its cell
         L     15,X0010
         BR    15
...
X0005    DC    A(F0005)            A-SECOND
X0010    DC    A(F0010)            C-ONLY
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL5'A    '          nonnumeric constants
S0002    DC    CL6'......'
S0003    DC    CL5'BC   '
S0004    DC    CL5'P1A  '
S0005    DC    CL5'C    '
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0001-COBBEG),AL2(21)
         DC    AL2(T0002-COBBEG),AL2(22)
         ...
         DC    AL2(T0015-COBBEG),AL2(41)
         DC    AL2(T0016-COBBEG),AL2(43)
         DC    AL2(T0017-COBBEG),AL2(46)
         DC    AL2(T0018-COBBEG),AL2(49)
         DC    AL2(T0019-COBBEG),AL2(50)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DS    0CL6                T (01 group)
D0001    DC    CL1'.'              T1 PIC X(1)
D0002    DC    CL1'.'              T2 PIC X(1)
D0003    DC    CL1'.'              T3 PIC X(1)
D0004    DC    CL1'.'              T4 PIC X(1)
D0005    DC    CL1'.'              T5 PIC X(1)
D0006    DC    CL1'.'              T6 PIC X(1)
*---------------------------------------------------------------
