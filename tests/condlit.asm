*---------------------------------------------------------------
* Generated by cobc370 from condlit.cbl
...
* IF
         ...
         USING WSC0000,8
         CLC   D0000(3),S0001      alphanumeric compare
         BNH   L0001
T0001    DS    0H
* DISPLAY
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0000(3),S0006      alphanumeric compare
         BH    L0005
T0009    DS    0H
* DISPLAY
...
* MOVE NNYNN -> TBL
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0001(5),S0009      literal move, space padded
T0013    DS    0H
* IF
         LA    6,2                 subscript-1
...
G0001    MVI   EDWK+2,C' '
G0002    DS    0H
         MVC   D0005(6),EDWK+2     the edited result
T0023    DS    0H
* DISPLAY
         MVC   DSPBUF+0(12),S0015
         MVC   DSPBUF+12(6),D0005+0
         MVC   DSPBUF+18(1),S0016
         LA    1,PARM0011
         L     15,VDISP
         BALR  14,15
T0024    DS    0H
* IF
         CLC   D0006(3),S0017      alphanumeric compare
         BNE   L0011
T0025    DS    0H
* DISPLAY
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0008(3),S0017      alphanumeric compare
         BNE   L0015
T0033    DS    0H
* DISPLAY
         MVC   DSPBUF+0(7),S0022
         LA    1,PARM0016
         L     15,VDISP
         BALR  14,15
T0034    DS    0H
...
K0001    EQU   *-15                numeric constants, as long as used
         DC    PL1'-5'
M0001    DC    XL8'4021402020204B20'  ED patterns
S0001    DC    CL3'M  '            nonnumeric constants
S0002    DC    CL16'LITERAL LEFT: LT'
S0003    DC    CL20'LITERAL LEFT: NOT LT'
S0004    DC    CL16'LITERAL LEFT: GT'
S0005    DC    CL20'LITERAL LEFT: NOT GT'
S0006    DC    CL3'ABC'
S0007    DC    CL26'LITERAL LEFT: NOT LT EQUAL'
S0008    DC    CL22'LITERAL LEFT: LT EQUAL'
S0009    DC    CL5'NNYNN'
S0010    DC    CL1'Y'
S0011    DC    CL8'FLG 3 ON'
S0012    DC    CL9'FLG 3 OFF'
S0013    DC    CL8'FLG 2 ON'
S0014    DC    CL9'FLG 2 OFF'
S0015    DC    CL12'POINT FIVE ['
S0016    DC    CL1']'
S0017    DC    CL3'000'
S0018    DC    CL7'XZ ZERO'
S0019    DC    CL11'XZ NOT ZERO'
S0020    DC    CL10'XZ-ZERO ON'
S0021    DC    CL11'XZ-ZERO OFF'
S0022    DC    CL7'XS ZERO'
S0023    DC    CL11'XS NOT ZERO'
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(20,0)
         DC    A(T0001-COBBEG),AL2(20,0)
         DC    A(T0002-COBBEG),AL2(21,0)
         DC    A(T0003-COBBEG),AL2(21,0)
         DC    A(T0004-COBBEG),AL2(22,0)
         DC    A(T0005-COBBEG),AL2(22,0)
         DC    A(T0006-COBBEG),AL2(23,0)
         DC    A(T0007-COBBEG),AL2(23,0)
         DC    A(T0008-COBBEG),AL2(24,0)
         DC    A(T0009-COBBEG),AL2(24,0)
         DC    A(T0010-COBBEG),AL2(25,0)
         DC    A(T0011-COBBEG),AL2(25,0)
         DC    A(T0012-COBBEG),AL2(26,0)
         DC    A(T0013-COBBEG),AL2(27,0)
         DC    A(T0014-COBBEG),AL2(27,0)
         DC    A(T0015-COBBEG),AL2(27,0)
         DC    A(T0016-COBBEG),AL2(27,0)
         DC    A(T0017-COBBEG),AL2(28,0)
         DC    A(T0018-COBBEG),AL2(28,0)
         DC    A(T0019-COBBEG),AL2(28,0)
         DC    A(T0020-COBBEG),AL2(28,0)
         DC    A(T0021-COBBEG),AL2(29,0)
         DC    A(T0022-COBBEG),AL2(29,0)
         DC    A(T0023-COBBEG),AL2(30,0)
         DC    A(T0024-COBBEG),AL2(31,0)
         DC    A(T0025-COBBEG),AL2(31,0)
         DC    A(T0026-COBBEG),AL2(31,0)
         DC    A(T0027-COBBEG),AL2(31,0)
         DC    A(T0028-COBBEG),AL2(32,0)
         DC    A(T0029-COBBEG),AL2(32,0)
         DC    A(T0030-COBBEG),AL2(32,0)
         DC    A(T0031-COBBEG),AL2(32,0)
         DC    A(T0032-COBBEG),AL2(33,0)
         DC    A(T0033-COBBEG),AL2(33,0)
         DC    A(T0034-COBBEG),AL2(33,0)
         DC    A(T0035-COBBEG),AL2(33,0)
         DC    A(T0036-COBBEG),AL2(34,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL3'ABC'            WS-X PIC X(3)
         DS    XL5                 reserve the rest of a table
D0001    DS    0CL5                TBL (01 group)
D0002    DC    5CL1' '             FLG PIC X(1) table
         DS    XL3                 reserve the rest of a table
D0004    DC    PL3'0'              P3 PIC S9(4)v1 COMP-3
         DS    XL5                 reserve the rest of a table
D0005    DC    CL6' '              P3D edited, 6 chars
         DS    XL2                 reserve the rest of a table
D0006    DC    CL3'000'            XZ PIC X(3)
         DS    XL5                 reserve the rest of a table
D0008    DC    CL3'00 '            XS PIC X(3)
*---------------------------------------------------------------
