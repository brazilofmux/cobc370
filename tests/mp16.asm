*---------------------------------------------------------------
* Generated by cobc370 from mp16.cbl
...
* COMPUTE C = ...
         ...
         USING WSC0000,8
         PACK  WK0+5(11),D0000(16)  zoned -> packed
         PACK  WK1+14(2),D0001(2)  zoned -> packed
         MP    WK0+5(11),WK1+14(2)  scale becomes the sum of the scales
         ZAP   PWK1(16),WK0+5(11)
         ...
         OI    ZWK+1,X'F0'
         MVC   D0002(18),ZWK       the whole zoned item
         OI    D0002+17,X'F0'      unsigned: force an F zone
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(18),D0002+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0002-COBBEG),AL2(13)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL16'1234567890123456'  A PIC 9(16)v0 DISP
D0001    DC    CL2'02'             B PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0002    DC    CL18'000000000000000000'  C PIC 9(18)v0 DISP
*---------------------------------------------------------------
