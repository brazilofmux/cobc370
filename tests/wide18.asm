*---------------------------------------------------------------
* Generated by cobc370 from wide18.cbl
...
T0004    DS    0H
* MOVE S18 -> E18
         MVC   ZWK(18),D0002       the whole zoned item
         XC    PWK1(6),PWK1        the high half of the work area is ze
         PACK  PWK1+6(10),ZWK+2(16)  the low 16 digits, with the sign
         PACK  DWK(2),ZWK(2)       and the leading digits on their own
         MVC   PWK1+6(1),DWK       digit 1 into the free byte
...
SPIELTB  DS    0H
         ...
         DC    AL2(T0023-COBBEG),AL2(42)
         DC    AL2(T0024-COBBEG),AL2(43)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    CL17'12345678901234567'  D17 PIC 9(17)v0 DISP
         DS    XL7                 reserve the rest of a table
D0001    DC    CL18'123456789012345678'  D18 PIC 9(18)v0 DISP
         DS    XL6                 reserve the rest of a table
D0002    DC    CL17'12345678901234567',XL1'D8'  S18 PIC S9(18)v0 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    CL18'000000000000000000'  R18 PIC 9(18)v0 DISP
         DS    XL6                 reserve the rest of a table
D0004    DC    CL17'00000000000000000'  R17 PIC 9(17)v0 DISP
         DS    XL7                 reserve the rest of a table
D0005    DC    PL10'0'             P18 PIC S9(18)v0 COMP-3
         DS    XL6                 reserve the rest of a table
D0006    DC    CL19' '             E18 edited, 19 chars
*---------------------------------------------------------------
