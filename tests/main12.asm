*---------------------------------------------------------------
* Generated by cobc370 from main12.cbl
...
* CALL 'SUB12'
         ...
         LA    0,D0011             A12
         ST    0,PL001+44
         OI    PL001+44,X'80'      high bit marks the last argument
         LA    1,PL001             R1 -> parameter list
         L     15,VC001
         BALR  14,15               static call, resolved by the linkage
         STH   15,D0012            the callee's return code -> RETURN-C
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(13),S0001
         MVC   DSPBUF+13(2),D0011+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
* STOP RUN
         ...
         BALR  14,15
         LH    15,D0012            RETURN-CODE -> the step's condition
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL13'RESULT SUM12 '  nonnumeric constants
...
* WORKING-STORAGE
D0000    DC    CL2'01'             A1 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0001    DC    CL2'02'             A2 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0002    DC    CL2'03'             A3 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    CL2'04'             A4 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0004    DC    CL2'05'             A5 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0005    DC    CL2'06'             A6 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0006    DC    CL2'07'             A7 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0007    DC    CL2'08'             A8 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0008    DC    CL2'09'             A9 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0009    DC    CL2'10'             A10 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0010    DC    CL2'11'             A11 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0011    DC    CL2'00'             A12 PIC 9(2)v0 DISP
D0012    DC    HL2'0'              RETURN-CODE PIC S9(4)v0 COMP
*---------------------------------------------------------------
