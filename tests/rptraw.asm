*---------------------------------------------------------------
* Generated by cobc370 from rptraw.cbl
...
L0013    DS    0H
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0008(1),S0001      alphanumeric compare
         BE    L0014
...
* READ RAW-FILE
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         GET   FD001,D0002         QSAM move mode
         B     L0002
L0001    DS    0H                  AT END
         DROP  8
T0012    DS    0H
* MOVE Y -> EOF
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0008(1),S0001      literal move, space padded
         DROP  8
L0002    DS    0H
T0013    DS    0H
* IF
...
T0015    DS    0H
* IF
         CLC   D0006(1),S0003      alphanumeric compare
         BNE   L0004
T0016    DS    0H
* DISPLAY
         MVC   DSPBUF+0(2),D0009+0
         MVC   DSPBUF+2(2),S0004
         MVC   DSPBUF+4(1),D0003+0
         MVC   DSPBUF+5(2),S0005
         MVC   DSPBUF+7(20),D0004+0
         MVC   DSPBUF+27(6),S0006
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0017    DS    0H
...
* DISPLAY
         ...
         MVC   DSPBUF+5(2),S0005
         MVC   DSPBUF+7(20),D0004+0
         MVC   DSPBUF+27(2),S0004
         MVC   DSPBUF+29(1),D0006+0
         MVC   DSPBUF+30(1),S0007
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
         DROP  8
...
RG000    ST    14,RGS000           save the return
         ...
         MVC   RBUF+1(8),S0008     COLUMN literal
         MVC   RBUF+132(1),S0009   COLUMN literal
         LA    1,RGP000
         L     15,VWRL
         BALR  14,15
         MVI   RSUPPR,X'00'
...
L0020    DS    0H
         ...
         MVI   RBUF+1,C' '
         MVC   RBUF+2(133),RBUF+1  blank the line
         MVC   RBUF+1(4),S0010     COLUMN literal
         MVC   D0018(2),D0007      zoned to zoned, same picture
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   RBUF+6(2),D0018     COLUMN placement
         LA    1,RGP001
         L     15,VWRL
         BALR  14,15
         DROP  8
...
X0001    DC    A(F0001)            GEN
X0002    DC    A(F0002)            SHOW-ONE
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
FD001    DCB   DDNAME=PROUT,DSORG=PS,MACRF=(GM)
...
S0002    DC    CL8'RECORDS '
S0003    DC    CL1' '
S0004    DC    CL2' ['
S0005    DC    CL2'] '
S0006    DC    CL6' BLANK'
S0007    DC    CL1']'
S0008    DC    CL8'RAW HEAD'
S0009    DC    CL1'E'
S0010    DC    CL4'ITEM'
...
SPIENUM  DC    H'19'               statements in the table
SPIEREGS DS    15F
...
PA0001   DC    A(P0001)            GEN
PA0002   DC    A(P0002)            SHOW-ONE
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(45,0)
         DC    A(T0001-COBBEG),AL2(46,0)
         DC    A(T0002-COBBEG),AL2(47,0)
         DC    A(T0003-COBBEG),AL2(48,0)
         DC    A(T0004-COBBEG),AL2(49,0)
         DC    A(T0005-COBBEG),AL2(50,0)
         DC    A(T0006-COBBEG),AL2(51,0)
         DC    A(T0007-COBBEG),AL2(52,0)
         DC    A(T0008-COBBEG),AL2(53,0)
         DC    A(T0009-COBBEG),AL2(54,0)
         DC    A(T0010-COBBEG),AL2(56,0)
         DC    A(T0011-COBBEG),AL2(58,0)
         DC    A(T0012-COBBEG),AL2(58,0)
         DC    A(T0013-COBBEG),AL2(60,0)
         DC    A(T0014-COBBEG),AL2(60,0)
         DC    A(T0015-COBBEG),AL2(62,0)
         DC    A(T0016-COBBEG),AL2(62,0)
         DC    A(T0017-COBBEG),AL2(63,0)
         DC    A(T0018-COBBEG),AL2(63,0)
...
D0000    DC    CL4' '              *RDW PIC X(4)
         DS    XL4                 reserve the rest of a table
D0001    DC    CL4' '              *RDW PIC X(4)
D0002    DS    0CL133              RAW-REC (01 group)
D0003    DC    CL1' '              R-CTL PIC X(1)
D0004    DC    CL20' '             R-TEXT PIC X(20)
D0005    DC    CL111' '            FILL0005 PIC X(111)
D0006    DC    CL1' '              R-LAST PIC X(1)
         DS    XL3                 reserve the rest of a table
D0007    DC    CL2'00'             WS-IDX PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0008    DC    CL1'N'              EOF PIC X(1)
         DS    XL7                 reserve the rest of a table
D0009    DC    CL2'00'             SEQ PIC 9(2)v0 DISP
         DS    XL2                 reserve the rest of a table
D0010    DS    0CL8                RAW-RPT (01 group)
D0011    DC    FL4'0'              LINE-COUNTER PIC 9(6)v0 COMP
D0012    DC    FL4'0'              PAGE-COUNTER PIC 9(6)v0 COMP
D0013    DS    0C                  PAGE-HEAD (02 group)
D0014    DC    CL8' '              RPT0 PIC X(8)
D0015    DC    CL1' '              RPT1 PIC X(1)
D0016    DS    0C                  DL (02 group)
D0017    DC    CL4' '              RPT2 PIC X(4)
D0018    DC    CL2'00'             RPT3 PIC 9(2)v0 DISP
*---------------------------------------------------------------
