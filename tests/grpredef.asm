*---------------------------------------------------------------
* Generated by cobc370 from grpredef.cbl
...
* DISPLAY
         ...
         MVC   DSPBUF+4(6),D0013
         LA    1,PARM0008
         L     15,VDISP
         BALR  14,15
T0008    DS    0H
* DISPLAY
         MVC   DSPBUF+0(4),S0009
         MVC   DSPBUF+4(4),D0014
         LA    1,PARM0009
         L     15,VDISP
         BALR  14,15
T0009    DS    0H
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL4'B1  '           nonnumeric constants
S0002    DC    CL4'B2  '
S0003    DC    CL4'S1  '
S0004    DC    CL4'N1  '
S0005    DC    CL4'N2A '
...
* WORKING-STORAGE
D0000    DS    0CL26               REC (01 group)
D0001    DC    CL20'12345678901234567890'  A PIC X(20)
D0002    EQU   COBWS+0             B REDEFINES
D0003    EQU   COBWS+0             B1 REDEFINES
D0004    EQU   COBWS+4             B2 REDEFINES
D0005    EQU   COBWS+0             SHORT REDEFINES
D0006    EQU   COBWS+0             S1 REDEFINES
D0007    EQU   COBWS+0             NEST REDEFINES
D0008    EQU   COBWS+0             N1 REDEFINES
D0009    EQU   COBWS+0             N2 REDEFINES
D0010    EQU   COBWS+0             N2A REDEFINES
D0011    EQU   COBWS+3             N2B REDEFINES
D0012    EQU   COBWS+8             N3 REDEFINES
D0013    DC    CL6'TAILXX'         TAIL PIC X(6)
         DS    XL6                 reserve the rest of a table
D0014    DC    CL4'NEXT'           AFTER01 PIC X(4)
*---------------------------------------------------------------
