*---------------------------------------------------------------
* Generated by cobc370 from listctl.cbl
...
* DISPLAY
         ...
         USING WSC0000,8
         MVC   DSPBUF+0(10),D0000+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0001    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),D0001+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0002    DS    0H
...
* WORKING-STORAGE
D0000    DC    CL10'BEFORE'        FIRST-ITEM PIC X(10)
         DS    XL6                 reserve the rest of a table
D0001    DC    CL10'MIDDLE'        SECOND-ITEM PIC X(10)
         DS    XL6                 reserve the rest of a table
D0002    DC    CL10'AFTER'         THIRD-ITEM PIC X(10)
*---------------------------------------------------------------
