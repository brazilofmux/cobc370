*---------------------------------------------------------------
* Generated by cobc370 from remaindr.cbl
...
T0000    DS    0H
* COMPUTE Q = ...
         ZAP   WK0+2(14),K0002+12(4)  literal
         SRP   WK0+2(14),12,0      align scale (left)
         DP    WK0+2(14),K0001+12(4)  quotient, then the remainder
         ZAP   QTMP(10),WK0+2(10)  the quotient on its own
         ZAP   WK0+6(10),QTMP(10)  drop the remainder
         SRP   WK0+6(10),60,0      align scale (right)
         L     8,BL0000            base locator
         USING WSC0000,8
         UNPK  D0000(9),WK0+6(10)  packed -> zoned
         OI    D0000+8,X'F0'       unsigned: force an F zone
T0001    DS    0H
* COMPUTE REM = ...
         ZAP   WK0+4(12),K0002+12(4)  literal
         SRP   WK0+4(12),8,0       align scale (left)
         ZAP   WK1+2(14),K0002+12(4)  literal
         SRP   WK1+2(14),12,0      align scale (left)
         DP    WK1+2(14),K0001+12(4)  quotient, then the remainder
         ZAP   QTMP(10),WK1+2(10)  the quotient on its own
         ZAP   WK1+4(12),QTMP(10)  drop the remainder
         SRP   WK1+4(12),60,0      align scale (right)
         MP    WK1+4(12),K0001+12(4)  scale becomes the sum of the scal
         SP    WK0+4(12),WK1+4(12)
         SRP   WK0+4(12),58,0      align scale (right)
         UNPK  D0001(8),WK0+4(12)  packed -> zoned
         OI    D0001+7,X'F0'       unsigned: force an F zone
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(3),S0001
         MVC   DSPBUF+3(9),D0000+0
         MVC   DSPBUF+12(7),S0002
         MVC   DSPBUF+19(8),D0001+0
         MVC   DSPBUF+27(1),S0003
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
* COMPUTE Q2 = ...
         ...
         UNPK  D0002(2),WK0+12(4)  packed -> zoned
...
* COMPUTE R2 = ...
         ...
         UNPK  D0003(2),WK0+13(3)  packed -> zoned
         OI    D0003+1,X'F0'       unsigned: force an F zone
T0005    DS    0H
* DISPLAY
         MVC   DSPBUF+0(4),S0004
         MVC   DSPBUF+4(2),D0002+0
         MVC   DSPBUF+6(6),S0005
...
K0004    EQU   *-14
         DC    PL2'47'
S0001    DC    CL3'Q ['            nonnumeric constants
S0002    DC    CL7'] REM ['
S0003    DC    CL1']'
S0004    DC    CL4'Q2 ['
S0005    DC    CL6'] R2 ['
...
* WORKING-STORAGE
D0000    DC    CL9'000000000'      Q PIC 9(9)v8 DISP
         DS    XL7                 reserve the rest of a table
D0001    DC    CL8'00000000'       REM PIC 9(8)v2 DISP
D0002    DC    CL2'00'             Q2 PIC 9(2)v0 DISP
         DS    XL6                 reserve the rest of a table
D0003    DC    CL2'00'             R2 PIC 9(2)v0 DISP
*---------------------------------------------------------------
