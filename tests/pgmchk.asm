*---------------------------------------------------------------
* Generated by cobc370 from pgmchk.cbl
...
WK4      DS    PL16
WK5      DS    PL16
S0001    DC    CL18'BEFORE THE BAD ADD'  nonnumeric constants
S0002    DC    CL17'AFTER THE BAD ADD'
...
* WORKING-STORAGE
D0000    DS    0CL3                W (01 group)
D0001    DC    CL3'ABC'            W-A PIC X(3)
D0002    EQU   COBWS+0             W-N REDEFINES
         DS    XL5                 reserve the rest of a table
D0003    DC    ZL7'0'              RESULT-FIELD PIC S9(7)v0 DISP
*---------------------------------------------------------------
