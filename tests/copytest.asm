*---------------------------------------------------------------
* Generated by cobc370 from copytest.cbl
...
* ADD IN-AMT -> TOTAL
         ...
         PACK  PWK2(16),D0005(5)   zoned -> packed
         AP    PWK1(16),PWK2(16)
...
* MOVE TOTAL -> E-TOTAL
         ...
         MVC   EDWK(9),M0002       load the ED pattern
         ED    EDWK(9),EDSRC
...
SPIELTB  DS    0F
         ...
         DC    A(T0009-COBBEG),AL2(1,0)
         DC    A(T0010-COBBEG),AL2(2,0)
         DC    A(T0011-COBBEG),AL2(1,0)
         DC    A(T0012-COBBEG),AL2(2,0)
...
* WORKING-STORAGE
D0000    DC    CL4'0000'           CW-COUNTER PIC 9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0001    DC    CL1'N'              CW-FLAG PIC X(1)
         DS    XL7                 reserve the rest of a table
D0002    DS    0CL14               IN-REC (01 group)
D0003    DC    CL3'000'            IN-ID PIC 9(3)v0 DISP
D0004    DC    CL6' '              IN-NAME PIC X(6)
D0005    DC    CL5'00000'          IN-AMT PIC 9(5)v2 DISP
         DS    XL2                 reserve the rest of a table
D0006    DS    0CL14               OUT-REC (01 group)
D0007    DC    CL3'000'            OUT-ID PIC 9(3)v0 DISP
D0008    DC    CL6' '              OUT-NAME PIC X(6)
D0009    DC    CL5'00000'          OUT-AMT PIC 9(5)v2 DISP
         DS    XL2                 reserve the rest of a table
D0010    DC    CL7'0000000'        TOTAL PIC 9(7)v2 DISP
         DS    XL1                 reserve the rest of a table
D0011    DC    CL8' '              E-TOTAL edited, 8 chars
D0012    DC    CL6' '              E-AMT edited, 6 chars
*---------------------------------------------------------------
