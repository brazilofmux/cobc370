*---------------------------------------------------------------
* Generated by cobc370 from merge2.cbl
...
* OPEN INPUT IN1-FILE
         ...
         BO    L0019
         WTO   'COBC370: OPEN FAILED, DD INFILE1',ROUTCDE=11
         ABEND 35
         B     L0020
L0019    DS    0H
L0020    DS    0H
...
* RETURN MERGE-FILE
         ...
         BZ    L0009
         B     L0028               it is in the SD's record
L0027    DS    0H
...
L0002    DS    0H
         ...
         CLI   MRGF000+0,0         IN1-FILE
         BNE   L0034               at end
         L     5,MRGA000+0         its record
         LTR   4,4
         BZ    L0035               the first candidate
         BAL   14,L0031            compare
         LTR   15,15
         BZ    L0034               the best so far stays
L0035    DS    0H
         LR    4,5
         LA    5,0
...
L0034    DS    0H
         ...
         LTR   4,4
         BZ    L0037               the first candidate
         BAL   14,L0031            compare
         LTR   15,15
         BZ    L0036               the best so far stays
L0037    DS    0H
         LR    4,5
         LA    5,1
         ST    5,MRGBST            the file it came from
...
L0029    DS    0H
         ...
         L     14,MRGRT
         BR    14
L0031    DS    0H                  candidate before the best?
         PACK  PWK1(16),10(2,4)    M-DEPT
         PACK  PWK2(16),10(2,5)
         CP    PWK1(16),PWK2(16)
         BL    L0032               DESCENDING
         BH    L0033
         CLC   0(10,4),0(5)        M-NAME
         BH    L0032               ASCENDING
         BL    L0033
L0033    DS    0H                  equal: the first-named file's
         SR    15,15
         BR    14
L0032    DS    0H
         LA    15,1
...
* MOVE Y -> EOF
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0011(1),S0002      literal move, space padded
         DROP  8
L0016    DS    0H
T0030    DS    0H
* PERFORM SHOW-ONE
L0040    DS    0H
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0011(1),S0002      alphanumeric compare
         BE    L0041
...
MRGT000  DC    A(L0003,L0004)      each file's READ
PWK1     DS    PL16
PWK2     DS    PL16
...
WK5      DS    PL16
* file control blocks
FD000    DCB   DDNAME=INFILE1,DSORG=PS,MACRF=(GM)
FD001    DCB   DDNAME=INFILE2,DSORG=PS,MACRF=(GM)
FD002    DCB   DDNAME=OUTFILE,DSORG=PS,MACRF=(GM,PM),RECFM=FB,         X
               LRECL=80,BLKSIZE=80
S0001    DC    CL12'SORT-RETURN '  nonnumeric constants
S0002    DC    CL1'Y'
S0003    DC    CL15'END OF OUT-FILE'
...
SPIENUM  DC    H'37'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0F
         ...
         DC    A(T0014-COBBEG),AL2(36,0)
         DC    A(T0015-COBBEG),AL2(36,0)
         DC    A(T0016-COBBEG),AL2(36,0)
         DC    A(T0017-COBBEG),AL2(36,0)
         DC    A(T0018-COBBEG),AL2(36,0)
         ...
         DC    A(T0025-COBBEG),AL2(37,0)
         DC    A(T0026-COBBEG),AL2(38,0)
         DC    A(T0027-COBBEG),AL2(39,0)
         DC    A(T0028-COBBEG),AL2(40,0)
         DC    A(T0029-COBBEG),AL2(40,0)
         DC    A(T0030-COBBEG),AL2(41,0)
         DC    A(T0031-COBBEG),AL2(42,0)
         DC    A(T0032-COBBEG),AL2(43,0)
         DC    A(T0033-COBBEG),AL2(44,0)
         DC    A(T0034-COBBEG),AL2(46,0)
         DC    A(T0035-COBBEG),AL2(47,0)
         DC    A(T0036-COBBEG),AL2(47,0)
...
D0001    DC    CL80' '             IN1-REC PIC X(80)
         DS    XL4                 reserve the rest of a table
D0002    DC    CL4' '              *RDW PIC X(4)
D0003    DC    CL80' '             IN2-REC PIC X(80)
         DS    XL4                 reserve the rest of a table
D0004    DC    CL4' '              *RDW PIC X(4)
D0005    DC    CL80' '             OUT-REC PIC X(80)
         DS    XL4                 reserve the rest of a table
D0006    DC    CL4' '              *RDW PIC X(4)
D0007    DS    0CL80               M-REC (01 group)
D0008    DC    CL10' '             M-NAME PIC X(10)
D0009    DC    CL2'00'             M-DEPT PIC 9(2)v0 DISP
D0010    DC    CL68' '             M-REST PIC X(68)
D0011    DC    CL1'N'              EOF PIC X(1)
         DS    XL7                 reserve the rest of a table
D0012    DC    ZL4'0'              SR PIC S9(4)v0 DISP
D0013    DC    HL2'0'              SORT-RETURN PIC S9(4)v0 COMP
         DS    XL2                 reserve the rest of a table
D0014    DC    FL4'0'              SORT-FILE-SIZE PIC S9(8)v0 COMP
*---------------------------------------------------------------
