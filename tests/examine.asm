*---------------------------------------------------------------
* Generated by cobc370 from examine.cbl
...
* DISPLAY
         ...
         MVC   DSPBUF+15(5),D0004+0
         MVC   DSPBUF+20(2),S0015
         MVC   DSPBUF+22(12),D0000+0
         MVC   DSPBUF+34(1),S0016
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0005    DS    0H
...
T0008    DS    0H
* DISPLAY
         MVC   DSPBUF+0(19),S0017
         MVC   DSPBUF+19(5),D0004+0
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0009    DS    0H
...
T0012    DS    0H
* DISPLAY
         MVC   DSPBUF+0(23),S0018
         MVC   DSPBUF+23(5),D0004+0
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
T0013    DS    0H
...
T0020    DS    0H
* DISPLAY
         MVC   DSPBUF+0(18),S0020
         MVC   DSPBUF+18(5),D0004+0
         MVC   DSPBUF+23(2),S0015
         MVC   DSPBUF+25(12),D0000+0
         MVC   DSPBUF+37(1),S0016
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
T0021    DS    0H
...
T0025    DS    0H
* DISPLAY
         MVC   DSPBUF+0(19),S0021
         MVC   DSPBUF+19(5),D0004+0
         MVC   DSPBUF+24(2),S0015
         MVC   DSPBUF+26(12),D0000+0
         MVC   DSPBUF+38(1),S0016
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0026    DS    0H
...
* DISPLAY
         ...
         MVC   DSPBUF+20(5),D0004+0
         MVC   DSPBUF+25(2),S0015
         MVC   DSPBUF+27(12),D0000+0
         MVC   DSPBUF+39(1),S0016
         LA    1,PARM0007
         L     15,VDISP
         BALR  14,15
T0031    DS    0H
...
T0033    DS    0H
* DISPLAY
         MVC   DSPBUF+0(13),S0023
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+13(12),D0000+0
         MVC   DSPBUF+25(1),S0016
         LA    1,PARM0008
         L     15,VDISP
         BALR  14,15
T0034    DS    0H
...
T0036    DS    0H
* DISPLAY
         MVC   DSPBUF+0(17),S0024
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+17(12),D0000+0
         MVC   DSPBUF+29(1),S0016
         LA    1,PARM0009
         L     15,VDISP
         BALR  14,15
T0037    DS    0H
...
T0039    DS    0H
* DISPLAY
         MVC   DSPBUF+0(15),S0025
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+15(12),D0000+0
         MVC   DSPBUF+27(1),S0016
         LA    1,PARM0010
         L     15,VDISP
         BALR  14,15
T0040    DS    0H
...
T0042    DS    0H
* DISPLAY
         MVC   DSPBUF+0(21),S0026
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+21(12),D0000+0
         MVC   DSPBUF+33(1),S0016
         LA    1,PARM0011
         L     15,VDISP
         BALR  14,15
T0043    DS    0H
...
T0052    DS    0H
* DISPLAY
         MVC   DSPBUF+0(17),S0030
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+17(6),D0001+0
         MVC   DSPBUF+23(1),S0016
         LA    1,PARM0014
         L     15,VDISP
         BALR  14,15
T0053    DS    0H
...
* DISPLAY
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+16(4),D0002+0
         MVC   DSPBUF+20(1),S0016
         LA    1,PARM0016
         L     15,VDISP
         BALR  14,15
T0060    DS    0H
...
T0062    DS    0H
* DISPLAY
         MVC   DSPBUF+0(11),S0033
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+11(10),D0003+0
         MVC   DSPBUF+21(1),S0016
         LA    1,PARM0017
         L     15,VDISP
         BALR  14,15
T0063    DS    0H
...
T0067    DS    0H
* DISPLAY
         MVC   DSPBUF+0(14),S0035
         MVC   DSPBUF+14(5),D0004+0
         LA    1,PARM0018
         L     15,VDISP
         BALR  14,15
T0068    DS    0H
...
S0011    DC    CL1' '
S0012    DC    CL1'/'
S0013    DC    CL12'AABAACAAAXAA'
S0014    DC    CL15'01 TALLY ALL A '
S0015    DC    CL2' ['
S0016    DC    CL1']'
S0017    DC    CL19'02 TALLY LEADING A '
S0018    DC    CL23'03 TALLY UNTIL FIRST C '
S0019    DC    CL23'04 TALLY UNTIL FIRST Q '
S0020    DC    CL18'05 TALLY ALL REPL '
S0021    DC    CL19'06 TALLY LEAD REPL '
S0022    DC    CL20'07 TALLY UNTIL REPL '
S0023    DC    CL13'08 REPL ALL ['
S0024    DC    CL17'09 REPL LEADING ['
S0025    DC    CL15'10 REPL FIRST ['
S0026    DC    CL21'11 REPL UNTIL FIRST ['
S0027    DC    CL22'12 REPL FIRST ABSENT ['
S0028    DC    CL6'100200'
S0029    DC    CL20'13 NUMERIC ALL ZERO '
S0030    DC    CL17'14 NUMERIC REPL ['
S0031    DC    CL16'15 SIGNED ALL 0 '
S0032    DC    CL16'16 SIGNED REPL ['
S0033    DC    CL11'17 EDITED ['
S0034    DC    CL12'A A A A     '
S0035    DC    CL14'18 ALL SPACES '
S0036    DC    CL18'19 TALLY SETTABLE '
S0037    DC    CL19'20 TALLY DISPLAYED '
S0038    DC    CL12'XXXXXXXXXXXX'
S0039    DC    CL15'21 TALLY RESET '
...
SPIENUM  DC    H'78'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(14,0)
         DC    A(T0001-COBBEG),AL2(15,0)
         DC    A(T0002-COBBEG),AL2(15,0)
         DC    A(T0003-COBBEG),AL2(16,0)
         DC    A(T0004-COBBEG),AL2(17,0)
         DC    A(T0005-COBBEG),AL2(18,0)
         DC    A(T0006-COBBEG),AL2(18,0)
         DC    A(T0007-COBBEG),AL2(19,0)
         DC    A(T0008-COBBEG),AL2(20,0)
         DC    A(T0009-COBBEG),AL2(21,0)
         DC    A(T0010-COBBEG),AL2(21,0)
         DC    A(T0011-COBBEG),AL2(22,0)
         DC    A(T0012-COBBEG),AL2(23,0)
         DC    A(T0013-COBBEG),AL2(24,0)
         DC    A(T0014-COBBEG),AL2(24,0)
         DC    A(T0015-COBBEG),AL2(25,0)
         DC    A(T0016-COBBEG),AL2(26,0)
         DC    A(T0017-COBBEG),AL2(27,0)
         DC    A(T0018-COBBEG),AL2(27,0)
         DC    A(T0019-COBBEG),AL2(28,0)
         DC    A(T0020-COBBEG),AL2(29,0)
         DC    A(T0021-COBBEG),AL2(30,0)
         DC    A(T0022-COBBEG),AL2(31,0)
         DC    A(T0023-COBBEG),AL2(31,0)
         DC    A(T0024-COBBEG),AL2(32,0)
         DC    A(T0025-COBBEG),AL2(33,0)
         DC    A(T0026-COBBEG),AL2(34,0)
         DC    A(T0027-COBBEG),AL2(35,0)
         DC    A(T0028-COBBEG),AL2(35,0)
         DC    A(T0029-COBBEG),AL2(36,0)
         DC    A(T0030-COBBEG),AL2(37,0)
         DC    A(T0031-COBBEG),AL2(38,0)
         DC    A(T0032-COBBEG),AL2(39,0)
         DC    A(T0033-COBBEG),AL2(40,0)
         DC    A(T0034-COBBEG),AL2(41,0)
         DC    A(T0035-COBBEG),AL2(42,0)
         DC    A(T0036-COBBEG),AL2(43,0)
         DC    A(T0037-COBBEG),AL2(44,0)
         DC    A(T0038-COBBEG),AL2(45,0)
         DC    A(T0039-COBBEG),AL2(46,0)
         DC    A(T0040-COBBEG),AL2(47,0)
         DC    A(T0041-COBBEG),AL2(48,0)
         DC    A(T0042-COBBEG),AL2(49,0)
         DC    A(T0043-COBBEG),AL2(50,0)
         DC    A(T0044-COBBEG),AL2(51,0)
         DC    A(T0045-COBBEG),AL2(52,0)
         DC    A(T0046-COBBEG),AL2(53,0)
         DC    A(T0047-COBBEG),AL2(54,0)
         DC    A(T0048-COBBEG),AL2(54,0)
         DC    A(T0049-COBBEG),AL2(55,0)
         DC    A(T0050-COBBEG),AL2(56,0)
         DC    A(T0051-COBBEG),AL2(57,0)
         DC    A(T0052-COBBEG),AL2(58,0)
         DC    A(T0053-COBBEG),AL2(59,0)
         DC    A(T0054-COBBEG),AL2(60,0)
         DC    A(T0055-COBBEG),AL2(60,0)
         DC    A(T0056-COBBEG),AL2(61,0)
         DC    A(T0057-COBBEG),AL2(62,0)
         DC    A(T0058-COBBEG),AL2(63,0)
         DC    A(T0059-COBBEG),AL2(64,0)
         DC    A(T0060-COBBEG),AL2(65,0)
         DC    A(T0061-COBBEG),AL2(66,0)
         DC    A(T0062-COBBEG),AL2(67,0)
         DC    A(T0063-COBBEG),AL2(68,0)
         DC    A(T0064-COBBEG),AL2(69,0)
         DC    A(T0065-COBBEG),AL2(69,0)
         DC    A(T0066-COBBEG),AL2(70,0)
         DC    A(T0067-COBBEG),AL2(71,0)
         DC    A(T0068-COBBEG),AL2(72,0)
         DC    A(T0069-COBBEG),AL2(73,0)
         DC    A(T0070-COBBEG),AL2(74,0)
         DC    A(T0071-COBBEG),AL2(75,0)
         DC    A(T0072-COBBEG),AL2(76,0)
         DC    A(T0073-COBBEG),AL2(77,0)
         DC    A(T0074-COBBEG),AL2(78,0)
         DC    A(T0075-COBBEG),AL2(78,0)
...
* WORKING-STORAGE
D0000    DC    CL12' '             W PIC X(12)
         DS    XL4                 reserve the rest of a table
D0001    DC    CL6'000000'         N PIC 9(6)v0 DISP
         DS    XL2                 reserve the rest of a table
D0002    DC    ZL4'0'              S PIC S9(4)v0 DISP
         DS    XL4                 reserve the rest of a table
D0003    DC    CL10' '             ED edited, 10 chars
         DS    XL6                 reserve the rest of a table
D0004    DC    CL5'00000'          T PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0005    DC    FL4'0'              TALLY PIC 9(5)v0 COMP
*---------------------------------------------------------------
