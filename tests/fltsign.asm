*---------------------------------------------------------------
* Generated by cobc370 from fltsign.cbl
...
* MOVE N -> E
         ...
         MVI   0(1),C'-'
G0001    DS    0H
         MVC   D0001(14),EDWK+2    the edited result
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(2),S0001
         MVC   DSPBUF+2(14),D0001+0
...
T0009    DS    0H
* MOVE -123456789 -> N
         ZAP   PWK1(16),K0004+11(5)  literal
         ZAP   D0000(6),PWK1(16)
T0010    DS    0H
* MOVE N -> E
         ZAP   PWK1(16),D0000(6)
...
SPIELTB  DS    0F
         ...
         DC    A(T0002-COBBEG),AL2(9,0)
         DC    A(T0003-COBBEG),AL2(10,0)
         DC    A(T0004-COBBEG),AL2(10,0)
         DC    A(T0005-COBBEG),AL2(10,0)
         DC    A(T0006-COBBEG),AL2(11,0)
         DC    A(T0007-COBBEG),AL2(11,0)
         DC    A(T0008-COBBEG),AL2(11,0)
         DC    A(T0009-COBBEG),AL2(12,0)
         DC    A(T0010-COBBEG),AL2(12,0)
         DC    A(T0011-COBBEG),AL2(12,0)
         DC    A(T0012-COBBEG),AL2(13,0)
         DC    A(T0013-COBBEG),AL2(13,0)
         DC    A(T0014-COBBEG),AL2(13,0)
         DC    A(T0015-COBBEG),AL2(14,0)
         DC    A(T0016-COBBEG),AL2(14,0)
         DC    A(T0017-COBBEG),AL2(14,0)
         DC    A(T0018-COBBEG),AL2(15,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DC    PL6'000'            N PIC S9(11)v2 COMP-3
         DS    XL2                 reserve the rest of a table
D0001    DC    CL14' '             E edited, 14 chars
*---------------------------------------------------------------
