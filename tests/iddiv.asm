*---------------------------------------------------------------
* Generated by cobc370 from iddiv.cbl
...
LEN0001  DC    H'33'
S0001    DC    CL33'ID DIVISION ABBREVIATION ACCEPTED'  nonnumeric cons
...
SPIELTB  DS    0F
         DC    A(T0000-COBBEG),AL2(6,0)
         DC    A(T0001-COBBEG),AL2(7,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
         DS    D                   no WORKING-STORAGE: something to poi
