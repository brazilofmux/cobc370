*---------------------------------------------------------------
* Generated by cobc370 from samerec.cbl
...
* DISPLAY
         ...
         USING WSC0000,8
         MVC   DSPBUF+3(2),D0008+0
         MVC   DSPBUF+5(2),S0002
         MVC   DSPBUF+7(4),D0009+0
         MVC   DSPBUF+11(2),S0002
         MVC   DSPBUF+13(3),D0010+0
         MVC   DSPBUF+16(1),S0003
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0001    DS    0H
* TIME-OF-DAY, from the clock
         ...
         L     15,VADT
         BALR  14,15
         MVC   D0018(6),ZWK        HHMMSS
         DROP  8
* MOVE TIME-OF-DAY -> TOD
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0011(6),D0018      alphanumeric move
         MVI   D0011+6,C' '        space fill the remainder
...
L0006    DS    0H
         ...
         BNL   L0001
         PACK  WK0+14(2),D0014(2)  zoned -> packed
         ZAP   WK1+14(2),K0002+14(2)  literal
         CP    WK0+14(2),WK1+14(2)  numeric compare
         BNL   L0001
         PACK  WK0+14(2),D0015(2)  zoned -> packed
         ZAP   WK1+14(2),K0002+14(2)  literal
         CP    WK0+14(2),WK1+14(2)  numeric compare
         BNL   L0001
T0003    DS    0H
* DISPLAY
         MVC   DSPBUF+0(21),S0004
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0004    DS    0H
...
T0005    DS    0H
* DISPLAY
         MVC   DSPBUF+0(13),S0005
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+13(8),D0011+0
         MVC   DSPBUF+21(1),S0003
         LA    1,PARM0003
         L     15,VDISP
         BALR  14,15
         DROP  8
...
T0006    DS    0H
* DISPLAY
         MVC   DSPBUF+0(15),S0006
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   DSPBUF+15(2),D0016+0
         MVC   DSPBUF+17(1),S0003
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0007    DS    0H
* MOVE TIME-OF-DAY -> TOD6
...
T0011    DS    0H
* MOVE HELLO -> R1-A
         MVC   D0002(5),S0009      literal move, space padded
T0012    DS    0H
* DISPLAY
         MVC   DSPBUF+0(6),S0010
         MVC   DSPBUF+6(3),D0006+0
         MVC   DSPBUF+9(2),S0002
         MVC   DSPBUF+11(5),D0002+0
         MVC   DSPBUF+16(1),S0003
         LA    1,PARM0006
         L     15,VDISP
         BALR  14,15
T0013    DS    0H
* MOVE ABC -> R2-A
         MVC   D0006(3),S0011      literal move, space padded
T0014    DS    0H
* DISPLAY
         MVC   DSPBUF+0(6),S0010
         MVC   DSPBUF+6(5),D0002+0
         MVC   DSPBUF+11(2),S0012
         MVC   DSPBUF+13(3),S0013
         MVC   DSPBUF+16(4),S0014
         MVC   DSPBUF+20(6),S0015
         MVC   DSPBUF+26(5),S0016
         MVC   DSPBUF+31(5),S0017
         MVC   DSPBUF+36(4),S0018
         MVC   DSPBUF+40(6),S0019
         MVC   DSPBUF+46(6),S0020
         MVC   DSPBUF+52(5),S0021
         MVC   DSPBUF+57(4),S0022
         LA    1,PARM0007
         L     15,VDISP
         BALR  14,15
T0015    DS    0H
...
WK5      DS    PL16
* file control blocks
FD000    DCB   DDNAME=OUTFILE,DSORG=PS,MACRF=(GM)
FD001    DCB   DDNAME=OUTFILE,DSORG=PS,MACRF=(GM)
* IS NUMERIC: the digits
CLSNUM   DC    256X'FF'
         ORG   CLSNUM+X'F0'
         DC    10X'00'             0-9
         ORG   CLSNUM+256
K0001    DC    PL16'24'            numeric constants
K0002    DC    PL16'60'
S0001    DC    CL3'Z ['            nonnumeric constants
S0002    DC    CL2']['
S0003    DC    CL1']'
S0004    DC    CL21'TIME-OF-DAY IS HHMMSS'
S0005    DC    CL13'TIME-OF-DAY ['
S0006    DC    CL15'AFTER THE SIX ['
S0007    DC    CL22'TIME-OF-DAY IS NUMERIC'
S0008    DC    CL1'X'
S0009    DC    CL5'HELLO'
S0010    DC    CL6'SAME ['
S0011    DC    CL3'ABC'
...
SPIENUM  DC    H'16'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0H
         DC    AL2(T0000-COBBEG),AL2(37)
         DC    AL2(T0001-COBBEG),AL2(38)
         DC    AL2(T0002-COBBEG),AL2(41)
         DC    AL2(T0003-COBBEG),AL2(41)
         DC    AL2(T0004-COBBEG),AL2(42)
         DC    AL2(T0005-COBBEG),AL2(42)
         DC    AL2(T0006-COBBEG),AL2(43)
         DC    AL2(T0007-COBBEG),AL2(44)
         DC    AL2(T0008-COBBEG),AL2(45)
         DC    AL2(T0009-COBBEG),AL2(45)
         DC    AL2(T0010-COBBEG),AL2(46)
         DC    AL2(T0011-COBBEG),AL2(47)
         DC    AL2(T0012-COBBEG),AL2(48)
         DC    AL2(T0013-COBBEG),AL2(49)
         DC    AL2(T0014-COBBEG),AL2(50)
         DC    AL2(T0015-COBBEG),AL2(52)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
         DS    XL4                 reserve the rest of a table
D0000    DC    CL4' '              *RDW PIC X(4)
D0001    DS    0CL80               R1 (01 group)
D0002    DC    CL5' '              R1-A PIC X(5)
D0003    DC    CL75' '             R1-B PIC X(75)
         DS    XL4                 reserve the rest of a table
D0004    DC    CL4' '              *RDW PIC X(4)
D0005    EQU   COBWS+8             R2 REDEFINES
D0006    EQU   COBWS+8             R2-A REDEFINES
D0007    EQU   COBWS+11            R2-B REDEFINES
D0008    DC    CL2'00'             Z1 PIC X(2) VALUE ALL
         DS    XL6                 reserve the rest of a table
D0009    DC    CL4'0000'           Z2 PIC X(4) VALUE ALL
         DS    XL4                 reserve the rest of a table
D0010    DC    CL3'000'            Z3 PIC X(3) VALUE ALL
         DS    XL5                 reserve the rest of a table
D0011    DC    CL8'********'       TOD PIC X(8) VALUE ALL
D0012    EQU   COBWS+120           TOD-PARTS REDEFINES
D0013    EQU   COBWS+120           TOD-HH REDEFINES
D0014    EQU   COBWS+122           TOD-MM REDEFINES
D0015    EQU   COBWS+124           TOD-SS REDEFINES
D0016    EQU   COBWS+126           TOD-REST REDEFINES
D0017    DC    CL6'000000'         TOD6 PIC 9(6)v0 DISP
D0018    DC    CL6'000000'         TIME-OF-DAY PIC 9(6)v0 DISP
*---------------------------------------------------------------
