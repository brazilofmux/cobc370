*---------------------------------------------------------------
* Generated by cobc370 from bigtab.cbl
...
* MOVE E-KEY -> SHOW
         ...
         MVC   D0006(5),0(7)       zoned to zoned, same picture
T0002    DS    0H
* DISPLAY
         MVC   DSPBUF+0(6),S0001
         MVC   DSPBUF+6(5),D0006+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0003    DS    0H
* MOVE E-KEY -> SHOW
         L     7,FC001             subscript-1
         MH    7,H0001             times element size
         LA    7,D0002(7)          element address
         MVC   D0006(5),0(7)       zoned to zoned, same picture
T0004    DS    0H
...
* MOVE ROW -> E-TEXT
         ...
         MVC   0(15,6),S0006       literal move, space padded
...
FC002    DC    F'5000'
S0001    DC    CL6'FIRST '         nonnumeric constants
S0002    DC    CL6'LAST  '
S0003    DC    CL8'NOTFOUND'
S0004    DC    CL6'FOUND '
S0005    DC    CL6'TAIL  '
S0006    DC    CL15'ROW            '
...
* WORKING-STORAGE
D0000    DS    0C                  BIG-TABLE (01 group)
D0001    DS    0CL20               BIG-ENTRY (05 group, OCCURS 5000)
D0002    DC    CL5'00000'          E-KEY PIC 9(5)v0 DISP
D0003    DC    CL15' '             E-TEXT PIC X(15)
         DS    99980X              reserve the rest of a table
D0004    DC    CL9'TAIL-HERE'      TAIL-ITEM PIC X(9)
         DS    XL7                 reserve the rest of a table
D0005    DC    HL2'0'              SUB PIC S9(4)v0 COMP
