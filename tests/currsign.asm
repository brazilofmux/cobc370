*---------------------------------------------------------------
* Generated by cobc370 from currsign.cbl
...
* MOVE AMT -> E-FLOAT
         ...
         MVI   0(1),X'C6'          the floating currency symbol
         MVC   D0002(14),EDWK+2    the edited result
T0001    DS    0H
* MOVE AMT -> E-FIXED
         PACK  PWK1(16),D0000(9)   zoned -> packed
         ZAP   EDSRC(6),PWK1(16)   source, sized to the selector count
...
* DISPLAY
         ...
         MVC   DSPBUF+1(14),D0002+0
         MVC   DSPBUF+15(3),S0002
         MVC   DSPBUF+18(13),D0003+0
         MVC   DSPBUF+31(1),S0003
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0005    DS    0H
* DISPLAY
         MVC   DSPBUF+0(1),S0001
         MVC   DSPBUF+1(14),D0004+0
         MVC   DSPBUF+15(3),S0002
         MVC   DSPBUF+18(12),D0005+0
         MVC   DSPBUF+30(1),S0003
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0006    DS    0H
...
WK4      DS    PL16
WK5      DS    PL16
K0001    DC    PL16'725'           numeric constants
K0002    DC    PL16'35'
K0003    DC    PL16'0125'
...
* WORKING-STORAGE
D0000    DC    ZL9'123456789'      AMT PIC S9(9)v2 DISP
         DS    XL7                 reserve the rest of a table
D0001    DC    ZL9'-1250'          SMALL PIC S9(9)v2 DISP
         DS    XL7                 reserve the rest of a table
D0002    DC    CL14' '             E-FLOAT edited, 14 chars
         DS    XL2                 reserve the rest of a table
D0003    DC    CL13' '             E-FIXED edited, 13 chars
         DS    XL3                 reserve the rest of a table
D0004    DC    CL14' '             E-ZED edited, 14 chars
         DS    XL2                 reserve the rest of a table
D0005    DC    CL12' '             E-PLAIN edited, 12 chars
         DS    XL4                 reserve the rest of a table
D0006    DC    CL2'05'             HALF PIC 9(2)v1 DISP
         DS    XL6                 reserve the rest of a table
D0007    DC    CL6'000000'         R PIC 9(6)v3 DISP
         DS    XL2                 reserve the rest of a table
D0008    DC    CL7' '              E-R edited, 7 chars
*---------------------------------------------------------------
