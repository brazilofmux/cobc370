*---------------------------------------------------------------
* Generated by cobc370 from perfnest.cbl
...
COBCON   DS    0D                  constants, work areas, out-of-line c
         DS    0F
PT005    DC    F'0'                PERFORM n TIMES counter: 40000 TIMES
X0003    DC    A(F0003)            C
X0005    DC    A(F0005)            COUNT-ONE
VDISP    DC    V(COBDISP)
VTERM    DC    V(COBTERM)
...
K0002    EQU   *-15
         DC    PL1'3'
S0001    DC    CL12'BACK IN MAIN'  nonnumeric constants
S0002    DC    CL18'BACK IN MAIN AGAIN'
S0003    DC    CL6'TIMES '
S0004    DC    CL1'A'
S0005    DC    CL15'B, PERFORMING C'
S0006    DC    CL9'B AFTER C'
S0007    DC    CL1'C'
S0008    DC    CL17'D: FELL THROUGH C'
S0009    DC    CL7'LOOPING'
...
* WORKING-STORAGE
D0000    DC    CL1'0'              N PIC 9(1)v0 DISP
         DS    XL7                 reserve the rest of a table
D0001    DC    CL5'40000'          BIG PIC 9(5)v0 DISP
         DS    XL3                 reserve the rest of a table
D0002    DC    CL5'00000'          CNT PIC 9(5)v0 DISP
*---------------------------------------------------------------
