*---------------------------------------------------------------
* Generated by cobc370 from rrdsnatd.cbl
...
* OPEN I-O RRDS-FILE
         ...
         USING WSC0000,8
         MVC   D0012(2),=C'30'     permanent error
         B     G0003
G0001    DS    0H
         DROP  8
         L     8,BL0000            base locator
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0012(2),S0004      alphanumeric compare
         BE    L0001
T0006    DS    0H
* DISPLAY
         MVC   DSPBUF+0(31),S0005
         MVC   DSPBUF+31(2),D0012+0
         LA    1,PARM0004
         L     15,VDISP
         BALR  14,15
T0007    DS    0H
* MOVE Y -> END-OF-FILE-SWITCH
         MVC   D0013(1),S0006      literal move, space padded
         DROP  8
L0001    DS    0H
* 010-PROCESS.
P0001    DS    0H
...
L0027    DS    0H
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0013(1),S0006      alphanumeric compare
         BE    L0028
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0002(1),S0007      alphanumeric compare
         BNE   L0005
T0018    DS    0H
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0002(1),S0008      alphanumeric compare
         BNE   L0006
T0020    DS    0H
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0002(1),S0009      alphanumeric compare
         BNE   L0007
T0022    DS    0H
...
P0007    DS    0H
T0024    DS    0H
* MOVE RI-IMAGE -> RRDS-RECORD
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0006(78),D0004     alphanumeric move
         MVI   D0006+78,C' '       space fill the remainder
         MVC   D0006+79(1),D0006+78
T0025    DS    0H
* MOVE RRK-LOW -> WS-RRN
...
* MOVE WS-RRN -> COUNTER-EDIT
         ...
         ED    EDWK(12),EDSRC
         MVC   D0019(10),EDWK+2    the edited result
T0027    DS    0H
* DISPLAY
         MVC   DSPBUF+0(10),D0019+0
         MVC   DSPBUF+10(10),S0010
         MVC   DSPBUF+20(80),D0006+0
         LA    1,PARM0005
         L     15,VDISP
         BALR  14,15
T0028    DS    0H
* MOVE N -> OP-FAILED-SWITCH
         MVC   D0017(1),S0011      literal move, space padded
T0029    DS    0H
* WRITE RRDS-RECORD
...
G0009    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0012(2),=C'22'     duplicate key
         B     G0012
G0010    DS    0H
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0012(2),=C'21'     key out of sequence
         B     G0012
G0011    DS    0H
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0012(2),=C'24'     cluster is full
         B     G0012
G0007    DS    0H
         DROP  8
         L     8,BL0000            base locator
...
* MOVE Y -> OP-FAILED-SWITCH
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0017(1),S0006      literal move, space padded
         DROP  8
L0009    DS    0H
T0031    DS    0H
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0017(1),S0006      alphanumeric compare
         BE    L0010
T0032    DS    0H
* DISPLAY
...
* IF
         ...
         CLC   D0017(1),S0006      alphanumeric compare
         BNE   L0011
         CLC   D0012(2),S0013      alphanumeric compare
         BNE   L0011
T0034    DS    0H
* DISPLAY
...
* IF
         L     8,BL0000            base locator
         USING WSC0000,8
         CLC   D0015(1),S0006      alphanumeric compare
         BE    L0013
T0041    DS    0H
* MOVE WS-RRN -> COUNTER-EDIT
         L     2,D0011
...
* DISPLAY
         MVC   DSPBUF+0(10),D0019+0
         MVC   DSPBUF+10(2),S0017
         MVC   DSPBUF+12(80),D0006+0
         LA    1,PARM0012
         L     15,VDISP
         BALR  14,15
T0049    DS    0H
* DISPLAY
         MVC   DSPBUF+0(35),S0018
         LA    1,PARM0013
         L     15,VDISP
         BALR  14,15
T0050    DS    0H
...
G0021    DS    0H
         ...
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0012(2),=C'21'     prime key changed
         B     G0024
G0022    DS    0H
         DROP  8
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0012(2),=C'23'     no such record
         B     G0024
G0023    DS    0H
         DROP  8
         L     8,BL0000            base locator
...
T0059    DS    0H
* DISPLAY
         MVC   DSPBUF+0(30),S0020
         MVC   DSPBUF+30(2),D0012+0
         LA    1,PARM0016
         L     15,VDISP
         BALR  14,15
         DROP  8
...
T0079    DS    0H
* DISPLAY
         MVC   DSPBUF+0(29),S0023
         MVC   DSPBUF+29(2),D0012+0
         LA    1,PARM0023
         L     15,VDISP
         BALR  14,15
         DROP  8
...
T0084    DS    0H
* MOVE Y -> FOUND-SWITCH
         MVC   D0015(1),S0006      literal move, space padded
T0085    DS    0H
* READ RRDS-FILE
...
* MOVE N -> FOUND-SWITCH
         L     8,BL0000            base locator
         USING WSC0000,8
         MVC   D0015(1),S0011      literal move, space padded
         DROP  8
L0026    DS    0H
* 159-EXIT.
P0018    DS    0H
...
FD001    ACB   DDNAME=RRDSF01,MACRF=(KEY,DIR,OUT)  VSAM access method c
FD001RA  DC    F'0'                has carried a request
FD001R   RPL   ACB=FD001,AREA=D0006,                                   X
               AREALEN=80,RECLEN=80,ARG=D0011,OPTCD=(KEY,DIR,KEQ,UPD,  X
               MVE)
FD001NA  DC    F'0'                has carried a request
FD001N   RPL   ACB=FD001,AREA=D0006,                                   X
               AREALEN=80,RECLEN=80,ARG=D0011,OPTCD=(KEY,DIR,KEQ,NUP,  X
               MVE)
M0001    DC    XL12'402020206B2020206B202120'  ED patterns
S0001    DC    CL34'RRDSRAND: READ/REWRITE RRDS DIRECT'  nonnumeric con
S0002    DC    CL34'----------------------------------'
S0003    DC    CL1' '
S0004    DC    CL2'00'
...
S0008    DC    CL1'C'
S0009    DC    CL1'D'
S0010    DC    CL10': ADDING: '
S0011    DC    CL1'N'
S0012    DC    CL27'               RECORD ADDED'
S0013    DC    CL2'22'
S0014    DC    CL40'            *** DUPLICATE RECORD ON FILE'
S0015    DC    CL28'VSAM ERROR ON WRITE, STATUS '
S0016    DC    CL21' *** RECORD NOT FOUND'
S0017    DC    CL2': '
S0018    DC    CL35'               RECORD BEFORE CHANGE'
S0019    DC    CL34'               RECORD AFTER CHANGE'
S0020    DC    CL30'VSAM ERROR ON REWRITE, STATUS '
S0021    DC    CL35'               RECORD BEFORE DELETE'
S0022    DC    CL20'             DELETED'
S0023    DC    CL29'VSAM ERROR ON DELETE, STATUS '
...
SPIENUM  DC    H'88'               statements in the table
SPIEREGS DS    15F
...
SPIELTB  DS    0H
         DC    AL2(T0000-COBBEG),AL2(42)
         DC    AL2(T0001-COBBEG),AL2(43)
         DC    AL2(T0002-COBBEG),AL2(44)
         DC    AL2(T0003-COBBEG),AL2(45)
         DC    AL2(T0004-COBBEG),AL2(46)
         DC    AL2(T0005-COBBEG),AL2(48)
         DC    AL2(T0006-COBBEG),AL2(48)
         DC    AL2(T0007-COBBEG),AL2(49)
         DC    AL2(T0008-COBBEG),AL2(51)
         DC    AL2(T0009-COBBEG),AL2(53)
         DC    AL2(T0010-COBBEG),AL2(54)
         DC    AL2(T0011-COBBEG),AL2(55)
         DC    AL2(T0012-COBBEG),AL2(58)
         DC    AL2(T0013-COBBEG),AL2(58)
         DC    AL2(T0014-COBBEG),AL2(60)
         DC    AL2(T0015-COBBEG),AL2(60)
         DC    AL2(T0016-COBBEG),AL2(62)
         DC    AL2(T0017-COBBEG),AL2(65)
         DC    AL2(T0018-COBBEG),AL2(65)
         DC    AL2(T0019-COBBEG),AL2(67)
         DC    AL2(T0020-COBBEG),AL2(67)
         DC    AL2(T0021-COBBEG),AL2(69)
         DC    AL2(T0022-COBBEG),AL2(69)
         DC    AL2(T0023-COBBEG),AL2(71)
         DC    AL2(T0024-COBBEG),AL2(73)
         DC    AL2(T0025-COBBEG),AL2(74)
         DC    AL2(T0026-COBBEG),AL2(75)
         DC    AL2(T0027-COBBEG),AL2(76)
         DC    AL2(T0028-COBBEG),AL2(77)
         DC    AL2(T0029-COBBEG),AL2(79)
         DC    AL2(T0030-COBBEG),AL2(79)
         DC    AL2(T0031-COBBEG),AL2(81)
         DC    AL2(T0032-COBBEG),AL2(81)
         DC    AL2(T0033-COBBEG),AL2(83)
         DC    AL2(T0034-COBBEG),AL2(83)
         DC    AL2(T0035-COBBEG),AL2(85)
         DC    AL2(T0036-COBBEG),AL2(85)
         DC    AL2(T0037-COBBEG),AL2(86)
         DC    AL2(T0038-COBBEG),AL2(88)
         DC    AL2(T0039-COBBEG),AL2(90)
         DC    AL2(T0040-COBBEG),AL2(92)
         DC    AL2(T0041-COBBEG),AL2(92)
         DC    AL2(T0042-COBBEG),AL2(93)
         DC    AL2(T0043-COBBEG),AL2(94)
         DC    AL2(T0044-COBBEG),AL2(96)
         DC    AL2(T0045-COBBEG),AL2(96)
         DC    AL2(T0046-COBBEG),AL2(98)
         DC    AL2(T0047-COBBEG),AL2(100)
         DC    AL2(T0048-COBBEG),AL2(101)
         DC    AL2(T0049-COBBEG),AL2(102)
         DC    AL2(T0050-COBBEG),AL2(103)
         DC    AL2(T0051-COBBEG),AL2(104)
         DC    AL2(T0052-COBBEG),AL2(106)
         DC    AL2(T0053-COBBEG),AL2(106)
         DC    AL2(T0054-COBBEG),AL2(108)
         DC    AL2(T0055-COBBEG),AL2(108)
         DC    AL2(T0056-COBBEG),AL2(109)
         DC    AL2(T0057-COBBEG),AL2(110)
         DC    AL2(T0058-COBBEG),AL2(112)
         DC    AL2(T0059-COBBEG),AL2(112)
         DC    AL2(T0060-COBBEG),AL2(113)
         DC    AL2(T0061-COBBEG),AL2(115)
         DC    AL2(T0062-COBBEG),AL2(117)
         DC    AL2(T0063-COBBEG),AL2(119)
         DC    AL2(T0064-COBBEG),AL2(119)
         DC    AL2(T0065-COBBEG),AL2(120)
         DC    AL2(T0066-COBBEG),AL2(121)
         DC    AL2(T0067-COBBEG),AL2(123)
         DC    AL2(T0068-COBBEG),AL2(123)
         DC    AL2(T0069-COBBEG),AL2(125)
         DC    AL2(T0070-COBBEG),AL2(127)
         DC    AL2(T0071-COBBEG),AL2(128)
         DC    AL2(T0072-COBBEG),AL2(129)
         DC    AL2(T0073-COBBEG),AL2(130)
         DC    AL2(T0074-COBBEG),AL2(132)
         DC    AL2(T0075-COBBEG),AL2(132)
         DC    AL2(T0076-COBBEG),AL2(134)
         DC    AL2(T0077-COBBEG),AL2(134)
         DC    AL2(T0078-COBBEG),AL2(136)
         DC    AL2(T0079-COBBEG),AL2(136)
         DC    AL2(T0080-COBBEG),AL2(137)
         DC    AL2(T0081-COBBEG),AL2(139)
         DC    AL2(T0082-COBBEG),AL2(141)
         DC    AL2(T0083-COBBEG),AL2(142)
         DC    AL2(T0084-COBBEG),AL2(143)
         DC    AL2(T0085-COBBEG),AL2(145)
         DC    AL2(T0086-COBBEG),AL2(145)
         DC    AL2(T0087-COBBEG),AL2(147)
COBWS    CSECT
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
         DS    XL4                 reserve the rest of a table
D0000    DC    CL4' '              *RDW PIC X(4)
D0001    DS    0CL80               RECORD-IMAGE (01 group)
D0002    DC    CL1' '              RI-ACTION PIC X(1)
D0003    DC    CL1' '              FILL0003 PIC X(1)
D0004    DC    CL78' '             RI-IMAGE PIC X(78)
         DS    XL4                 reserve the rest of a table
D0005    DC    CL4' '              *RDW PIC X(4)
D0006    DS    0CL80               RRDS-RECORD (01 group)
D0007    DS    0CL10               RR-KEY (02 group)
D0008    DC    CL7'0000000'        RRK-HIGH PIC 9(7)v0 DISP
D0009    DC    CL3'000'            RRK-LOW PIC 9(3)v0 DISP
D0010    DC    CL70' '             FILL0010 PIC X(70)
D0011    DC    FL4'0'              WS-RRN PIC 9(8)v0 COMP
         DS    XL4                 reserve the rest of a table
D0012    DC    CL2'00'             WS-STATUS PIC X(2)
         DS    XL6                 reserve the rest of a table
D0013    DC    CL1'N'              END-OF-FILE-SWITCH PIC X(1)
         DS    XL7                 reserve the rest of a table
D0015    DC    CL1'Y'              FOUND-SWITCH PIC X(1)
         DS    XL7                 reserve the rest of a table
D0017    DC    CL1'N'              OP-FAILED-SWITCH PIC X(1)
         DS    XL7                 reserve the rest of a table
D0019    DC    CL10' '             COUNTER-EDIT edited, 10 chars
*---------------------------------------------------------------
