*---------------------------------------------------------------
* Generated by cobc370 from subsmul.cbl
...
* COMPUTE R = ...
         ...
         MP    WK0+9(7),0(4,7)     scale becomes the sum of the scales
         ZAP   D0005(7),WK0+9(7)
T0005    DS    0H
* MOVE R -> RDX
         ZAP   PWK1(16),D0005(7)
         ZAP   EDSRC(7),PWK1(16)   source, sized to the selector count
         ...
         MVI   0(1),C'-'
G0001    DS    0H
         MVC   D0006(14),EDWK+2    the edited result
T0006    DS    0H
* DISPLAY
         MVC   DSPBUF+0(8),S0001
         MVC   DSPBUF+8(14),D0006+0
...
* COMPUTE R = ...
         ...
         MH    7,H0001             times element size
         LA    7,D0003(7)          element address
         SRP   WK0+5(11),8,0       align scale (left)
         DP    WK0+5(11),0(4,7)    quotient, then the remainder
...
* COMPUTE R = ...
         ...
         MH    7,H0001             times element size
         LA    7,D0002(7)          element address
         MP    WK0+9(7),0(3,7)     scale becomes the sum of the scales
         LA    7,0                 subscript-1
         MH    7,H0001             times element size
         LA    7,D0002(7)          element address
         ZAP   WK1+12(4),0(3,7)
...
K0004    EQU   *-14
         DC    PL2'999'
M0001    DC    XL16'402040202020202020202021204B2020'  ED patterns
H0001    DC    H'7'                element sizes
S0001    DC    CL8'TIMES  ['       nonnumeric constants
S0002    DC    CL1']'
S0003    DC    CL8'DIVIDE ['
S0004    DC    CL8'MIXED  ['
...
SPIELTB  DS    0F
         ...
         DC    A(T0012-COBBEG),AL2(25,0)
         DC    A(T0013-COBBEG),AL2(26,0)
         CSECT                     WORKING-STORAGE: private code, one p
COBWS    DS    0D
WSC0000  EQU   COBWS               chunk origins
* WORKING-STORAGE
D0000    DS    0CL70               TBL (01 group)
D0001    DS    0CL7                ROW (05 group, OCCURS 10)
D0002    DC    PL3'0'              QTY PIC S9(5)v0 COMP-3
D0003    DC    PL4'0'              PRICE PIC S9(7)v2 COMP-3
         DS    XL65                reserve the rest of a table
D0004    DC    HL2'2'              I PIC 9(4)v0 COMP
         DS    XL6                 reserve the rest of a table
D0005    DC    PL7'0'              R PIC S9(12)v2 COMP-3
         DS    XL1                 reserve the rest of a table
D0006    DC    CL14' '             RDX edited, 14 chars
*---------------------------------------------------------------
