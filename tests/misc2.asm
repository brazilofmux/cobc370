*---------------------------------------------------------------
* Generated by cobc370 from misc2.cbl
...
* DISPLAY
         ...
         MVC   DSPBUF+6(5),D0003+0
         MVC   DSPBUF+11(1),S0002
         MVC   DSPBUF+12(5),D0004+0
         MVC   DSPBUF+17(1),S0002
         MVC   DSPBUF+18(5),D0005+0
         LA    1,PARM0001
         L     15,VDISP
         BALR  14,15
T0007    DS    0H
* DISPLAY
         ...
         MVC   DSPBUF+7(6),D0006+0
         MVC   DSPBUF+13(1),S0004
         LA    1,PARM0002
         L     15,VDISP
         BALR  14,15
T0008    DS    0H
...
* MOVE TXT -> NUM
         LA    1,D0011
         MVC   0(4,1),D0010        alphanumeric into a numeric item
T0010    DS    0H
* DISPLAY
         MVC   DSPBUF+0(6),S0006
         MVC   DSPBUF+6(4),D0011+0
...
* MOVE TXT -> NUM6
         LA    1,D0012
         MVI   0(1),C'0'           zero fill on the left
         MVC   1(1,1),0(1)
         MVC   2(4,1),D0010        alphanumeric into a numeric item
T0012    DS    0H
* DISPLAY
         MVC   DSPBUF+0(6),S0007
         MVC   DSPBUF+6(6),D0012+0
